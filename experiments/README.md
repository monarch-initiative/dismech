...
| [`rhea_reaction_grounding/`](rhea_reaction_grounding/) | Could dismech ground mechanism nodes in Rhea biochemical reactions, and how much of the KB would that reach? Measures coverage via the rhea2go GO bridge, tests whether a reached reaction corroborates the biomarker already curated, and separates resolvable from genuinely ambiguous GO-to-reaction mappings. | 3 |
