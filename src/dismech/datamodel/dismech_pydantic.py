...
class NCITDiseaseOrFindingTerm(str):
    """
    An NCIT disease, neoplasm subtype, or clinically used disease/finding concept used for oncology disease and subtype mappings.
    """
    pass
...
class Subtype(ConfiguredBaseModel):
    ...
    subtype_term: Optional[DiseaseDescriptor] = Field(default=None, description="""The MONDO term for a disease subtype when an appropriate MONDO class exists. Use supplemental subtype ncit_mappings for oncology-specific subtype grounding.""", json_schema_extra = { "linkml_meta": {'alias': 'subtype_term', 'domain_of': ['Subtype']} })
    ncit_mappings: Optional[list[NCITMapping]] = Field(default=None, description="""NCIT disease or disease/finding mappings""", json_schema_extra = { "linkml_meta": {'alias': 'ncit_mappings', 'domain_of': ['Subtype', 'DiseaseMappings']} })
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'description',
         'domain_of': ['Descriptor',
                       'DietaryModification',
                       'GeneticContext',
...
class Disease(ConfiguredBaseModel):
    ...
    mappings: Optional[DiseaseMappings] = Field(default=None, description="""External identifier mappings (SSSOM-inspired)""", json_schema_extra = { "linkml_meta": {'alias': 'mappings', 'domain_of': ['Disease']} })
...
class NCITMapping(TermMapping):
    """
    NCIT disease or disease/finding ontology mapping
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/monarch-initiative/dismech',
         'slot_usage': {'term': {'bindings': [{'binds_value_of': 'id',
                                               'obligation_level': 'REQUIRED',
