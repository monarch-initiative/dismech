...
class Dataset(ConfiguredBaseModel):
    ...
    publication: Optional[PublicationReference] = Field(default=None, description="""Associated publication reference with PMID and validated title""", json_schema_extra = { "linkml_meta": {'alias': 'publication', 'domain_of': ['Dataset', 'ComputationalModel']} })
...
class EvidenceItem(ConfiguredBaseModel):
    ...
    reference: Optional[str] = Field(default=None, description="""The authoritative reference (publication) for this evidence item""", json_schema_extra = { "linkml_meta": {'alias': 'reference',
         ...
         'implements': ['linkml:authoritative_reference']} })
    reference_title: Optional[str] = Field(default=None, description="""Title of the cited publication, validated against the authoritative source (e.g., PubMed)""", json_schema_extra = { "linkml_meta": {'alias': 'reference_title',
         'comments': ['This title is automatically validated by the '
                      'linkml-reference-validator tool against the cited PMID.',
                      'Including a title alongside each PMID prevents wrong-PMID '
                      'errors that are invisible with bare identifiers.'],
