...
# Generation date: 2026-04-12T22:54:41
# Schema: dismech
#
...
class NCITDiseaseTerm(EnumDefinitionImpl):
    """
    A disease or disease-subtype concept from NCIT used for oncology mappings. Validation checks that the NCIT term
    exists and the label matches exactly.
    """
    _defn = EnumDefinition(
        name="NCITDiseaseTerm",
        description="""A disease or disease-subtype concept from NCIT used for oncology mappings. Validation checks that the NCIT term exists and the label matches exactly.""",
    )
