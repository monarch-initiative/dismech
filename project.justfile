...
[group('QC')]
qc: check-reference-cache-frontmatter check-term-cache-integrity check-folded-hyphens check-snippet-length check-title-snippets validate-all validate-modules validate-groupings validate-synthesis-all validate-phenotype-distributions qc-deep-research
