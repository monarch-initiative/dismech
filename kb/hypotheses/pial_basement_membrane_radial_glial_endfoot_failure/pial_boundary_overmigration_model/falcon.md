...
* **Cas adaptor proteins are required in Emx1-lineage cells** for PBM integrity: Emx1Cre;CasTcKO cortices show **Laminin+ PBM ruptures** and **Nestin+ RG endfeet detachment/extension into the subarachnoid space**, consistent with boundary failure (wong2023anadhesionsignaling pages 15-18).
...
> - **Strongly supported:** Loss of αDG-mediated ECM binding, especially to laminin-rich PBM, destabilizes radial-glial basal endfeet and the glial scaffold, producing visible Laminin-positive basement-membrane discontinuities together with Nestin-positive endfoot detachment or extension into the subarachnoid space (nickolls2018therolesof pages 5-6, wong2023anadhesionsignaling pages 15-18, wong2023anadhesionsignaling media 44b4a27d).
