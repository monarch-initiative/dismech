# Assessment of the OpenScientist icosapent-ethyl plaque report
...
events in a design capable of estimating a plaque-mediated indirect effect.
REDUCE-IT proves an event benefit in its trial population, not its plaque
mechanism.

## Claims requiring qualification

### Mineral oil is a sensitivity concern, not established confounding
...
Keep the hypothesis `EMERGING`. Retain EVAPORATE as partial evidence for the
IPE-to-plaque edge and the null OCT result as a qualifier. Do not assert a
plaque-to-event causal edge. Represent apoB/remnant lowering, comparator effects,
and other EPA mechanisms as unresolved alternatives or upstream pathways rather
than selecting one as the established mediator.
