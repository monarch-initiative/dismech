...
_Anatomical location where this entity/process occurs or procedure is performed_





URI: [dismech:located_in](https://w3id.org/monarch-initiative/dismech/located_in)
Alias: located_in
...
| ---  | ---  |
| self | dismech:located_in |
| native | dismech:located_in |
...
```yaml
name: located_in
description: Anatomical location where this entity/process occurs or procedure is
  performed
