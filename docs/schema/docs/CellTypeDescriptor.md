...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Descriptor],[Term]<term%200..1-++[CellTypeDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[SampleTypeDescriptor]++-%20cell_type_term%200..1>[CellTypeDescriptor],[Pathophysiology]++-%20cell_types%200..*>[CellTypeDescriptor],[Biochemical]++-%20cell_types%200..*>[CellTypeDescriptor],[Descriptor]^-[CellTypeDescriptor],[SampleTypeDescriptor],[Pathophysiology],[Biochemical],[AnatomicalEntityDescriptor])](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Descriptor],[Term]<term%200..1-++[CellTypeDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[SampleTypeDescriptor]++-%20cell_type_term%200..1>[CellTypeDescriptor],[Pathophysiology]++-%20cell_types%200..*>[CellTypeDescriptor],[Biochemical]++-%20cell_types%200..*>[CellTypeDescriptor],[Descriptor]^-[CellTypeDescriptor],[SampleTypeDescriptor],[Pathophysiology],[Biochemical],[AnatomicalEntityDescriptor])
 ...
 *  **None** *[cell_type_term](cell_type_term.md)*  <sub>0..1</sub>  **[CellTypeDescriptor](CellTypeDescriptor.md)**
 *  **None** *[cell_types](cell_types.md)*  <sub>0..\*</sub>  **[CellTypeDescriptor](CellTypeDescriptor.md)**
 ...
 * [CellTypeDescriptor➞term](CellTypeDescriptor_term.md)  <sub>0..1</sub>
