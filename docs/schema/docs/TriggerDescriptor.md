...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Term]<term%200..1-++[TriggerDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Pathophysiology]++-%20triggers%200..*>[TriggerDescriptor],[Descriptor]^-[TriggerDescriptor],[Term],[Qualifier],[Pathophysiology],[Descriptor],[AnatomicalEntityDescriptor])](https://yuml.me/diagram/nofunky;dir:TB/class/[Term]<term%200..1-++[TriggerDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Pathophysiology]++-%20triggers%200..*>[TriggerDescriptor],[Descriptor]^-[TriggerDescriptor],[Term],[Qualifier],[Pathophysiology],[Descriptor],[AnatomicalEntityDescriptor])
 ...
 *  **None** *[triggers](triggers.md)*  <sub>0..\*</sub>  **[TriggerDescriptor](TriggerDescriptor.md)**
 ...
 * [TriggerDescriptor➞term](TriggerDescriptor_term.md)  <sub>0..1</sub>
