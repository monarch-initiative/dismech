...
URI: [dismech:EnvironmentDescriptor](https://w3id.org/monarch-initiative/dismech/EnvironmentDescriptor)


[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Term]<term%200..1-++[EnvironmentDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Environmental]++-%20environment_context%200..1>[EnvironmentDescriptor],[Descriptor]^-[EnvironmentDescriptor],[Environmental],[Descriptor],[AnatomicalEntityDescriptor])](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Term]<term%200..1-++[EnvironmentDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Environmental]++-%20environment_context%200..1>[EnvironmentDescriptor],[Descriptor]^-[EnvironmentDescriptor],[Environmental],[Descriptor],[AnatomicalEntityDescriptor])
 ...
 *  **None** *[environment_context](environment_context.md)*  <sub>0..1</sub>  **[EnvironmentDescriptor](EnvironmentDescriptor.md)**
 ...
 * [EnvironmentDescriptor➞term](EnvironmentDescriptor_term.md)  <sub>0..1</sub>
...
|  |  |  |
| --- | --- | --- |
| **Comments:** | | Use ENVO (Environment Ontology) for habitats, biomes, and environmental features |
