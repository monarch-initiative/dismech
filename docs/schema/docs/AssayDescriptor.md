...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Descriptor],[Term]<term%200..1-++[AssayDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Pathophysiology]++-%20assays%200..*>[AssayDescriptor],[Biochemical]++-%20assays%200..*>[AssayDescriptor],[Descriptor]^-[AssayDescriptor],[Pathophysiology],[Biochemical],[AnatomicalEntityDescriptor])](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Descriptor],[Term]<term%200..1-++[AssayDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Pathophysiology]++-%20assays%200..*>[AssayDescriptor],[Biochemical]++-%20assays%200..*>[AssayDescriptor],[Descriptor]^-[AssayDescriptor],[Pathophysiology],[Biochemical],[AnatomicalEntityDescriptor])
 ...
 *  **None** *[assays](assays.md)*  <sub>0..\*</sub>  **[AssayDescriptor](AssayDescriptor.md)**
 ...
 * [AssayDescriptor➞term](AssayDescriptor_term.md)  <sub>0..1</sub>
