...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Term]<term%200..1-++[TreatmentDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Diagnosis]++-%20diagnosis_term%200..1>[TreatmentDescriptor],[Treatment]++-%20treatment_term%200..1>[TreatmentDescriptor],[Descriptor]^-[TreatmentDescriptor],[Treatment],[Term],[Qualifier],[Diagnosis],[Descriptor],[AnatomicalEntityDescriptor])](https://yuml.me/diagram/nofunky;dir:TB/class/[Term]<term%200..1-++[TreatmentDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Diagnosis]++-%20diagnosis_term%200..1>[TreatmentDescriptor],[Treatment]++-%20treatment_term%200..1>[TreatmentDescriptor],[Descriptor]^-[TreatmentDescriptor],[Treatment],[Term],[Qualifier],[Diagnosis],[Descriptor],[AnatomicalEntityDescriptor])
 ...
 *  **None** *[diagnosis_term](diagnosis_term.md)*  <sub>0..1</sub>  **[TreatmentDescriptor](TreatmentDescriptor.md)**
 *  **None** *[treatment_term](treatment_term.md)*  <sub>0..1</sub>  **[TreatmentDescriptor](TreatmentDescriptor.md)**
 ...
 * [TreatmentDescriptor➞term](TreatmentDescriptor_term.md)  <sub>0..1</sub>
