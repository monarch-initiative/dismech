...
URI: [dismech:OrganismDescriptor](https://w3id.org/monarch-initiative/dismech/OrganismDescriptor)


[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Term]<term%200..1-++[OrganismDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Dataset]++-%20organism%200..1>[OrganismDescriptor],[Descriptor]^-[OrganismDescriptor],[Descriptor],[Dataset],[AnatomicalEntityDescriptor])](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Term]<term%200..1-++[OrganismDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Dataset]++-%20organism%200..1>[OrganismDescriptor],[Descriptor]^-[OrganismDescriptor],[Descriptor],[Dataset],[AnatomicalEntityDescriptor])
 ...
 *  **None** *[organism](organism.md)*  <sub>0..1</sub>  **[OrganismDescriptor](OrganismDescriptor.md)**
 ...
 * [OrganismDescriptor➞term](OrganismDescriptor_term.md)  <sub>0..1</sub>
