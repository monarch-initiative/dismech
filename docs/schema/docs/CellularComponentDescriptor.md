...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Descriptor],[Term]<term%200..1-++[CellularComponentDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Pathophysiology]++-%20cellular_components%200..*>[CellularComponentDescriptor],[Descriptor]^-[CellularComponentDescriptor],[Pathophysiology],[AnatomicalEntityDescriptor])](https://yuml.me/diagram/nofunky;dir:TB/class/[Term],[Qualifier],[Descriptor],[Term]<term%200..1-++[CellularComponentDescriptor&#124;preferred_term(i):string;description(i):string%20%3F;modifier(i):ModifierEnum%20%3F;laterality(i):LateralityEnum%20%3F],[Pathophysiology]++-%20cellular_components%200..*>[CellularComponentDescriptor],[Descriptor]^-[CellularComponentDescriptor],[Pathophysiology],[AnatomicalEntityDescriptor])
 ...
 *  **None** *[cellular_components](cellular_components.md)*  <sub>0..\*</sub>  **[CellularComponentDescriptor](CellularComponentDescriptor.md)**
 ...
 * [CellularComponentDescriptor➞term](CellularComponentDescriptor_term.md)  <sub>0..1</sub>
