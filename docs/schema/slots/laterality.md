...
_Laterality qualifier (left, right, or bilateral)_





URI: [dismech:slot/laterality](https://w3id.org/monarch-initiative/dismech/slot/laterality)
Alias: laterality
...
| Property | Value |
| --- | --- |
| Range | [LateralityEnum](../enums/LateralityEnum.md) |
...
| ---  | ---  |
| self | dismech:laterality |
| native | dismech:laterality |
