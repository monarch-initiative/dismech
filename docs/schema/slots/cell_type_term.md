...
_CL term for the cell type_





URI: [dismech:slot/cell_type_term](https://w3id.org/monarch-initiative/dismech/slot/cell_type_term)
...
| ---  | ---  |
| self | dismech:cell_type_term |
| native | dismech:cell_type_term |
