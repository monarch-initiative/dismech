...
_Probability or fraction of A before B in an EHR signal_





URI: [dismech:slot/a_before_b](https://w3id.org/monarch-initiative/dismech/slot/a_before_b)
Alias: a_before_b
...
| ---  | ---  |
| self | dismech:a_before_b |
| native | dismech:a_before_b |
