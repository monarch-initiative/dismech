...
_Probability or fraction of A and B occurring in the same time window_





URI: [dismech:slot/same_time](https://w3id.org/monarch-initiative/dismech/slot/same_time)
Alias: same_time
...
| ---  | ---  |
| self | dismech:same_time |
| native | dismech:same_time |
