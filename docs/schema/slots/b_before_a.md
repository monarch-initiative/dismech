...
_Probability or fraction of B before A in an EHR signal_





URI: [dismech:slot/b_before_a](https://w3id.org/monarch-initiative/dismech/slot/b_before_a)
Alias: b_before_a
...
| ---  | ---  |
| self | dismech:b_before_a |
| native | dismech:b_before_a |
