...
_Temporal qualifier for this descriptor (e.g., acute, chronic, recurrent)_





URI: [dismech:slot/temporality](https://w3id.org/monarch-initiative/dismech/slot/temporality)
Alias: temporality
...
| Property | Value |
| --- | --- |
| Range | [TemporalityEnum](../enums/TemporalityEnum.md) |
...
| ---  | ---  |
| self | dismech:temporality |
| native | dismech:temporality |
