...
_First disease in a comorbidity pair_





URI: [dismech:slot/disease_a](https://w3id.org/monarch-initiative/dismech/slot/disease_a)
Alias: disease_a
...
| ---  | ---  |
| self | dismech:disease_a |
| native | dismech:disease_a |
