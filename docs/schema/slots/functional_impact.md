...
URI: [dismech:slot/functional_impact](https://w3id.org/monarch-initiative/dismech/slot/functional_impact)
...
| ---  | ---  |
| self | dismech:functional_impact |
| native | dismech:functional_impact |
