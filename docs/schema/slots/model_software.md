...
_Software/toolbox for running the model (e.g., COBRApy, COBRA Toolbox)_





URI: [dismech:slot/model_software](https://w3id.org/monarch-initiative/dismech/slot/model_software)
...
| ---  | ---  |
| self | dismech:model_software |
| native | dismech:model_software |
