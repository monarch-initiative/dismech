# Enum: LysosomalStorageEnum 




_Classification of lysosomal storage diseases by accumulated substrate type. Values link to MONDO disease grouping terms._
...
description: Classification of lysosomal storage diseases by accumulated substrate
  type. Values link to MONDO disease grouping terms.
from_schema: https://w3id.org/monarch-initiative/dismech
rank: 1000
enum_uri: MONDO:0002561
permissible_values:
  sphingolipidosis:
    text: sphingolipidosis
    description: Accumulation of sphingolipids (Gaucher, Fabry, Niemann-Pick, Krabbe,
      etc.)
