# Enum: PhenotypeCategoryEnum 




_Broad phenotype categories from the Human Phenotype Ontology. Each value corresponds to a direct child of HP:0000118 (Phenotypic abnormality)._
...
description: Broad phenotype categories from the Human Phenotype Ontology. Each value
  corresponds to a direct child of HP:0000118 (Phenotypic abnormality).
from_schema: https://w3id.org/monarch-initiative/dismech
rank: 1000
permissible_values:
  Blood:
    text: Blood
    description: Abnormalities of the hematopoietic system including anemias, coagulopathies,
  ...
  Cellular:
    text: Cellular
    description: Abnormalities at the cellular level including cell morphology and
      behavior
    meaning: HP:0025354
  ...
  Growth:
    text: Growth
    description: Abnormalities of growth including short stature, tall stature, and
      growth delay
    meaning: HP:0001507
