...
URI: [dismech:class/RegimenDescriptor](https://w3id.org/monarch-initiative/dismech/class/RegimenDescriptor)
...
```mermaid
 classDiagram
    ...
    click RegimenDescriptor href "../../classes/RegimenDescriptor/"
      ...
      RegimenDescriptor : clinical_course
        
          
    
        
        
        RegimenDescriptor --> "0..1" ClinicalCourseEnum : clinical_course
      ...
      RegimenDescriptor : onset
        
          
    
        
        
        RegimenDescriptor --> "0..1" OnsetDescriptor : onset
      ...
      RegimenDescriptor : severity
        
          
    
        
        
        RegimenDescriptor --> "0..1" Any : severity
        click Any href "../../classes/Any/"
    

        
      RegimenDescriptor : spatial_extent
        
          
    
        
        
        RegimenDescriptor --> "0..1" SpatialExtentEnum : spatial_extent
        click SpatialExtentEnum href "../../enums/SpatialExtentEnum/"
    

        
      RegimenDescriptor : temporality
        
          
    
        
        
        RegimenDescriptor --> "0..1" TemporalityEnum : temporality
      ...
      RegimenDescriptor : term
        ...
        RegimenDescriptor --> "0..1 _recommended_" Term : term
...
| [term](../slots/term.md) | 0..1 _recommended_ <br/> [Term](../classes/Term.md) | Optional NCIT regimen term reference | [Descriptor](../classes/Descriptor.md) |
...
| ---  | --- | --- | --- |
| [Treatment](../classes/Treatment.md) | [regimen_term](../slots/regimen_term.md) | range | [RegimenDescriptor](../classes/RegimenDescriptor.md) |
