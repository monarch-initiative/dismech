...
# Class: BiomarkerDescriptor 


_A descriptor for biomarkers, bindable to NCIT_





URI: [dismech:class/BiomarkerDescriptor](https://w3id.org/monarch-initiative/dismech/class/BiomarkerDescriptor)
...
```mermaid
 classDiagram
    ...
    click BiomarkerDescriptor href "../../classes/BiomarkerDescriptor/"
      ...
      BiomarkerDescriptor : clinical_course
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" ClinicalCourseEnum : clinical_course
        click ClinicalCourseEnum href "../../enums/ClinicalCourseEnum/"
    

        
      BiomarkerDescriptor : description
        
      BiomarkerDescriptor : laterality
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" LateralityEnum : laterality
        click LateralityEnum href "../../enums/LateralityEnum/"
    

        
      BiomarkerDescriptor : located_in
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" AnatomicalEntityDescriptor : located_in
        click AnatomicalEntityDescriptor href "../../classes/AnatomicalEntityDescriptor/"
    

        
      BiomarkerDescriptor : modifier
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" ModifierEnum : modifier
        click ModifierEnum href "../../enums/ModifierEnum/"
    

        
      BiomarkerDescriptor : onset
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" OnsetDescriptor : onset
        click OnsetDescriptor href "../../classes/OnsetDescriptor/"
    

        
      BiomarkerDescriptor : preferred_term
        
      BiomarkerDescriptor : qualifiers
        
          
    
        
        
        BiomarkerDescriptor --> "*" Qualifier : qualifiers
        click Qualifier href "../../classes/Qualifier/"
    

        
      BiomarkerDescriptor : severity
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" Any : severity
        click Any href "../../classes/Any/"
    

        
      BiomarkerDescriptor : spatial_extent
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" SpatialExtentEnum : spatial_extent
        click SpatialExtentEnum href "../../enums/SpatialExtentEnum/"
    

        
      BiomarkerDescriptor : temporality
        
          
    
        
        
        BiomarkerDescriptor --> "0..1" TemporalityEnum : temporality
        click TemporalityEnum href "../../enums/TemporalityEnum/"
    

        
      BiomarkerDescriptor : term
        
          
    
        
        
        BiomarkerDescriptor --> "0..1 _recommended_" Term : term
...
| [term](../slots/term.md) | 0..1 _recommended_ <br/> [Term](../classes/Term.md) | NCIT biomarker term reference | [Descriptor](../classes/Descriptor.md) |
...
| ---  | --- | --- | --- |
| [ExperimentalReadout](../classes/ExperimentalReadout.md) | [biomarker_term](../slots/biomarker_term.md) | range | [BiomarkerDescriptor](../classes/BiomarkerDescriptor.md) |
| [Biochemical](../classes/Biochemical.md) | [biomarker_term](../slots/biomarker_term.md) | range | [BiomarkerDescriptor](../classes/BiomarkerDescriptor.md) |
...
| ---  | ---  |
| self | dismech:BiomarkerDescriptor |
| native | dismech:BiomarkerDescriptor |
...
<details>
```yaml
name: BiomarkerDescriptor
description: A descriptor for biomarkers, bindable to NCIT
