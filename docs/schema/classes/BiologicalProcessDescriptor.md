...
# Class: BiologicalProcessDescriptor 


_A descriptor for biological processes, bindable to Gene Ontology (GO)_





URI: [dismech:class/BiologicalProcessDescriptor](https://w3id.org/monarch-initiative/dismech/class/BiologicalProcessDescriptor)
...
```mermaid
 classDiagram
    ...
    click BiologicalProcessDescriptor href "../../classes/BiologicalProcessDescriptor/"
      ...
      BiologicalProcessDescriptor : clinical_course
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" ClinicalCourseEnum : clinical_course
        click ClinicalCourseEnum href "../../enums/ClinicalCourseEnum/"
    

        
      BiologicalProcessDescriptor : description
        
      BiologicalProcessDescriptor : laterality
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" LateralityEnum : laterality
        click LateralityEnum href "../../enums/LateralityEnum/"
    

        
      BiologicalProcessDescriptor : located_in
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" AnatomicalEntityDescriptor : located_in
        click AnatomicalEntityDescriptor href "../../classes/AnatomicalEntityDescriptor/"
    

        
      BiologicalProcessDescriptor : modifier
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" ModifierEnum : modifier
        click ModifierEnum href "../../enums/ModifierEnum/"
    

        
      BiologicalProcessDescriptor : onset
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" OnsetDescriptor : onset
        click OnsetDescriptor href "../../classes/OnsetDescriptor/"
    

        
      BiologicalProcessDescriptor : preferred_term
        
      BiologicalProcessDescriptor : qualifiers
        
          
    
        
        
        BiologicalProcessDescriptor --> "*" Qualifier : qualifiers
        click Qualifier href "../../classes/Qualifier/"
    

        
      BiologicalProcessDescriptor : severity
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" Any : severity
        click Any href "../../classes/Any/"
    

        
      BiologicalProcessDescriptor : spatial_extent
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" SpatialExtentEnum : spatial_extent
        click SpatialExtentEnum href "../../enums/SpatialExtentEnum/"
    

        
      BiologicalProcessDescriptor : temporality
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1" TemporalityEnum : temporality
        click TemporalityEnum href "../../enums/TemporalityEnum/"
    

        
      BiologicalProcessDescriptor : term
        
          
    
        
        
        BiologicalProcessDescriptor --> "0..1 _recommended_" Term : term
...
| [term](../slots/term.md) | 0..1 _recommended_ <br/> [Term](../classes/Term.md) | Optional GO biological process term reference | [Descriptor](../classes/Descriptor.md) |
...
| ---  | --- | --- | --- |
| [ExperimentalPerturbation](../classes/ExperimentalPerturbation.md) | [biological_processes](../slots/biological_processes.md) | range | [BiologicalProcessDescriptor](../classes/BiologicalProcessDescriptor.md) |
| [ExperimentalReadout](../classes/ExperimentalReadout.md) | [biological_processes](../slots/biological_processes.md) | range | [BiologicalProcessDescriptor](../classes/BiologicalProcessDescriptor.md) |
| [Pathophysiology](../classes/Pathophysiology.md) | [biological_processes](../slots/biological_processes.md) | range | [BiologicalProcessDescriptor](../classes/BiologicalProcessDescriptor.md) |
| [Pathophysiology](../classes/Pathophysiology.md) | [pathways](../slots/pathways.md) | range | [BiologicalProcessDescriptor](../classes/BiologicalProcessDescriptor.md) |
| [LogicalCriterion](../classes/LogicalCriterion.md) | [biological_processes](../slots/biological_processes.md) | range | [BiologicalProcessDescriptor](../classes/BiologicalProcessDescriptor.md) |
| [DifferentiatingMechanism](../classes/DifferentiatingMechanism.md) | [biological_processes](../slots/biological_processes.md) | range | [BiologicalProcessDescriptor](../classes/BiologicalProcessDescriptor.md) |
...
| ---  | ---  |
| self | dismech:BiologicalProcessDescriptor |
| native | dismech:BiologicalProcessDescriptor |
...
<details>
```yaml
name: BiologicalProcessDescriptor
...
attributes:
  preferred_term:
    ...
    owner: BiologicalProcessDescriptor
    domain_of:
    - Descriptor
    - ConditionDescriptor
    range: string
