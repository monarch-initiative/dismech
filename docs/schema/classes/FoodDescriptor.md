...
_A descriptor for foods, beverages, nutrients, minerals, and supplements, bindable to FOODON or CHEBI_





URI: [dismech:class/FoodDescriptor](https://w3id.org/monarch-initiative/dismech/class/FoodDescriptor)
...
```mermaid
 classDiagram
    ...
    click FoodDescriptor href "../../classes/FoodDescriptor/"
      ...
      FoodDescriptor : clinical_course
        
          
    
        
        
        FoodDescriptor --> "0..1" ClinicalCourseEnum : clinical_course
        click ClinicalCourseEnum href "../../enums/ClinicalCourseEnum/"
    

        
      FoodDescriptor : description
        
      FoodDescriptor : laterality
        
          
    
        
        
        FoodDescriptor --> "0..1" LateralityEnum : laterality
        click LateralityEnum href "../../enums/LateralityEnum/"
    

        
      FoodDescriptor : located_in
        
          
    
        
        
        FoodDescriptor --> "0..1" AnatomicalEntityDescriptor : located_in
        click AnatomicalEntityDescriptor href "../../classes/AnatomicalEntityDescriptor/"
    

        
      FoodDescriptor : modifier
        
          
    
        
        
        FoodDescriptor --> "0..1" ModifierEnum : modifier
        click ModifierEnum href "../../enums/ModifierEnum/"
    

        
      FoodDescriptor : onset
        
          
    
        
        
        FoodDescriptor --> "0..1" OnsetDescriptor : onset
        click OnsetDescriptor href "../../classes/OnsetDescriptor/"
    

        
      FoodDescriptor : preferred_term
        
      FoodDescriptor : qualifiers
        
          
    
        
        
        FoodDescriptor --> "*" Qualifier : qualifiers
        click Qualifier href "../../classes/Qualifier/"
    

        
      FoodDescriptor : severity
        
          
    
        
        
        FoodDescriptor --> "0..1" Any : severity
        click Any href "../../classes/Any/"
    

        
      FoodDescriptor : spatial_extent
        
          
    
        
        
        FoodDescriptor --> "0..1" SpatialExtentEnum : spatial_extent
        click SpatialExtentEnum href "../../enums/SpatialExtentEnum/"
    

        
      FoodDescriptor : temporality
        
          
    
        
        
        FoodDescriptor --> "0..1" TemporalityEnum : temporality
      ...
      FoodDescriptor : term
        ...
        FoodDescriptor --> "0..1 _recommended_" Term : term
...
| [term](../slots/term.md) | 0..1 _recommended_ <br/> [Term](../classes/Term.md) | Optional FOODON or CHEBI dietary entity term reference | [Descriptor](../classes/Descriptor.md) |
...
| ---  | --- | --- | --- |
| [DietaryModification](../classes/DietaryModification.md) | [food](../slots/food.md) | range | [FoodDescriptor](../classes/FoodDescriptor.md) |
| [Environmental](../classes/Environmental.md) | [food_source](../slots/food_source.md) | range | [FoodDescriptor](../classes/FoodDescriptor.md) |
| [InfectiousAgent](../classes/InfectiousAgent.md) | [food_source](../slots/food_source.md) | range | [FoodDescriptor](../classes/FoodDescriptor.md) |
...
* Use FOODON for specific foods, beverages, food products, and dietary sources
* Use CHEBI when the dietary target is an exact nutrient, mineral, vitamin, or supplement
...
| ---  | ---  |
| self | dismech:FoodDescriptor |
| native | dismech:FoodDescriptor |
...
```yaml
name: FoodDescriptor
description: A descriptor for foods, beverages, nutrients, minerals, and supplements,
  bindable to FOODON or CHEBI
comments:
- Use FOODON for specific foods, beverages, food products, and dietary sources
- Use CHEBI when the dietary target is an exact nutrient, mineral, vitamin, or supplement
...
slot_usage:
  term:
    name: term
    description: Optional FOODON or CHEBI dietary entity term reference
    bindings:
    - range: FoodTerm
