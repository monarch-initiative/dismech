...
URI: [dismech:class/LifeCycleStageDescriptor](https://w3id.org/monarch-initiative/dismech/class/LifeCycleStageDescriptor)
...
```mermaid
 classDiagram
    ...
    click LifeCycleStageDescriptor href "../../classes/LifeCycleStageDescriptor/"
      ...
      LifeCycleStageDescriptor : clinical_course
        
          
    
        
        
        LifeCycleStageDescriptor --> "0..1" ClinicalCourseEnum : clinical_course
      ...
      LifeCycleStageDescriptor : onset
        
          
    
        
        
        LifeCycleStageDescriptor --> "0..1" OnsetDescriptor : onset
      ...
      LifeCycleStageDescriptor : severity
        
          
    
        
        
        LifeCycleStageDescriptor --> "0..1" Any : severity
        click Any href "../../classes/Any/"
    

        
      LifeCycleStageDescriptor : spatial_extent
        
          
    
        
        
        LifeCycleStageDescriptor --> "0..1" SpatialExtentEnum : spatial_extent
        click SpatialExtentEnum href "../../enums/SpatialExtentEnum/"
    

        
      LifeCycleStageDescriptor : temporality
        
          
    
        
        
        LifeCycleStageDescriptor --> "0..1" TemporalityEnum : temporality
      ...
      LifeCycleStageDescriptor : term
        ...
        LifeCycleStageDescriptor --> "0..1 _recommended_" Term : term
...
| [term](../slots/term.md) | 0..1 _recommended_ <br/> [Term](../classes/Term.md) | OPL life cycle stage term reference | [Descriptor](../classes/Descriptor.md) |
...
| ---  | --- | --- | --- |
| [AgentLifeCycleStage](../classes/AgentLifeCycleStage.md) | [life_cycle_stage_term](../slots/life_cycle_stage_term.md) | range | [LifeCycleStageDescriptor](../classes/LifeCycleStageDescriptor.md) |
