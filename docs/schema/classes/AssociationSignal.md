...
URI: [dismech:class/AssociationSignal](https://w3id.org/monarch-initiative/dismech/class/AssociationSignal)
...
```mermaid
 classDiagram
    class AssociationSignal
    click AssociationSignal href "../../classes/AssociationSignal/"
      ...
      AssociationSignal : directionality
        ...
        click ComorbidityDirectionEnum href "../../enums/ComorbidityDirectionEnum/"
      ...
      AssociationSignal : evidence
        ...
        AssociationSignal --> "* _recommended_" EvidenceItem : evidence
      ...
      AssociationSignal : go_enrichment
        ...
        click GOEnrichment href "../../classes/GOEnrichment/"
      ...
      AssociationSignal : method
        ...
        click AssociationSignalMethodEnum href "../../enums/AssociationSignalMethodEnum/"
      ...
      AssociationSignal : source
        ...
        click AssociationSignalSourceEnum href "../../enums/AssociationSignalSourceEnum/"
...
| ---  | --- | --- | --- |
| [source](../slots/source.md) | 0..1 <br/> [AssociationSignalSourceEnum](../enums/AssociationSignalSourceEnum.md) | Source dataset or provenance label | direct |
| [method](../slots/method.md) | 0..1 <br/> [AssociationSignalMethodEnum](../enums/AssociationSignalMethodEnum.md) | Method or pipeline name | direct |
| [signal_disorder_a_id](../slots/signal_disorder_a_id.md) | 0..1 <br/> [Uriorcurie](../types/Uriorcurie.md) | Original identifier for disorder A in this signal (CURIE, e | direct |
| [signal_disorder_b_id](../slots/signal_disorder_b_id.md) | 0..1 <br/> [Uriorcurie](../types/Uriorcurie.md) | Original identifier for disorder B in this signal (CURIE, e | direct |
| [population](../slots/population.md) | 0..1 <br/> [String](../types/String.md) | Population or cohort description (e | direct |
| [demographics](../slots/demographics.md) | 0..1 <br/> [Demographics](../classes/Demographics.md) | Demographic stratification for an association signal | direct |
...
| [disorder_a_count](../slots/disorder_a_count.md) | 0..1 <br/> [Integer](../types/Integer.md) | Number of records/patients carrying disorder A in the source dataset | direct |
| [disorder_b_count](../slots/disorder_b_count.md) | 0..1 <br/> [Integer](../types/Integer.md) | Number of records/patients carrying disorder B in the source dataset | direct |
| [pair_count](../slots/pair_count.md) | 0..1 <br/> [Integer](../types/Integer.md) | Number of records/patients with co-occurrence of disorder A and disorder B in... | direct |
...
| [statistics](../slots/statistics.md) | 0..1 <br/> [AssociationStatistics](../classes/AssociationStatistics.md) | Statistical summary for an association signal | direct |
| [go_enrichment](../slots/go_enrichment.md) | 0..1 <br/> [GOEnrichment](../classes/GOEnrichment.md) | GO enrichment results associated with a signal | direct |
...
| ---  | --- | --- | --- |
| [ComorbidityAssociation](../classes/ComorbidityAssociation.md) | [association_signals](../slots/association_signals.md) | range | [AssociationSignal](../classes/AssociationSignal.md) |
