...
# Class: MolecularFunctionDescriptor 


_A descriptor for molecular functions, bindable to Gene Ontology (GO)_





URI: [dismech:class/MolecularFunctionDescriptor](https://w3id.org/monarch-initiative/dismech/class/MolecularFunctionDescriptor)
...
```mermaid
 classDiagram
    ...
    click MolecularFunctionDescriptor href "../../classes/MolecularFunctionDescriptor/"
      ...
      MolecularFunctionDescriptor : clinical_course
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" ClinicalCourseEnum : clinical_course
        click ClinicalCourseEnum href "../../enums/ClinicalCourseEnum/"
    

        
      MolecularFunctionDescriptor : description
        
      MolecularFunctionDescriptor : laterality
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" LateralityEnum : laterality
        click LateralityEnum href "../../enums/LateralityEnum/"
    

        
      MolecularFunctionDescriptor : located_in
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" AnatomicalEntityDescriptor : located_in
        click AnatomicalEntityDescriptor href "../../classes/AnatomicalEntityDescriptor/"
    

        
      MolecularFunctionDescriptor : modifier
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" ModifierEnum : modifier
        click ModifierEnum href "../../enums/ModifierEnum/"
    

        
      MolecularFunctionDescriptor : onset
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" OnsetDescriptor : onset
        click OnsetDescriptor href "../../classes/OnsetDescriptor/"
    

        
      MolecularFunctionDescriptor : preferred_term
        
      MolecularFunctionDescriptor : qualifiers
        
          
    
        
        
        MolecularFunctionDescriptor --> "*" Qualifier : qualifiers
        click Qualifier href "../../classes/Qualifier/"
    

        
      MolecularFunctionDescriptor : severity
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" Any : severity
        click Any href "../../classes/Any/"
    

        
      MolecularFunctionDescriptor : spatial_extent
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" SpatialExtentEnum : spatial_extent
        click SpatialExtentEnum href "../../enums/SpatialExtentEnum/"
    

        
      MolecularFunctionDescriptor : temporality
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1" TemporalityEnum : temporality
        click TemporalityEnum href "../../enums/TemporalityEnum/"
    

        
      MolecularFunctionDescriptor : term
        
          
    
        
        
        MolecularFunctionDescriptor --> "0..1 _recommended_" Term : term
...
| [term](../slots/term.md) | 0..1 _recommended_ <br/> [Term](../classes/Term.md) | Optional GO molecular function term reference | [Descriptor](../classes/Descriptor.md) |
...
| ---  | --- | --- | --- |
| [Pathophysiology](../classes/Pathophysiology.md) | [molecular_functions](../slots/molecular_functions.md) | range | [MolecularFunctionDescriptor](../classes/MolecularFunctionDescriptor.md) |
...
| ---  | ---  |
| self | dismech:MolecularFunctionDescriptor |
| native | dismech:MolecularFunctionDescriptor |
...
<details>
```yaml
name: MolecularFunctionDescriptor
description: A descriptor for molecular functions, bindable to Gene Ontology (GO)
from_schema: https://w3id.org/monarch-initiative/dismech
is_a: Descriptor
slot_usage:
  term:
    name: term
    description: Optional GO molecular function term reference
    bindings:
...
attributes:
  preferred_term:
    ...
    owner: MolecularFunctionDescriptor
    domain_of:
    - Descriptor
    - ConditionDescriptor
    range: string
