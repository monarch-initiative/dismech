...
# Class: ImagingFindingDescriptor 


_A descriptor for an in-vivo imaging finding, bindable to the NCIT Imaging Finding branch (C176708 / C199145) or an HP imaging-observable phenotype. Inherits located_in (UBERON body site), laterality, spatial_extent, and modifier from Descriptor for post-composition._





URI: [dismech:class/ImagingFindingDescriptor](https://w3id.org/monarch-initiative/dismech/class/ImagingFindingDescriptor)
...
```mermaid
 classDiagram
    ...
    click ImagingFindingDescriptor href "../../classes/ImagingFindingDescriptor/"
      ...
      ImagingFindingDescriptor : clinical_course
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" ClinicalCourseEnum : clinical_course
        click ClinicalCourseEnum href "../../enums/ClinicalCourseEnum/"
    

        
      ImagingFindingDescriptor : description
        
      ImagingFindingDescriptor : laterality
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" LateralityEnum : laterality
        click LateralityEnum href "../../enums/LateralityEnum/"
    

        
      ImagingFindingDescriptor : located_in
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" AnatomicalEntityDescriptor : located_in
        click AnatomicalEntityDescriptor href "../../classes/AnatomicalEntityDescriptor/"
    

        
      ImagingFindingDescriptor : modifier
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" ModifierEnum : modifier
        click ModifierEnum href "../../enums/ModifierEnum/"
    

        
      ImagingFindingDescriptor : onset
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" OnsetDescriptor : onset
        click OnsetDescriptor href "../../classes/OnsetDescriptor/"
    

        
      ImagingFindingDescriptor : preferred_term
        
      ImagingFindingDescriptor : qualifiers
        
          
    
        
        
        ImagingFindingDescriptor --> "*" Qualifier : qualifiers
        click Qualifier href "../../classes/Qualifier/"
    

        
      ImagingFindingDescriptor : severity
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" Any : severity
        click Any href "../../classes/Any/"
    

        
      ImagingFindingDescriptor : spatial_extent
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" SpatialExtentEnum : spatial_extent
        click SpatialExtentEnum href "../../enums/SpatialExtentEnum/"
    

        
      ImagingFindingDescriptor : temporality
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1" TemporalityEnum : temporality
        click TemporalityEnum href "../../enums/TemporalityEnum/"
    

        
      ImagingFindingDescriptor : term
        
          
    
        
        
        ImagingFindingDescriptor --> "0..1 _recommended_" Term : term
...
| [term](../slots/term.md) | 0..1 _recommended_ <br/> [Term](../classes/Term.md) | NCIT imaging-finding or HP phenotype term reference | [Descriptor](../classes/Descriptor.md) |
...
| ---  | --- | --- | --- |
| [ImagingFinding](../classes/ImagingFinding.md) | [imaging_finding_term](../slots/imaging_finding_term.md) | range | [ImagingFindingDescriptor](../classes/ImagingFindingDescriptor.md) |
...
* Use for imaging appearances (white-matter lesions, atrophy, enhancement, hyperintensity)
* Body site goes in located_in (UBERON); focal/multifocal/diffuse in spatial_extent
...
| ---  | ---  |
| self | dismech:ImagingFindingDescriptor |
| native | dismech:ImagingFindingDescriptor |
...
<details>
```yaml
name: ImagingFindingDescriptor
description: A descriptor for an in-vivo imaging finding, bindable to the NCIT Imaging
  Finding branch (C176708 / C199145) or an HP imaging-observable phenotype. Inherits
  located_in (UBERON body site), laterality, spatial_extent, and modifier from Descriptor
...
slot_usage:
  term:
    name: term
    description: NCIT imaging-finding or HP phenotype term reference
    bindings:
...
attributes:
  preferred_term:
    ...
    owner: ImagingFindingDescriptor
    domain_of:
    - Descriptor
    - ConditionDescriptor
    range: string
