...
With HPO alone these score similarly. With mechanism context:
- FA model traces pancytopenia to **DNA repair defect → bone marrow failure**
- DBA model traces anemia to **ribosomal biogenesis → erythroid progenitor apoptosis**
...
This finding drove targeted curation:
- Strengthened **Th17 pathophysiology** (GO:0072538) across Crohn's, Psoriasis, AS, MS, RA
- Created new **Atopic Dermatitis** entry (previously missing, 16 significant cluster-disease pairs)
- Added IRF4, BATF, STAT3 as pleiotropic autoimmune risk genes across 12 disease entries
