...
> repo-wide mechanical backfill (`just backfill-reference-titles`) added the
> remaining 3,287 missing titles across 445 files in one pass, sourcing every
> title verbatim from `references_cache/` frontmatter. `find_missing_reference_titles.py`
> now reports **0**.
>
