...
Title 1 
Towards a Buruli Ulcer Rapid Diagnostic Test that Targets Mycolactone 2 
 3 
Authors 4 
Marina Siirin,1 Bijan Pedram,1 Maria J. Gonzalez-Moa,1 Louisa Warryn,2,3 Rie Yotsu,4,5 Jean M. Saunders,1 5 
Aaron E. Saunders, 6 Richard K. Baldwin,6 Jessica L. Porter,7 Timothy P . Stinear,7 Israel Cruz -Mata,8,9 6 
Dziedzom Komi de Souza,8,10 Gerd Pluschke, 2,3 Marco A. Biamonte1 7 
 8 
1. Drugs & Diagnostics for Tropical Diseases, San Diego, California, United States of America 9 
2. Swiss Tropical and Public Health Institute, Allschwil, Switzerland.  10 
3. University of Basel, Basel, Switzerland. 11 
4. School of Tropical Medicine and Global Health, Nagasaki University, Nagasaki, Japan 12 
5. Department of Tropical Medicine, Tulane School of Public Health and Tropical Medicine, New 13 
Orleans, Louisiana, United States of America 14 
6. NanoComposix, a Fortis Life company, San Diego, California, United States of America 15 
7. Department of Microbiology and Immunology, Doherty Institute, University of Melbourne, 16 
Victoria, Australia 17 
8. Foundation for Innovative New Diagnostics (FIND), Geneva, Switzerland. 18 
9. National School of Public Health, CIBERINFEC, Instituto de Salud Carlos III, Madrid, Spain. 19 
10. Noguchi Memorial Institute, Accra, Ghana. 20 
...
and no powered instrumentation  is required. T he test can detect as little as 3.5 –7 ng of mycolactone 33 
collected on a swab.  34 
Author summary 35 
Buruli ulcer is a neglected tropical disease that affect s the poorest of the poorest  in Africa. Even young 36 
...
hindering access to care, and also because of the l ack of awareness, of reporting system , and of field-53 
...
partners developed a preliminary Target Product Profile (TPP) in 2018 [14] which was revisited in 2022 67 
...
In parallel, a test strip was developed as shown in Figure 3, where a sample pad (glass fiber), nitrocellulose, 104 
...
sample contains significant amounts of mycolactone, the latter saturate s the binding sites on the anti-113 
...
Conjugate. Magnetic gold nanoshells were conjugated to  mouse monoclonal antibody  JD5.1 using 145 
...
Chase buffer. The chase buffer was prepared with 2% proprietary detergent, 0.1% proprietary surfactant, 168 
...
DMSO) diluted in ethan ol by a  factor of 135 to reach a 10 µM concentration. Positive controls were 177 
...
Clinical samples from Ghana were taken at the hospital or health centres as part of the routine diagnostic 190 
...
min prior to imaging and quantitation  with a benchtop reader (Leelu v3.0, Lumos Diagnostics, Carlsbad, 213 
CA).    214 
Procedure to run the assay using a simulated sample ab sorbed onto a swab  (Figure 4, Steps 1 -7). To 215 
...
simulated wound exudates, without employing a swab. With this initial set of optimized conditions, t he 244 
...
developed over 30 minutes.  The fully optimized conditions can be found in the Instructions for Use 258 
...
Test line intensity (Reader  Units) p=0.42 p=0.06
p=0.006
 282 
...
Specificity with cell cultures of different mycobacteria strains. Having developed a test that appeared to 287 
...
mandatory for sample collection but that mycolactone, being so lipophilic with a calculated logP of  9.0 304 
[25], m ay stick to the fibers of which the swab is made, and not be easily extracted into an aqueous 305 
...
(Figure 8A). Based on the quantification of the test line intensiti es, we calculated that 80% of the 310 
...
Optimizing the test conditions to real wound exudates. Having established the performance of the test 320 
...
the field represented a challenging matrix that varie d from patient-to-patient and included blood and 323 
...
negative for Buruli Ulcer by PCR . Some clinical samples contained d ebris and particulates, sometimes in 329 
...
clinical samples as the sample matrix.  366 
 367 
CONFIDENTIAL
Additional BU RDT adjustments for the field 
 High pH of extraction and chase buffer improve test performance with simulated wound 
exudated containing 75 ul of NHS
32
Extraction buffer Chase buffer
 . CC-BY 4.0 International licenseIt is made available under a 
 is the author/funder, who has granted medRxiv a license to display the preprint in perpetuity. (which was not certified by peer review)
The copyright holder for this preprint this version posted January 23, 2024. ; https://doi.org/10.1101/2024.01.23.24301643doi: medRxiv preprint 
...
T/C
 369 
Figure 12. Mycolactone dose response in pooled Buruli ulcer  negative swab 370 
...
problematic cases, the nanoparticles seemed to be especially difficult to recover magnetically. T his 411 
...
mycolactone in wound exudate. The test also met most of the WHO TPP parameters in that it was stable 427 
