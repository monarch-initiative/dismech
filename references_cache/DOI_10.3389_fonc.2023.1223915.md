...
full_text_url: "https://www.frontiersin.org/articles/10.3389/fonc.2023.1223915/pdf?isPublishedV2=False"
oa_status: gold
license: cc-by
local_pdf_path: files/DOI_10.3389_fonc.2023.1223915.pdf
---

# Organoids and metastatic orthotopic mouse model for mismatch repair-deficient colorectal cancer
**Authors:** Yurong Song, Travis D. Kerr, Chelsea Sanders, Lisheng Dai, Shaneen S. Baxter, Brandon Somerville, Ryan N. Baugher, Stephanie D. Mellott, Todd B. Young, Heidi E. Lawhorn, Teri M. Plona, Bingfang Xu, Lei Wei, Qiang Hu, Song Liu, Alan Hutson, Baktiar Karim, Sandra Burkett, Simone Difilippantonio, Ligia Pinto, Johannes Gebert, Matthias Kloor, Steven M. Lipkin, Shizuko Sei, Robert H. Shoemaker
**Journal:** Frontiers in Oncology (2023)
**DOI:** [10.3389/fonc.2023.1223915](https://doi.org/10.3389/fonc.2023.1223915)
...
colorectal cancer
Yurong Song1*, Travis D. Kerr1, Chelsea Sanders2, Lisheng Dai1,
Shaneen S. Baxter1, Brandon Somerville1, Ryan N. Baugher3,
Stephanie D. Mellott3, Todd B. Young3, Heidi E. Lawhorn3,
Teri M. Plona3, Bingfang Xu4, Lei Wei5, Qiang Hu5, Song Liu5,
Alan Hutson5, Baktiar Karim6, Sandra Burkett7,
Simone Diﬁlippantonio2, Ligia Pinto1, Johannes Gebert8,
Matthias Kloor8, Steven M. Lipkin9, Shizuko Sei10
and Robert H. Shoemaker10
1Frederick National Laboratory for Cancer Research, Vaccine, Immunity, and Cancer Directorate,
Frederick, MD, United States, 2Frederick National Laboratory for Cancer Research, Laboratory Animal
Sciences Program, Frederick, MD, United States, 3Frederick National Laboratory for Cancer Research,
Clinical Laboratory Improvement Amendments (CLIA) Molecular Diagnostics Laboratory, Frederick,
MD, United States,
4Frederick National Laboratory for Cancer Research, Genomics Laboratory, Frederick,
MD, United States, 5Department of Biostatistics and Bioinformatics, Roswell Park Comprehensive Cancer
Center, Buffalo, NY, United States, 6Molecular Histopathology Laboratory, Frederick National Laboratory
for Cancer Research, Frederick, MD, United States, 7Molecular Cytogenetics Core Facility, National
Cancer Institute, Frederick, MD, United States, 8Department of Applied Tumor Biology, Institute of
Pathology, University of Heidelberg, Heidelberg, Germany,9Department of Medicine, Weill Cornell
Medical College, Cornell University, New York, NY, United States, 10Chemopreventive Agent
...
mismatch repair de ﬁciency syndrome, resulting in an increased lifetime risk of
...
deﬁcient (MMRd) cancer patients, the overall response rate needs to be improved
...
a Msh2-de ﬁcient mouse model, and followed with a detailed characterization.
...
the ef ﬁcacy of neoantigen-based vaccines or anticancer drugs in combination
with other therapies.
KEYWORDS
mismatch repair de ﬁciency, Lynch syndrome, microsatellite instability, chromosome
...
Germline de ﬁciency in MMR genes (MMRd) leads to Lynch
syndrome (LS) via monoallelic m utation or constitutional
mismatch repair de ﬁciency syndrome (CMMRD) via biallelic
...
replication, especially in codi ng microsatellite regions. The
...
the four de ﬁcient MMR genes. MLH1 and MSH2 mutations are
...
antibody pembrolizumab in hea vily pretreated MMRd/MSI-H
...
an objective response of 45% with pembrolizumab used as a ﬁrst-
...
heterogeneity, elucidate resis tance mechanisms, and test new
...
Abbreviations: B2M, b-2 microglobulin; ChgA, Chromogranin A; CI, conﬁdence
interval; CIN, chromosome instability; CMMRD, constitutional mismatch repair
deﬁciency; CRC, colorectal cancer; dpi, days post implantation; FFPE, formalin-
ﬁxed, paraf ﬁn-embedded; FSM, frameshift mutation; FSP, frameshift peptides;
...
deﬁciency; MNR, mononucleotide repeat; MRI, magnetic resonance imaging;
...
Msh2LoxP/LoxP;Villin-Cre; WT, wildtype.
...
immunode ﬁciency in NSG mice. Organoids and orthotopic
models derived from MMR pro ﬁcient tumors from genetically
engineered mouse mod els (GEMMs) (e.g., ApcMin model) are
...
deﬁciency, can be used to better understand MMRd/MSI-H
...
LoxP/+;Villin-
Cre to Msh2LoxP/LoxP mice. Animals were fed ad libitum on a normal
...
mice following published protocols ( 20, 21). Brie ﬂy, tumors were
...
(Msh2+/+;Villin-Cre+/+) following a modi ﬁed protocol ( 22, 23).
Brieﬂy, intestinal villi were gently scraped off and discarded, and
...
tissue fragments were collected on a sieve and discarded. The ﬂow-
...
RPMI 1640, then puri ﬁed by ﬁltration through 70 µm mesh. The
...
of 1 mL per cryovial were placed in a Corning CoolCell
® container
...
cells was diluted in a ﬁnal volume containing 50% Matrigel for
...
harvested using sterile technique once they reached 1 cm. Brie ﬂy,
...
tumor fragment was placed gently into the right ﬂank by pushing
...
Brieﬂy, the blind-ended pouch of the cecum was exteriorized and
...
cecum moist. A ﬁgure-eight stitch was placed onto the cecum using
...
pulling with serrated forceps to facilitate the in ﬁltration of cancer
...
Tumors were removed and ﬁxed in 10% neutral buffered
formalin overnight, transferred to 70% ethanol, and then
routinely processed and embedded in paraf ﬁn. Hematoxylin and
eosin (H&E) and immunohistoc hemical (IHC) staining were
...
quantiﬁed using a HALO
® image analysis platform (Indica labs,
Albuquerque, NM).
...
reported previously ( 27– 31). PCR ampli ﬁcation was carried out
...
performed using the rhAmpSeq a mplicon sequencing system
(Integrated DNA Technologies IDT, Coralville, IA) with a dual-
indexing strategy. Approximately 55 ng of puri ﬁed DNA was
...
bead-based cleanup, amplicon libraries were sized and quanti ﬁed
using a D1000 ScreenTape on TapeStation (Agilent Technologies,
Santa Clara, CA) and a KAPA q-PCR system (Roche, Frederick,
M D ) .S e q u e n c i n gl i b r a r i e sw e r ed i l u t e dt o4n M ,c o m b i n e d ,a n d
denatured for loading into the sequencing system. The ﬁnal loading
...
For data analysis, index primers on raw reads from FASTQ ﬁles
...
rate distributions were modeled by ﬁtting its VAF from all WT
control samples into a Weibull distribution, then each tumor
sample ’sV A Fw a sc o m p a r e dt ot h e ﬁtted distribution as
previously described ( 32). A sample was de ﬁned as positive when
the sample’s VAF of a mutation was signi ﬁcantly above background
Song et al. 10.3389/fonc.2023.1223915
...
analysis or Sanger sequenci ng as described previously ( 31).
Brie ﬂy, for fragment analysis, all primers were ordered
(Supplementary Table 2 ; Integrated DNA Technologies) and
ampliﬁed on ProFlex PCR System (Thermo Fisher Scienti ﬁc,
...
Ampliﬁed samples were diluted with molecular grade water up to
a 1:15 ratio as needed. A master mix combining Hi-Di ™
Formamide (8.5 µL per reaction; Thermo Fisher Scienti ﬁc),
GeneScan™ 500 LIZ ™ dye size standard (0.5 µL per reaction;
Thermo Fisher Scienti ﬁc), and 1 µL of diluted sample was created
...
3730xl DNA Analyzer (Thermo Fisher Scientiﬁc), using 96 capillary
50 cm array, a DS-33 Matrix Standard Kit (Dye Set 5; Thermo
Fisher Scienti ﬁc), and 3730XL Data Collection Software (version
5.0; Thermo Fisher Scienti ﬁc). Data were then analyzed and
overlayed with GeneMapper ™ software (version 5.0; Thermo
Fisher Scienti ﬁc). Length of the PCR product in the testing
sample was compared to the WT sample and the altered length
was de ﬁned as instability. MSI status was classi ﬁed as MSI-high
(MSI-H) (instability at 2 or mo re microsatellite loci) and
microsatellite stable (MSS) (instability at 1 locus or none).
For Sanger sequencing, primers were designed and ampli ﬁed
(Supplementary Tables 2 , 3). PCR products were puri ﬁed using
...
puri
ﬁed amplicon then proceeded into cycle sequencing with
BigDye ™ Terminator v3.1 Cycle Sequencing Kit and M13
forward and M13 reverse prim ers (Thermo Fisher Scienti ﬁc)
...
v3.1 Kit (Thermo Fisher Scienti ﬁc), and 3730XL Data Collection
...
ampliﬁed using the following conditions: 95°C for 2 minutes, 36
...
Ipswich, MA) at 37°C for 15 minutes and puri ﬁed using the
Ampure XP protocol (Thermo Fisher Scienti ﬁc). Puri ﬁed
amplicons were pooled together based on equal molarity, then
pooled libraries were quanti ﬁed using TapeStation and the ﬁnal
concentration was determined using a Qubit assay (Thermo Fisher
Scientiﬁc). Paired-end sequencing was performed on an Illumina
MiSeq sequencer using MiSeq V2 reagent kits 500-cycles (Illumina).
The sequencing quality was monitored and the raw FASTQ ﬁles
were downloaded for data analysis. Paired-end reads were trimmed
using Trimmomatic ( 33). Top 100-300 most common reads for
each sample were identi ﬁed and sequence reads containing
...
performed as described previously ( 31). Brie ﬂy, organoids were
...
(ThermoFisher Scientiﬁc). Cells were then arrested in metaphase by
...
for 15 minutes at 37°C, and then ﬁxed with methanol:acetic acid 3:1.
...
epi-ﬂuorescence microscope (Imager Z2, Zeiss) and analyzed using
HiSKY 7.2 acquisition softwar e( G e n A S I s ,A p p l i e dS p e c t r a l
...
detected by staining 5 mmf o r m a l i n -ﬁxed, paraf ﬁn-embedded
...
Scanner (Leica Biosystems). Images were analyzed and quanti ﬁed
...
were two-sided and p < 0.05 was considered signi ﬁcant unless
...
colon tumors developed inVCMsh2 mice with 59% and 100% success
...
with an open lumen ﬁlled with dead cells (Supplementary Figure 1C).
To con ﬁrm the Msh2 deletion by Villin-Cre in vivo ,M s h 2I H C
...
IHC, revealing high expre ssion of these markers ( Figure 1A ;
...
summarizes the staining quanti ﬁcation used for Figure 1 .
To determine if the antigen presentation complex was
functional in tumor organoids, ﬂow cytometry analysis of MHC
...
signi ﬁcantly increased compared to non-treated controls,
...
MMRd cells characteristically show MSI-H. To conﬁrm the MSI
status in the tumor organoids, up to seven MSI markers were
assessed in 27 tumor organoids and WT organoids via DNA
fragment length analysis. As e xpected, all tumor organoids
...
showed the similar MSI pro ﬁles ( Supplementary Table 8 ). For
example, 960T2A1 and 960T3D3 were derived from tumors T2
and T3, respectively, from mouse #960. Their MSI pro ﬁle for three
...
whole-chromosome ampliﬁcation (e.g., chr1, 3, 9, and 12), deletion
...
961T3C3 showed high instability (e.g., ampli ﬁcation of
...
VCMsh2 mice. Interestingly, the simi lar mutation frequency was
observed between tumors and tumor -matched mucosa, indicating
that these FSMs driven by Msh2 deletion may not be suf ﬁcient to
drive the tumor development an d that secondary mutations may
be required.
...
found in ﬁve organoid lines derived from the same tumor (586T2),
...
frequency was low in Msh2-de ﬁcient mouse tumor organoids.
...
conﬁrm the expression of Asxl1 since there was no mutant-speci ﬁc
...
A
FIGURE 5
In vivo growth of organoids. (A) Growth of parental organoids 586T2A4 and 961T3C3 by s.c. injection of 1 × 10 6 cells in C57BL/6J recipients (n = 10
...
tumor to reach 500 mm 3 was 26.4 days (95% CI, 21.5 to 31.3) (left panel) and 28.3 days (95% CI, 26.4 to 35) (right panel). TV, tumor volume.
FIGURE 4
...
panels). The median time for a tumor to reach 500 mm 3 was 26.4
...
bottom). This may be because 961T3C3 s.c. tumors were ﬁlled with
...
post implantation (dpi) for ea ch donor group, respectively
...
to a speci ﬁc type of bacteria ( 52). Moreover, organoids have been
...
gene deﬁciency. Shared frameshift neoantigens are ideal for vaccine
...
using either MSS cell lines in syngeneic mice (e.g., MC38 ( 54, 55)o r
CT26 ( 56– 59)) or human MSI-H cell lines (e.g., HCT116) in
immune-deﬁcient mice ( 60, 61). Herein, we described an intra-
...
immunode ﬁcient mice using cell lines derived from human
...
speciﬁc dependence of therapies, assess the ef ﬁcacy of therapies on
...
metastasis ( 56) and evaluating the ef ﬁcacy of immune checkpoint
blockade therapies ( 59
) and other therapies (e.g., recombinant
methioninase to target the methionine (MET)-dependent cancers
(62)). The model described here is the ﬁrst orthotopic model of
...
MSI-H tumors. We are currently assessing the ef ﬁcacy of frameshift
...
important role in organoid growth in vivo.I n d e e d ,L ie ta l .r e p o r t e d
...
most ﬁt clones, presumably with driver mutations, were selected or
...
speciﬁc recruitment of tumor-associated macrophages ( 71). Thus, it
is plausible to assume that tissue-speciﬁc microenvironmental factors,
...
involved in pro-metastatic tu mor growth and mechanisms of
...
speciﬁc anti-BrdU antibody for detection in tumors. Interestingly,
...
organoids derived from Msh2-de ﬁcient tumors were of epithelial
...
consistent with the ﬁnding that about 50% of MMRd/MSI-H
CRC had Lgr5 expression ( 82) and indicates that tumor cells were
initiated either solely from L gr5+ cells (with some of them
...
speciﬁcally deleted in Lgr5+ cells (Lgr5-CreERT2;Msh2ﬂox/-) survived
...
stemness-dependent (although stem cells are much more efﬁcient in
...
initial Apc deletion followed by inﬂammation (86)). It remains to be
...
organoid tumor cells. Some cells showed signi ﬁcant abnormality,
including deletion, tra nslocation, and ampli ﬁcation of whole
chromosomes, while others were normal. This is consistent with
the recent ﬁnding of mixed genomic states of MSI and CIN in CRC
...
(14, 15, 93– 97). In this study, we con ﬁrmed that these tumor
organoids and intra-cecal i mplanted tumors expressed
characteristic FSMs/FSPs with variable mutation frequency and
VAF. The signi ﬁcance of these FSMs/FSPs in tumor progression
...
driven by Msh2 de ﬁciency, had the characteristics of MMRd/MSI-
H tumors and recapitulated the de novo tumors developed in
VCMsh2 mice, with the potential for tumor growth monitoring
by US or MRI. This is the ﬁrst syngeneic model of MMRd/MSI-H
...
signiﬁcance of FSMs and to test targeted interventions. Moreover,
...
addition, organoids derived from Msh2-de ﬁcient small intestine
...
analysis presented here are av ailable upon request from the
...
All authors contributed to t he article and approved the
submitted version.
Funding
...
The content of this publication does not necessarily re ﬂect the views
...
Medicine for providing Msh2LoxP/LoxP mice; the staff at Animal
Research Technical Support (ARTS) for conducting the animal
studies; Dr. Joseph Kalen, Lisa Rif ﬂe, and Lilia Ileva at the Small
...
The reviewer WL declared a shared af ﬁliation with the authors
...
Diagnostic criteria for constitutional mismatch repair de ﬁciency (CMMRD):
...
et al. Colon and endometrial cancers with mismatch repair de ﬁciency can arise from
...
cause of mismatch-repair de ﬁciency in Lynch syndrome-like tumors. Gastroenterol
...
Histological and somatic mutational pro ﬁles of mismatch repair de ﬁcient endometrial
...
mismatch repair-de ﬁcient metastatic colorectal cancer: the phase II checkMate 142
...
Current status and future perspectives. JC l i nT r a n s lR e s (2021) 7(4):511 – 22.
...
repair de ﬁciency predicts response of solid tumors to PD-1 blockade. Science (2017)
...
repair-deﬁcient metastatic colorectal cancer (KEYNOTE-177): ﬁnal analysis of a
randomised, open-label, phase 3 study.
Lancet Oncol (2022) 23(5):659 – 70. doi:
10.1016/S1470-2045(22)00197-8
12. Overman MJ, Lonardi S, Wong KYM, Lenz HJ, Gelsomino F, Aglietta M, et al.
Durable clinical bene ﬁt with nivolumab plus ipilimumab in DNA mismatch repair-
deﬁcient/microsatellite instability-high metastatic colorectal cancer. J Clin Oncol (2018)
...
A, Urban K, et al. Recurrent frameshift ne oantigen vaccine e licits protective
...
15. Kloor M, Reuschenbach M, Pauligk C, Karbach J, Ra ﬁyan MR, Al-Batran SE,
et al. A frameshift peptide neoantigen-based vaccine for mismatch repair-de ﬁcient
cancers: A phase I/IIa clinical trial. Clin Cancer Res (2020) 26(17):4503 – 10. doi:
10.1158/1078-0432.CCR-19-3517
1 6 . L e o n iG ,D ' A l i s eA M ,C o t u g n oG ,L a n g o n eF ,G a r z i aI ,D eL u c i aM ,e ta l .A
genetic vaccine encoding shared canc er neoantigens to treat tumors with
...
10.1111/cas.15737
19. Kucherlapati MH, Lee K, Nguyen AA, Clark AB, Hou H Jr., Rosulek A, et al. An
...
Long-term expansion of epithelial or ganoids from human colon, adenoma,
...
study T-cell and epithelial cell interaction. J Immunol Methods (2015) 421:89
– 95. doi:
...
of coding microsatellite frameshift mutations in DNA mismatch repair-deﬁcient mouse
...
sciadv.abd7703
33. Bolger AM, Lohse M, Usadel B. Trimmomatic: a ﬂexible trimmer for Illumina
...
35. Shin G, Greer SU, Hopmans E, Grimes SM, Lee H, Zhao L, et al. Pro ﬁling diverse
...
identiﬁcation of genes with coding microsatellites mutated in DNA mismatch repair-
deﬁcient cancer cells. Int J Cancer (2001) 93(1):12 – 9. doi: 10.1002/ijc.1299
...
Vaccines for immunoprevention of DNA mismatch repair de ﬁcient cancers. J
Immunother Cancer (2022) 10(6):e004416. doi: 10.1136/jitc-2021-004416
41. Shia J, Ellis NA, Paty PB, Nash GM, Qin J, Of ﬁt K, et al. Value of histopathology
...
colorectal tumor organoid library demonstrates progressive loss of niche factor
...
5 6 .Z h a n gY ,D a v i sC ,R y a nJ ,J a n n e yC ,P e n aM M .D e v e l o p m e n ta n d
...
Continuous sensing of IFNalpha by hepatic endothelial cells shapes a vascular
...
human colon model identiﬁes cancer driver genes. Nat Biotechnol (2016) 34(8):845– 51.
doi: 10.1038/nbt.3586
61. Menen RS, Kaushal S, Snyder CS, Talamini MA, Hoffman RM, Bouvet M.
Detection of colon cancer metastases with ﬂuorescence laparoscopy in orthotopic nude
...
tumor progression and the clinical applications (Review). Oncol Rep (2016) 35
...
(2020) 11:940. doi: 10.3389/ﬁmmu.2020.00940
...
factors underlie heterogeneity of immune cell in ﬁltration and response to
...
et al. Tumor location determines tissue-speci ﬁc recruitment of tumor-associated
...
cells cannot satisfy the spindle assembly checkpoint. Dev Cell (2004) 7(5):637–
51. doi:
...
driving a progenitor cell program. Front Oncol (2022) 12:904479. doi: 10.3389/
fonc.2022.904479
...
82. Jang BG, Kim HS, Chang WY, Bae JM, Kim WH, Kang GH. Expression pro ﬁle of
LGR5 and its prognostic signi ﬁcance in colorectal cancer progression. Am J Pathol
(2018) 188(10):2236– 50. doi: 10.1016/j.ajpath.2018.06.012
83. el Marjou F, Janssen KP, Chang BH, Li M, Hindie V, Chan L, et al. Tissue-
speciﬁc and inducible Cre-mediated recombination in the gut epithelium. Genesis
...
Goette E, et al. Temozolomide increases the number of mismatch repair-de ﬁcient
...
88. Al-Sohaily S, Biankin A, Leong R, Kohonen-Corish M, Warusavitarne J.
...
vaccine targeting multiple neoantigens as strategy to eradicate large tumors combined with
...
vaccines. Front Immunol (2021) 12:757804. doi: 10.3389/ﬁmmu.2021.757804
...
catenin mutations are speci ﬁc for colorectal carcinomas with microsatellite instability
...
Exon 3 beta-catenin mutations are speci ﬁcally associated with colorectal carcinomas in
hereditary non-polyposis colorectal cancer syndrome. Gut (2005) 54(2):264 – 7. doi:
10.1136/gut.2004.048132
103. Ahadova A, von Knebel Doeberitz M, Blaker H, Kloor M. CTNNB1-mutant
