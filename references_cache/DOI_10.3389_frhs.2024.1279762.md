...
CORRESPONDENCE
Natalia Hounsome
n.hounsome@bsms.ac.uk
RECEIVED 18 August 2023
ACCEPTED 04 September 2024
PUBLISHED 18 September 2024
CITATION
Hounsome N, Yirgu R, Middleton J, Cassell JA,
Fekadu A and Davey G (2024) Cost-
effectiveness of mass drug administration for
control of scabies in Ethiopia: a
decision-analytic model.
Front. Health Serv. 4:1279762.
doi: 10.3389/frhs.2024.1279762
COPYRIGHT
© 2024 Hounsome, Yirgu, Middleton, Cassell,
Fekadu and Davey. This is an open-access
...
control of scabies in Ethiopia:
...
and Gail Davey
1,4
1Brighton and Sussex Centre for Global Health Research, Brighton and Sussex Medical School,
University of Sussex, Brighton, United Kingdom, 2Center for Innovative Drug Development and
Therapeutic Trials for Africa (CDT-Africa), Addis Ababa University, Addis Ababa, Ethiopia, 3Department
of Primary Care and Public Health, Brighton and Sussex Medical School, University of Sussex, Brighton,
United Kingdom, 4School of Public Health, Addis Ababa University, Addis Ababa, Ethiopia
Background: The strategies to control scabies in highly endemic
...
KEYWORDS
scabies, mass drug administration, Ethiopia, cost-effectiveness, ivermectin
Abbreviations
API, active pharmaceutical ingredient; DALY, Disability-Adjusted Life Year; ICER, incremental cost-
effectiveness ratio; MDA, mass drug administration; NTD, neglected tropical disease.
...
includes two doses of oral ivermectin (200 μg/kg) given 7 –
14
days apart. Ivermectin is currently not approved for pregnant
women, lactating mothers in the ﬁrst week, and children
...
lymphatic ﬁlariasis). In Ethiopia, the Federal Ministry of Health
implements onchocerciasis and lymphatic ﬁlariasis MDA
...
into existing MDA programme s. While onchocerciasis MDA
...
recommended by the WHO Framework ( 12)a n d ≥15%
...
effective at a speci ﬁed cost-effectiveness threshold. The model
...
Brieﬂy, Ayu Guagusa district ( Figure 1 ) was purposively selected
...
symptoms, taking ivermectin tablets during the last round of
...
out by four nurses and one health of ﬁcer trained in diagnosing
...
with crusted scabies. Questions werealso asked about the return visits
with symptoms of scabies and treatments provided.
Model description
The decision trees used in the model are shown in Figure 2.T h e
...
negotiated price for the ivermectin MDA programme in Fiji, 0.18
...
MDA programme and, therefore, dif ﬁcult to estimate. However,
...
ﬁeld operations during the MDA.
...
The incremental cost-effectiveness ratio (ICER) was de ﬁned as
...
was multiplied by −1t or e ﬂect that a positive outcome was
deﬁned as a decrease in the number of scabies cases (scabies
cases avoided).
...
managing patients with scabies, permethrin was the ﬁrst treatment
of choice for usual care (14 respondents). Three healthcare
professionals also mentioned benzyl benzoate and sulphur cream
as a ﬁrst-line treatment. One respondent reported prescribing
...
TABLE 1 Results of the base-case and deterministic sensitivity analysis of MDA compared to usual care.
Parameter MDA Usual care Difference ICER a Probability cost-effective (%)
Base-case analysis
...
of 100,000. The MDA strategy was not cost-effective at scabies
...
and lymphatic ﬁlariasis, and ivermectin-based onchocerciasis and
lymphatic ﬁlariasis MDA programmes are currently implemented
TABLE 1 Continued
Parameter MDA Usual care Difference ICER a Probability cost-effective (%)
...
in these areas ( 13). Integrating scabies MDA into existing
...
empirical data on the effectiveness of the double-dose ivermectin
...
comparing the safety, ef ﬁcacy, and cost-effectiveness of benzyl
...
populations. The model did not compare any speci ﬁc treatment
...
In contrast to dynamic models ( 23, 24, 26), our model does
...
individuals. We populated the m odel with effectiveness data
...
model-based analysis suggests t hat MDA is unlikely to be cost-
...
and are dif ﬁcult to predict, changing the prevalence numbers in
the model can address this limitation.
This model was based on a study conducted in Ethiopia and
reﬂects the current practice of scabies management in this
...
this was delivered by the existing staff within the onchocerciasis
...
Institutional Review Board (IRB) and Brighton and Sussex
Medical School (BSMS) Research Governance and Ethics
Committee (RGEC). Permission was sought from the Ministry of
Health (MoH), Amhara regional health Bureau, and local
administrative heads before commencing ﬁeldwork. Informed
consent was obtained from the adult study participants and
parents of children <15 years old, and assent from minors 15 – 17
years old in addition to parents ’ or guardians ’ consent. The
...
NH: Formal Analysis, Methodology, Validation, Visualization,
Writing – original draft, Writing – review & editing. RY: Data
curation, Investigation, Writing – original draft, Writing – review
& editing. JM: Conceptualization, Methodology, Supervision,
Writing – review & editing. JC: Conceptualization, Funding
acquisition, Methodology, Writing – review & editing. AF:
Funding acquisition, Methodology, Supervision, Writing – review
& editing. GD: Conceptualization, Funding acquisition,
Methodology, Supervision, Writing – review & editing.
Funding
The author(s) declare ﬁnancial support was received for the
research, authorship, and/or publication of this article. This
research was funded by the UK National Institute for Health and
Care Research (NIHR) for the Global Health Research Unit on
Neglected Tropical Diseases (Grant number 16/136/29). The
views expressed are those of the authors and not necessarily
those of NIHR or the UK Department of Health and Social Care.
Acknowledgments
We thank the ﬁeld team, health care workers from Gimjabet
Hospital, and Awi Zone and Ayu Guagusa District Health
Ofﬁces Administration for their invaluable support with data
collection. We thank Dr. Vasso Anagnostopoulou for supporting
data management and Dr. Saeideh Babashahi for the critical
comments on the model and the manuscript.
Conﬂict of interest
...
1279762/full#supplementary-material
Hounsome et al. 10.3389/frhs.2024.1279762
Frontiers in Health Services 10 frontiersin.org

References
1. World Health Organization. Scabies. Available online at: https://www.who.int/
news-room/fact-sheets/detail/scabies (accessed June 6, 2023).
2. Karimkhani C, Colombara DV, Drucker AM, Norton SA, Hay R, Engelman D,
et al. The global burden of scabies: a cross-sectional analysis from the global
burden of disease study 2015. Lancet Infect Dis . (2017) 17(12):1247 – 54. doi: 10.
1016/S1473-3099(17)30483-8
3. Mellanby K. Scabies in 1976. R Soc Health J . (1977) 97(1):32 – 6. doi: 10.1177/
146642407709700112
4. Thomas C, Coates SJ, Engelman D, Chosidow O, Chang AY. Ectoparasites:
scabies. J Am Acad Dermatol . (2020) 82(3):533 – 48. doi: 10.1016/j.jaad.2019.05.109
5. Akinde CB, Walker S, Ajose A. Systematic review of institutional scabies outbreaks
in sub saharan Africa. Epidemiol Int J . (2023) 7(4). doi: 10.23880/eij-16000273
6. Ministry of Health of Ethiopia. Scabies Outbreak Preparedness and Response
Plan. December 2015. OCHA Services. Humanitarian Response. Available online at:
https://www.humanitarianresponse.info/sites/www.humanitarianresponse.info/ﬁles/
documents/ﬁles/fmoh_scabies_response_plan-_29_dec_2015.docx_.pdf (accessed
June 6, 2023).
7. Enbiale W, Ayalew A. Investigation of a scabies outbreak in drought-affected
areas in Ethiopia. Trop Med Infect Dis. (2018) 3(4):114. doi: 10.3390/
tropicalmed3040114
8. Alebachew H, Mulatu K, Worku M. Scabies outbreak investigation in Addet town,
West Gojjam Zone, Amhara region, Northwest Ethiopia, 2017. Available online at:
https://www.researchsquare.com/article/rs-634/v3 (accessed June 6, 2023).
9. Azene AG, Aragaw AM, Wassie GT. Prevalence and associated factors of scabies
in Ethiopia: systematic review and meta-analysis. BMC Infect Dis . (2020) 20(1):380.
doi: 10.1186/s12879-020-05106-3
10. Enbiale W, Baynie TB, Ayalew A, Gebrehiwot T, Getanew T, Ayal A, et al.
“Stopping the itch ”: mass drug administration for scabies outbreak control covered
for over nine million people in Ethiopia. J Infect Dev Countries . (2020) 14
(06.1):28S– 35. doi: 10.3855/jidc.11701
11. World Health Organization. WHO informal consultation on a framework for
scabies control: World Health Organization Regional Of ﬁce for the Western Paci ﬁc:
Manila, Philippines, 19 – 21 February 2019: meeting report. Available online at:
https://www.who.int/publications/i/item/9789240008069 (accessed June 6, 2023).
12. Engelman D, Marks M, Steer AC, Beshah A, Biswas G, Chosidow O, et al. A
framework for scabies control. PLoS Negl Trop Dis . (2021) 15(9):e0009661. doi: 10.
1371/journal.pntd.0009661
13. The Federal Ministry of Health of Ethiopia. Second Edition of National
Neglected Tropical Diseases Master Plan for Ethiopia, 2016. Available online at:
https://www.afro.who.int/publications/second-edition-national-neglected-tropical-
diseases-master-plan-ethiopia-2016#:∼:text=This%20National%20Master%20Plan%
20for,2016%E2%80%932020%20across%20the%20country (accessed June 6, 2023).
14. Ministry of Health of Ethiopia. Guidelines for onchocerciasis elimination in
Ethiopia (2015). Available online at: https://www.cartercenter.org/resources/pdfs/
news/health_publications/river_blindness/onchocerciasis-elimination-certiﬁcation-
guidelines-ethiopia.pdf (accessed June 6, 2023).
15. Yirgu R, Middleton J, Fekadu A, Cassell JA, Tesfaye A, Jones CI, et al. Scabies in
the amhara region of northern Ethiopia: a cross-sectional study of prevalence,
determinants, clinical presentation and community knowledge. BMJ Open . (2023)
13(10):e075038. doi: 10.1136/bmjopen-2023-075038
16. Weinstein MC, O ’Brien B, Hornberger J, Jackson J, Johannesson M, McCabe C,
...
studies. Value Health . (2003) 6(1):9 – 17. doi: 10.1046/j.1524-4733.2003.00234.x
17. Eddy DM, Hollingworth W, Caro JJ, Tsevat J, McDonald KM, Wong JB, et al.
Model transparency and validation: a report of the ISPOR-SMDM modeling good
research practices task force-7. Value Health . (2012) 15(6):843 – 50. doi: 10.1016/j.
jval.2012.04.012
18. Briggs AH, Weinstein MC, Fenwick EA, Karnon J, Sculpher M, Paltiel A, et al.
Model parameter estimation and uncertainty: a report of the ISPOR-SMDM modeling
good research practices task force-6. Value Health. (2012) 15(6):835– 42. doi: 10.1016/j.
jval.2012.04.014
19. Husereau D, Drummond M, Petrou S, Carswell C, Moher D, Greenberg D, et al.
Consolidated health economic evaluation reporting standards (CHEERS) statement.
Cost Eff Resour Alloc . (2013) 11(1):6. doi: 10.1186/1478-7547-11-6
20. Kim YE, Sicuri E, Tediosi F. Financial and economic costs of the elimination and
eradication of onchocerciasis (river blindness) in Africa. PLoS Negl Trop Dis . (2015) 9
(9):e0004056. doi: 10.1371/journal.pntd.0004056
21. Mow M, Thean LJ, Parnaby M, Mani J, Rafai E, Sahukhan A, et al. Costs of
mass drug administration for scabies in Fiji. PLoS Negl Trop Dis . (2022) 16(2):
e0010147. doi: 10.1371/journal.pntd.0010147
22. Bachewar NP, Thawani VR, Mali SN, Gharpure KJ, Shingade VP, Dakhale GN.
Comparison of safety, ef ﬁcacy, and cost effectiveness of benzyl benzoate, permethrin,
and ivermectin in patients of scabies. Indian J Pharmacol . (2009) 41(1):9 – 14. doi: 10.
4103/0253-7613.48882
23. Gilmore SJ. Control strategies for endemic childhood scabies. PLoS One. (2011)
6(1):e15990. doi: 10.1371/journal.pone.0015990
24. Kinyanjui T, Middleton J, Güttel S, Cassell J, Ross J, House T. Scabies in
residential care homes: modelling, inference and interventions for well-connected
population sub-units. PLoS Comput Biol. (2018) 14(3):e1006046. doi: 10.1371/
journal.pcbi.1006046
25. Bernigaud C, Fernando DD, Lu H, Taylor S, Hartel G, Guillot J, et al. In vitro
ovicidal activity of current and under-development scabicides: which treatments kill
scabies eggs? Br J Dermatol . (2020) 182(2):511 – 3. doi: 10.1111/bjd.18517
26. Lydeamore MJ, Campbell PT, Regan DG, Tong SY, Andrews RM, Steer AC, et al.
A biological model of scabies infection dynamics and treatment informs mass drug
administration strategies to increase the likelihood of elimination. Math Biosci .
(2019) 309:163 – 73. doi: 10.1016/j.mbs.2018.08.007
27. Kositz C, Bradley J, Hutchins H, Last A, D ’Alessandro U, Marks M. Broadening
the range of use cases for ivermectin – a review of the evidence. Trans R Soc Trop Med
Hyg. (2022) 116(3):201 – 12. doi: 10.1093/trstmh/trab114
28. UN Statistics Division. Demographic and Social Statistics. Demographic
Yearbook 2020. Available online at: https://unstats.un.org/unsd/demographic-social/
products/dyb/dyb_2020/ (accessed June 6, 2023).
29. Kiﬂe B, Nigatu M. Compliance to a ﬁve-year biannual ivermectin treatment
for onchocerciasis elimination and its determinants among adults in the bench
Maji zone, southwest Ethiopia: a community-based cross-sectional study.
J Parasitol Res. (2021). doi: 10.1155/2021/8866639
30. Kearns TM, Speare R, Cheng AC, McCarthy J, Carapetis JR, Holt DC, et al.
Impact of an ivermectin mass drug administration on scabies prevalence in a
remote Australian aboriginal community. PLoS Negl Trop Dis . (2015) 9(10):
e0004151. doi: 10.1371/journal.pntd.0004151
31. Romani L, Whitfeld MJ, Koroivueta J, Kama M, Wand H, Tikoduadua L, et al.
Mass drug administration for scabies control in a population with endemic disease.
N Engl J Med . (2015) 73(24):2305 – 13. doi: 10.1056/NEJMoa1500987
32. Roberts LJ, Huffam SE, Walton SF, Currie BJ. Crusted scabies: clinical and
immunological ﬁndings in seventy-eight patients and a review of the literature.
J Infect.
(2005) 50(5):375 – 81. doi: 10.1016/j.jinf.2004.08.033
Hounsome et al. 10.3389/frhs.2024.1279762
