...
rate of pathogenic variants (PV). We identi ﬁed 231 families in the Polyposis Register, 31 of which had CP. A polyposis-associated
...
polyposis coli (APC) were identi ﬁed as the cause of FAP, explaining
the autosomal dominant inheritance pattern observed in families
[4, 5]. MUTYH was identiﬁed as the ﬁrst gene to cause an autosomal
...
other syndromes, as surveillance is tailored to speci ﬁc genetic
...
systematically registered. CP is de ﬁned as over 100 cumulative
...
Polyposis Registry and identi ﬁed those with CP de ﬁned as a patient having
...
Received: 8 October 2023 Revised: 18 February 2024 Accepted: 28 February 2024
Published online: 12 March 2024
1Danish Polyposis Register, Gastro Unit, Copenhagen University Hospital - Amager and Hvidovre, Hvidovre, Denmark. 2Department of Clinical Medicine, University of
Copenhagen, Copenhagen, Denmark. 3Department of Clinical Genetics, Copenhagen University Hospital - Rigshospitalet, Copenhagen, Denmark. 4Gastrounit, Medical Division,
Copenhagen University Hospital - Amager and Hvidovre, Hvidovre, Denmark. 5Center for Genomic Medicine, Copenhagen University Hospital - Rigshospitalet, Copenhagen,
Denmark. ✉email: john.gasdal.karstensen@regionh.dk
www.nature.com/ejhg
1234567890();,:

number variations (CNV) were called using GATK HaplotypeCaller and
GermlineCNVCaller, respectively [10], in the coding regions and +/−50 bp
of the surrounding intronic regions. Variant annotation and ﬁltration
...
were performed on DNA from formalin- ﬁxed, paraf ﬁn-embedded, non-
...
frequency threshold [ 10]. Variant annotation and ﬁltration were, again,
...
using VarSeq 2.2.3 (Golden Helix). If a PV was identi ﬁed in one family
...
classiﬁed according to general American College of Medical Genetics
(ACMG) guidelines (for MUTYH, NTHL1, and POLE)o r APC gene-speciﬁc
...
six PV in APC, three homozygous PV in MUTYH,ah o m o z y g o u sP V
...
using a NGS panel as the ﬁrst choice. WGS allows us to detect
...
ﬁrst adenoma, it should be con ﬁrmed in additional samples, i.e., at
...
emphasizes that a clinical diagnosis of a speci ﬁc polyposis
Fig. 1 Results of genetic testing in patients with colorectal
polyposis.
J.G. Karstensen et al.
589
European Journal of Human Genetics (2024) 32:588 – 592

Table 1. Genetic results.
Gene DNA Protein ACMG criteria used Variant class Remarks
APC NM_000038.6 and NM_001127511.2
c.(?_-220)_(165 + 1_166-1)del p.(?) PS4; PP1; PM2_Supporting LP Deletion of promoter 1B
(NM_001354897.2)
c.(220 + 1_221-1)_(8532_?)del PVS1; PM2_Supporting LP Deletion of exon 4 –16 mosaicism in
blood
c.(422 + 1_423-1)_(834 + 1_835-
1)dup
PVS1; PM2_Supporting LP Duplication involving exon 5-8
c.694 C > T p.(Arg232Ter) PVS1; PM2_supporting; PS4 P
c.3927_3931del p.(Glu1309Aspfs*4) PVS1; PS4_VeryStrong; PM6_VeryStrong (reviewed by
expert panel); ClinVar Accession: SCV003836601.1
P
c.4108 A > T p.(Lys1370Ter) PVS1; PM2_supporting LP
c.4348 C > T p.(Arg1450Ter) PVS1; PM2_Supporting LP Variant detected in three polyps
(mosaicism), not in blood
c.5826_5829del p.(Asp1942Glufs*27) PVS1; PM2_Supporting; PP1; PS4 P
Insertion of retrotransposon in
intron 12*
p.(?) LP
Inversion involving exon 1B* p.(?) LP
Insertion of retrotransposon in
exon 16*
p.(?) LP
MUTYH NM_001128425.2
c.734 G > A, p.(Arg245His) PS3; PS4; PP3 P Homozygous
c.1187 G > A p.(Gly396Asp) PS3; PS4; PP3 PM1 P Homozygous
c.1437_1439del p.(Glu480del) PS3; PS4; PM1 P Homozygous
NTHL1 NM_002528.6
c.268 C > T p.(Gln90Ter) PVS1; PS4 P Homozygous
POLE NM_006231.4
c.1270 C > G p.(Leu424Val) PS4; PM1; PP1; PP3 P Heterozygous
P Pathogenic, LP Likely pathogenic;
*Detected with whole genome sequencing.
J.G. Karstensen et al.
590
European Journal of Human Genetics (2024) 32:588 – 592

syndrome is virtually impossible, unless the phenotype is indis-
...
deﬁned, perhaps with autosomal recessive inheritance. Fortu-
...
DATA AVAILABILITY
Anonymized and summarized data collected for the study will be made available to
other researchers upon publication and following reasonable requests made to the
corresponding author.
CODE AVAILABILITY
This study uses data from the Danish Polyposis Register. The data collected will be
made available to other researchers upon publication and following reasonable
requests to the corresponding author.
REFERENCES
1. Bülow S, Berk T, Neale K. The history of familial adenomatous polyposis. Fam
Cancer. 2006;5:213 – 20.
2. Karstensen JG, Burisch J, Pommergaard HC, Aalling L, Højen H, Jespersen N, et al.
Colorectal cancer in individuals with familial adenomatous polyposis, based on
analysis of the Danish polyposis registry. Clin Gastroenterol Hepatol.
2019;17:2294– 2300.e2291.
3. Karstensen JG, Bülow S, Højen H, Jelsig AM, Jespersen N, Andersen KK, et al.
Wewer MD. Cancer in patients with familial adenomatous polyposis: a nationwide
Danish cohort study with matched controls. Gastroenterology.
2023;165:573– 581.e573.
4. Groden J, Thliveris A, Samowitz W, Carlson M, Gelbert L, Albertsen H, et al.
Identiﬁcation and characterization of the familial adenomatous polyposis coli
gene. Cell. 1991;66:589 – 600.
5. Joslyn G, Carlson M, Thliveris A, Albertsen H, Gelbert L, Samowitz W, et al.
Identiﬁcation of deletion mutations and three new genes at the familial polyposis
locus. Cell. 1991;66:601 – 13.
6. Al-Tassan N, Chmiel NH, Maynard J, Fleming N, Livingston AL, Williams GT, et al.
Inherited variants of MYH associated with somatic G:C- > T: a mutations in col-
orectal tumors. Nat Genet. 2002;30:227 – 32.
7. Jelsig AM, Byrjalsen A, Busk Madsen M, Kuhlmann TP, van Overeem Hansen T,
Wadt KAW, et al. Novel genetic causes of gastrointestinal polyposis syndromes.
Appl Clin Genet. 2021;14:455 – 66.
8. Jelsig AM, Karstensen JG, Jespersen N, Ketabi Z, Lautrup C, Rønlund K, et al.
Danish guidelines for management of non-APC-associated hereditary polyposis
syndromes. Hered Cancer Clin Pr. 2021;19:41.
9. Spier I, Drichel D, Kerick M, Kirfel J, Horpaopan S, Laner A, et al. Low-level APC
mutational mosaicism is the underlying cause in a substantial fraction of unex-
plained colorectal adenomatous polyposis cases. J Med Genet. 2016;53:172 – 9.
10. McKenna A, Hanna M, Banks E, Sivachenko A, Cibulskis K, Kernytsky A, et al. The
...
11. Byrjalsen A, Hansen TVO, Stoltze UK, Mehrjouy MM, Barnkob NM, Hjalgrim LL,
et al. Nationwide germline whole genome sequencing of 198 consecutive
pediatric cancer patients reveals a high incidence of cancer prone syndromes.
PLoS Genet. 2020;16:e1009231.
...
13. Spier I, Yin X, Richardson M, Pineda M, Laner A, Ritter D, et al. G Gene-speci ﬁc
ACMG/AMP classi ﬁcation criteria for germline APC variants: recommendations
from the ClinGen InSiGHT Hereditary Colorectal Cancer/Polyposis Variant Cura-
tion Expert Panel. Genet Med. 2024;26:100992.
14. Quadri M, Vetro A, Gismondi V, Marabelli M, Bertario L, Sala P, et al. APC rear-
rangements in familial adenomatous polyposis: heterogeneity of deletion lengths
and breakpoint sequences underlies similar phenotypes. Fam Cancer.
2015;14:41– 49.
15. Su LK, Steinbach G, Sawyer JC, Hindi M, Ward PA, Lynch PM. Genomic rearran-
gements of the APC tumor-suppressor gene in familial adenomatous polyposis.
Hum Genet. 2000;106:101 – 7.
16. Rofes P, González S, Navarro M, Moreno-Cabrera JM, Solanes A, Darder E, et al.
Paired somatic-germline testing of 15 polyposis and colorectal cancer-
predisposing genes highlights the role of APC mosaicism in de novo familial
adenomatous polyposis. J Mol Diagn. 2021;23:1452 – 9.
17. Takao M, Yamaguchi T, Eguchi H, Yamada T, Okazaki Y, Tomita N, et al. APC
germline variant analysis in the adenomatous polyposis phenotype in Japanese
patients. Int J Clin Oncol. 2021;26:1661 – 70.
18. Beck SH, Jelsig AM, Yassin HM, Lindberg LJ, Wadt KAW, Karstensen JG. Intestinal
and extraintestinal neoplasms in patients with NTHL1 tumor syndrome: a sys-
tematic review. Fam Cancer. 2022;21:453 – 62.
19. Stanich PP, Pearlman R, Hinton A, Gutierrez S, LaDuca H, Hampel H, et al. Pre-
valence of germline mutations in polyposis and colorectal cancer-associated
genes in patients with multiple colorectal polyps. Clin Gastroenterol Hepatol.
2019;17:2008– 15.
20. Bonjoch L, Fernandez-Rozadilla C, Alvarez-Barona M, Lopez-Novo A, Herrera-
Pariente C, Amigo J, et al. BMPR2 as a novel predisposition gene for hereditary
colorectal polyposis. Gastroenterology. 2023;165:162 – 172.e165.
AUTHOR CONTRIBUTIONS
JGK, TOH, and AMJ designed and planned the study. JGK, TOH, JB, MD, HH, MBM, NJ,
and AMJ conducted the study. JGK and AMJ drafted the manuscript. MD designed
the ﬁgures and tables. All authors critically revised the manuscript for important
intellectual content and approved the ﬁnal manuscript.
FUNDING
The Misse and Valdemar Risom Foundation. Open access funding provided by
Copenhagen University.
COMPETING INTERESTS
JGK is a consultant for SNIPR BIOME. The other authors have no con ﬂicts of interest to
declare.
ETHICS APPROVAL
As this was a non-interventional study, no ethics approval was needed.
ADDITIONAL INFORMATION
Supplementary information The online version contains supplementary material
available at https://doi.org/10.1038/s41431-024-01585-z.
