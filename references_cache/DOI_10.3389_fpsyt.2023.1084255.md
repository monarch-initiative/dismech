...
full_text_url: "https://www.frontiersin.org/articles/10.3389/fpsyt.2023.1084255/pdf"
oa_status: gold
license: cc-by
local_pdf_path: files/DOI_10.3389_fpsyt.2023.1084255.pdf
---

# Feasibility of the virtual reality-based assessments in patients with panic disorder
**Authors:** Byung-Hoon Kim, Jae-Jin Kim, Jooyoung Oh, Seung-Hyun Kim, Changsu Han, Hyun-Ghang Jeong, Moon-Soo Lee, Junhyung Kim
**Journal:** Frontiers in Psychiatry (2023)
**DOI:** [10.3389/fpsyt.2023.1084255](https://doi.org/10.3389/fpsyt.2023.1084255)
...
fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 1
...
PUBLISHED 24 January 2023
CITATION
Kim B-H, Kim J-J, Oh J, Kim S-H, Han C,
Jeong H-G, Lee M-S and Kim J (2023)
Feasibility of the virtual reality-based
assessments in patients with panic disorder.
Front. Psychiatry 14:1084255.
doi: 10.3389/fpsyt.2023.1084255
COPYRIGHT
© 2023 Kim, Kim, Oh, Kim, Han, Jeong, Lee and
...
these terms.
Feasibility of the virtual
reality-based assessments in
patients with panic disorder
Byung-Hoon Kim1,2, Jae-Jin Kim1,2, Jooyoung Oh1,2,
Seung-Hyun Kim3, Changsu Han3, Hyun-Ghang Jeong3,
Moon-Soo Lee3,4 and Junhyung Kim3*
1Department of Psychiatry, Yonsei University College of Medicine, Seoul, Republic of Korea, 2Institute
of Behavioral Sciences in Medicine, Yonsei University College of Medicine, Seoul, Republic of Korea,
3Department of Psychiatry, Korea University Guro Hospital, Korea University College of Medicine, Seoul,
Republic of Korea, 4Department of Life Sciences, Korea University, Seoul, Republic of Korea
Introduction: Recurrences and diagnostic instability of panic disorder (PD) are
...
Methods: Twenty-ﬁve patients with PD (ANX group) and 28 healthy adults (CON
...
group reported signiﬁcantly higher AS for all steps and a smaller HRV index in M1
(steps 1 and 2) and M2 (step 1). Repeated-measures analysis of covariance (ANCOVA)
revealed signiﬁcant interaction effects for AS in M1 ( F = 4.09, p = 0.02) and M2 ( F
= 4.20, p = 0.02), and HRV index in M2 ( F = 16.22, p < 0.001) and M3 (F = 21.22, p
= 0.02). The HRV index only indicated a good model ﬁt for the three-factor model,
reﬂecting the construct of the VRA-PD. Both AS and HRV indexes were signiﬁcantly
...
KEYWORDS
virtual reality, anxiety, assessment, panic disorder, physiological responses, relaxation,
interoceptive exposure, research domain criteria (RDoC)
Abbreviations: VRA-PD, virtual reality-based anxiety behavior evaluation systems; VR, virtual reality; AS,
...
HADS, hospital anxiety and depression scale; SSQ, simulator sickness questionnaire; CFI, comparative ﬁt
index; TLI, Tucker–Lewis index; RMSEA, root mean square error of approximation; SRMR, standardized root
mean squared residual.
Frontiers in Psychiatry 01 frontiersin.org

fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 2
Kim et al. 10.3389/fpsyt.2023.1084255
1. Introduction
...
of PD in the general adult population is between 1.4 and 4.1% (2ñ
...
a negative eﬀect on the long-term course of these diseases (6).
...
consistent with twin and family research on comorbidity ﬁndings,
...
diagnostic systems are considered a need for signiﬁcant improvement
...
design treatments for those suﬀering from anxiety.
...
that mirrors daily living requirements (17ñ20). Previous research
has shown that VR oﬀers an enormous opportunity to evaluate
...
with anxiety disorders, based on the ﬁndings that the use of VR is
eﬀective for cognitive behavioral therapy for anxiety disorders and
...
individual suﬀering from anxiety. The VRA-PD uses the virtual
environment data of the VR-based relaxation self-training program
for PD, the feasibility of which has been conﬁrmed in other studies
...
modules that represent diﬀerent parts of cognitive behavioral therapy
...
without anxiety. By introducing the system conﬁguration of VRA-
...
the discriminant, construct, and convergent validity of V AR-PD in
patients with PD. We hypothesized that variables within VRA-PD
diﬀer signiﬁcantly between patients with PD and healthy controls,
represent a three-factor model reﬂecting the construct of VRA-PD,
and signiﬁcantly correlate with anxiety symptoms.
...
criteria for healthy controls were as follows: (1) suﬀering from
...
notiﬁed of the objectives, methods, and possible risks of the study.
Frontiers in Psychiatry 02 frontiersin.org

fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 3
Kim et al. 10.3389/fpsyt.2023.1084255
All aspects of the study were conducted in accordance with the 1964
...
due to incomplete physiological assessment data. The ﬁnal sample
...
sample.
2.2. System conﬁguration and operation
...
addition, the scenario and virtual environment were modiﬁed
...
training program developed in previous research and conﬁrmed to
...
a 3D video ﬁlmed in a real scene using a 360-degree 3D camera
...
to provide a 360-degree view with an 89-degree ﬁeld of vision.
...
due to cybersickness or rising anxiety, the user was notiﬁed that the
...
on a visual analog scale (V AS), which presented “not at all” (0 points)
...
fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 4
Kim et al. 10.3389/fpsyt.2023.1084255
FIGURE 1
Conﬁguration diagram of the virtual reality-based assessment in panic disorder (VRA-PD). A box with rounded corners inside an angled rectangle
...
shown in the overall system conﬁguration ( Figure 1 ), data were
...
(Pulse Analyzer, MFDS, Certiﬁcation No. 11-1296), LAXTHA Inc.,
...
rate of 250 Hz and a bandpass frequency of 0.3ñ10.6 Hz.
A PPG sensor was placed on the index ﬁnger of the left hand,
and the hands connected to the sensors were placed on the armrest
of a chair and relaxed. Manicured ﬁngernails or foreign substances
were removed from the ﬁngernails attached to the pulsing electrode.
In addition, tight-ﬁtting sleeves, disposable bands, and rubber bands
that exerted pressure on the arms or ﬁngers were removed.
...
patient groups, including those with PD (34ñ36), and its predictive
...
fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 5
Kim et al. 10.3389/fpsyt.2023.1084255
FIGURE 2
...
comfortable scene for the remaining 1 min and 30 s. The program was conducted in Korean; however, the examples of the help balloon in this ﬁgure are
...
therapy (40). When the user ﬁnished the daily environment exposure
...
(HD), respectively ( Figures 2B-3 , 2C-3). Because of the diﬃculty
...
the ﬁrst 30 s out of 2 min in the production process. The remaining
...
fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 6
Kim et al. 10.3389/fpsyt.2023.1084255
PDSS, translated and standardized in 2001 (42). Five PDSS questions
...
α = 0.88) and test-retest reliability ( r = 0.71) (43). The Cronbach’sα
...
point scale (0ñ3), ﬁrst for fear and then for avoidance. Zero represents
...
avoidance, one indicates occasional avoidance (1ñ33 percent of the
time), two indicates often avoiding the circumstance (34ñ67 percent
of the time), and three indicates always avoiding the situation (68ñ100
...
anxiety symptoms (such as diﬃculty relaxing or excessive concern)
...
to have suﬃcient psychometric qualities, including strong internal
consistency (Cronbach’s α = 0.92), clinical value, and construct
validity (48, 49). This study used the Korean version of the GAD-7
with conﬁrmed psychometric qualities (50). The GAD-7 also showed
good reliability in the current study (Cronbach’sα = 0.93).
...
with good internal consistency [Cronbach’sα = 0.89 (HADS-A) and
...
simulator sickness and to investigate any signiﬁcant impacts (e.g.,
...
reliability in the current study (Cronbach’sα = 0.93).
...
then compared between the two groups using the MannñWhitney
test. A repeated-measures analysis of covariance (ANCOV A) was
...
Since the diﬀerence in the subjective AS between the two groups
was signiﬁcant, both the group factor and the repetition eﬀects were
included. For physiological data, repeated-measures ANCOV A for
only the repetition eﬀect was executed only in the ANX group, a
...
PD ﬁt well by module. To validate the factor structure of the
VRA-PD, we employed conﬁrmatory factor analyses with maximum
...
module provides a diﬀerent stimulus. Model ﬁt was assessed using
the chi-squared statistic, comparative ﬁt index (CFI), TuckerñLewis
index (TLI), root mean square error of approximation (RMSEA),
and standardized root mean squared residual (SRMR). Although a
consensus on acceptable levels of ﬁt indices is still missing (56), a
value of 0.95 or more for CFI and TLI, 0.08 or less for RMSEA,
and 0.08 or less for the SRMR is considered an acceptable ﬁt (57).
...
scales
Statistical tests did not show signiﬁcant diﬀerences in age, years
of education, sex, and marital status distribution between the two
Frontiers in Psychiatry 06 frontiersin.org

fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 7
Kim et al. 10.3389/fpsyt.2023.1084255
groups. The ANX group presented more nicotine and alcohol use
than the CON group (Table 1). A signiﬁcant diﬀerence was found in
...
VRA-PD use was more signiﬁcant in the ANX group (mean = 34.68,
...
for baseline AS.
The HRV index was signiﬁcantly lower in the ANX group
elevators 2 and 6 of module 1 (M1) and in the diaphragmatic
respiratory relaxation (DRR) environment of module 2 (M2) than
in the CON group (M1 elevator 2: MannñWhitney U = −3.86,
p < 0.001; M1 elevator 6: MannñWhitney U = −2.43, p = 0.015; M2
DRR: MannñWhitney U = −2.82, p = 0.005).
3.4. Content validity
3.4.1. Self-rating anxiety scores
For the repeated measured ANCOV A results of AS for each
module ( Table 3 ), a signiﬁcant interaction eﬀect between group
(ANX vs. CON) and time (pre vs. during vs. post) was found for M1
and M2, rather than for the AS of Module 3 (M3). For all modules,
a signiﬁcant main eﬀect of the group was shown, and the post hoc
test showed higher AS in the ANX group than in the CON group.
A signiﬁcant main eﬀect of time was revealed for MI.
Figure 3 shows the signiﬁcant results among the paired t-tests
for each group, conducted as a post hoc test for the interaction eﬀect
shown in M1 and M2. In the CON group, there was no signiﬁcant
...
Values are displayed as mean, standard deviation, and median (interquartile range). CON and ANX were compared using the MannñWhitney test. IQR, interquartile range; sk, skewness; ku, kurtosis.
Frontiers in Psychiatry 07 frontiersin.org

fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 8
Kim et al. 10.3389/fpsyt.2023.1084255
TABLE 3 Results of repeated-measured ANOVA for self-rating anxiety scores in the two groups (ANX and CON) and different time concerning each module.
...
The post hoc comparison of the signiﬁcant ANCOVA results is also described within the plot. The symbols in the graph mean signiﬁcantly different
self-rating anxiety scores between pre and during (#), between pre and post (y), and between during and post (
 ) from the post hoc comparisons with
...
signiﬁcantly correlated with depression-related HADS-D rather than
with the SSQ. AS exhibited a strong association with anxiety-related
Frontiers in Psychiatry 08 frontiersin.org

fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 9
Kim et al. 10.3389/fpsyt.2023.1084255
TABLE 4 Conﬁrmatory factory analysis of self-rating anxiety score and heart rate variability (HRV) index in virtual reality-based assessment in panic
disorder (VRA-PD).
Variables χ2 df χ2/df RMSEA (90% CI) CFI TLI SRMR
AS 85.503 24 3.479 0.218 (0.168ñ0.270) 0.917 0.875 0.040
HRV index 17.162 11 1.560 0.026 (0.000ñ0.184) 0.949 0.903 0.063
Acceptable
cut-oﬀ value
<3 <0.06 > 0.90 > 0.90 < 0.08
CFI, comparative ﬁt index; TLI, TuckerñLewis index; RMSEA, root mean square error of approximation; SRMR, standardized root mean squared residual.
FIGURE 4
...
clarify the diﬀerences in anxiety symptoms. There was no signiﬁcant
diﬀerence in the demographic characteristics between the two groups;
however, there was a signiﬁcant diﬀerence in the usage of alcohol
...
studies have shown that the use of substances can aﬀect physiological
data (61), these diﬀerences support the inclusion of smoking and
...
ill (62). In the case of LSAS, there was no diﬀerence between the two
groups in both subscales of fear and avoidance, whereas, in the GAD-
7, HADS-A, and HADS-D, it was conﬁrmed that the ANX group was
signiﬁcantly higher than the CON group. Unlike PDSS and LSAS,
which are disease-speciﬁc, GAD-7 and HADS-A are mainly used as
screening tools. This diﬀerence seems to have been conﬁrmed, as it
is known that speciﬁcity is poor for a detailed diagnosis of anxiety
...
the HADS-D as a covariate when looking at how depression aﬀects
...
adverse eﬀects of cybersickness. Previous studies have suggested that
...
stressed people (67). Therefore, the signiﬁcantly high mean SSQ
...
for most items in the CON group and was signiﬁcantly higher in
the ANX group than in the CON group. Inducing subjective anxiety
was signiﬁcantly diﬀerent in patients with the PD compared with the
...
anxiety could diﬀerentiate the two groups. These results support both
...
fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 10
Kim et al. 10.3389/fpsyt.2023.1084255
TABLE 5 Correlations among variables in virtual reality-based assessment in panic disorder (VRA-PD), psychological characteristics and simulator sickness
...
The correlation coeﬃcient ( rs) and p-values were calculated using Spearman’s rank correlation analysis. The statistically signiﬁcant results are indicated in bold. *p < 0.05; **p < 0.001. PDSS, panic
...
the CON group. Even in measures with no signiﬁcant diﬀerence,
...
data, obtained via conﬁrmatory factor analyses, showed that the
...
diﬀerent physiological responses, as intended for the HRV index.
It seems that the self-rating AS did not show validity because the
current VRA-PD measured self-rating anxiety as a V AS score for
overall anxiety, which is insuﬃcient to show the diﬀerences between
the modules. Previous research on dysfunctional communication
using VR has shown that the diﬀerences between modules are well
reﬂected when speciﬁc subjective responses according to the contents
of the virtual environment are acquired (23). Therefore, it would
be necessary to prepare questionnaires and ratings that can reﬂect
the characteristics of the module to increase the feasibility of the
self-rating behavior parameter.
In the repeated-measures ANCOV A, the self-rating AS results
were intended to evaluate the content validity of each VRA-PD
module. The interaction eﬀect of group and time was conﬁrmed in
...
that each part of the VRA-PD worked as intended. The insigniﬁcant
result of this change in M3 indicated that the diﬀerence between
the two types of interoceptive exposure might not be signiﬁcant.
Moreover, a short relaxation period can aﬀect anxiety (70), and
...
aﬀects their response.
Among the physiological responses of the VRA-PD modules,
signiﬁcant changes were observed in M2 and M3 concerning the
...
individuals (69); hence, this ﬁnding can be interpreted as indicating
...
The physiological data showed signiﬁcant changes in the
HRV index in M3, unlike in the self-rating AS. These results
suggest that the virtual environment of M3 is insuﬃcient to aﬀect
subjective anxiety but is suﬃcient to induce physical changes. This
...
though the self-rating AS changed signiﬁcantly. In anxiety disorders,
both the cognitive domain and physiological responses are important
Frontiers in Psychiatry 10 frontiersin.org

fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 11
Kim et al. 10.3389/fpsyt.2023.1084255
(28). When developing an RDoC study, assessing and integrating a
variety of both biological and behavioral measures simultaneously are
recommended (14). Therefore, our ﬁndings are interesting because
...
Signiﬁcant correlations were conﬁrmed between VRA-PD
...
and physical responses in the VRA-PD environment reﬂect the
...
signiﬁcant correlation between the HRV index measured in VRA-PD
and a part of AS, which shows that the measurement in VRA-
PD is not speciﬁc to anxiety, contrary to expectations. However,
this result may also reﬂect that depression is a signiﬁcant factor
aﬀecting anxiety, and cybersickness is a signiﬁcant element in the
...
clinically valid, a study that directly compares diﬀerent types of
...
panic disorder patients may not generalize to a diﬀerent diagnosis
...
use can aﬀect the patient’s physiological response, the patient’s
response to anxiety disorders may be masked. Our ﬁfth limitation
...
study can have aﬀected the quality of physiological data. Previous
...
variables obtained from the VRA-PD could reﬂect the diﬀerences
...
approved by the Ethics Committee of Korea University Guro
Hospitals. The patients/participants provided their written informed
consent to participate in this study.
Author contributions
B-HK, J-JK, and JK: conceptualization. S-HK, CH, H-GJ, and
M-SL: participant evaluation and data acquisition. B-HK and JK:
formal analysis and writing—original draft preparation. JK: writing—
review, editing, and supervision. All authors contributed to the
...
(NRF) and funded by the Korean government (MSIT) (NRF-
2021R1I1A1A01046025 and NRF-2021M3E5D1A01015191) and the
National Research Foundation of Korea (NRF) grant funded by the
Korean government (MSIT) (No. NRF-2021M3E5D9025019).
Conﬂict of interest
...
fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 12
Kim et al. 10.3389/fpsyt.2023.1084255
References
1. American Psychiatric Association. Diagnostic and statistical manual of mental
disorders. 5th ed. Arlington, V A: American Psychiatric Association (2013).
2. Eaton W, Kessler RC, Wittchen HU, Magee WJ. Panic and panic disorder in the
United States. Am J Psychiatry. (1994) 151:413ñ20. doi: 10.1176/ajp.151.3.413
3. Weissman M, Bland RC, Canino GJ, Faravelli C, Greenwald S, Hwu HG, et al. The
cross-national epidemiology of panic disorder. Arch Gen Psychiatry. (1997) 54:305ñ9.
doi: 10.1001/archpsyc.1997.01830160021003
4. de Jonge P , Roest A, Lim C, Florescu S, Bromet E, Stein D, et al. Cross-national
epidemiology of panic disorder and panic attacks in the world mental health surveys.
Depress Anxiety. (2016) 33:1155ñ77. doi: 10.1002/da.22572
5. Bruce S, Yonkers K, Otto M, Eisen J, Weisberg R, Pagano M, et al. Inﬂuence of
psychiatric comorbidity on recovery and recurrence in generalized anxiety disorder, social
phobia, and panic disorder: a 12-year prospective study. Am J of Psychiatry. (2005)
162:1179ñ87. doi: 10.1176/appi.ajp.162.6.1179
6. Scholten W, Batelaan N, van BA, Wjh Penninx B, Smit J, van Oppen P. Recurrence of
anxiety disorders and its predictors. J Aﬀect Disord. (2013) 147:180ñ5. doi: 10.1016/j.jad.
2012.10.031
7. Rhebergen D, Batelaan N, de Graaf R, Nolen W, Spijker J, Beekman A, et al. The
7-year course of depression and anxiety in the general population. Acta Psychiatr Scand.
(2011) 123:297ñ306. doi: 10.1111/J.1600-0447.2011.01677.X
8. Fichter M, Quadﬂieg N, Fischer U, Kohlboeck G. Twenty-ﬁve-year course and
outcome in anxiety and depression in the upper bavarian longitudinal community study.
Acta Psychiatr Scand. (2010) 122:75ñ85. doi: 10.1111/J.1600-0447.2009.01512.X
9. Scholten W, Batelaan N, Penninx B, van Balkom A, Smit J, Schoevers R, et al.
Diagnostic instability of recurrence and the impact on recurrence rates in depressive and
anxiety disorders. J Aﬀect Disord. (2016) 195:185ñ90. doi: 10.1016/j.jad.2016.02.025
10. Middeldorp C, Cath D, van Dyck R, Boomsma D. The co-morbidity of anxiety and
depression in the perspective of genetic epidemiology. a review of twin and family studies.
Psychol Med. (2005) 35:611ñ24. doi: 10.1017/S003329170400412X
11. Insel T, Cuthbert B, Garvey M, Heinssen R, Pine D, Quinn K, et al. Research domain
criteria (RDoC): toward a new classiﬁcation framework for research on mental disorders.
Am J of Psychiatry. (2010) 167:748ñ51. doi: 10.1176/APPI.AJP.2010.09091379
12. Insel T. The NIMH research domain criteria (RDoC) project: precision medicine for
psychiatry. Am J of Psychiatry. (2014) 171:395ñ7. doi: 10.1176/appi.ajp.2014.14020138
13. Carcone D, Ruocco A. Six years of research on the National Institute of Mental
Health’s Research domain criteria (RDoC) initiative: a systematic review. Front Cell
Neurosci. (2017) 11:46. doi: 10.3389/fncel.2017.00046
14. NIMH. RDoC Matrix . (2022). Available online at: https://www.nimh.nih.gov/
research/research-funded-by-nimh/rdoc/constructs/rdoc-matrix (accessed Oct 19,
2022).
15. Marin M, Hammoud M, Klumpp H, Simon N, Milad M. Multimodal categorical
and dimensional approaches to understanding threat conditioning and its extinction
in individuals with anxiety disorders. JAMA Psychiatry. (2020) 77:618ñ27. doi: 10.1001/
JAMAPSYCHIATRY.2019.4833
16. Tozzi L, Staveland B, Holt-Gosselin B, Chesnut M, Chang S, Choi D, et al. The
human connectome project for disordered emotional states: protocol and rationale for
a research domain criteria study of brain connectivity in young adult anxiety and
depression. Neuroimage. (2020) 214:116715. doi: 10.1016/J.NEUROIMAGE.2020.116715
17. Corriveau Lecavalier N, Ouellet É, Boller B, Belleville S. Use of immersive virtual
reality to assess episodic memory: a validation study in older adults.Neuropsychol Rehabil.
(2018) 30:462ñ80. doi: 10.1080/09602011.2018.1477684
18. Han K, Ku J, Kim K, Jang H, Park J, Kim J, et al. Virtual reality prototype for
measurement of expression characteristics in emotional situations. Comput Biol Med.
(2009) 39:173ñ9. doi: 10.1016/j.compbiomed.2008.12.002
19. Ku J, Jang H, Kim K, Park S, Kim J, Kim C, et al. Pilot study for assessing the
behaviors of patients with schizophrenia towards a virtual avatar. Cyberpsychol Behav.
(2006) 9:531ñ9. doi: 10.1089/cpb.2006.9.531
20. Park K, Ku J, Choi S, Jang H, Park J, Kim S, et al. A virtual reality application in role-
plays of social skills training for schizophrenia: a randomized, controlled trial. Psychiatry
Res. (2011) 189:166ñ72. doi: 10.1016/j.psychres.2011.04.003
21. Sanchez D, Weiner E, van Zelderen A. Virtual reality assessments (VRAs): exploring
the reliability and validity of evaluations in VR. Int J Select Assess. (2022) 30:103ñ25.
doi: 10.1111/IJSA.12369
22. Gutiérrez-Maldonado J, Rus-Calafell M, González-Conde J. Creation of a new set of
dynamic virtual reality faces for the assessment and training of facial emotion recognition
ability. Virtual Real. (2014) 18:61ñ71. doi: 10.1007/s10055-013-0236-7
23. Kim J, Jung Y , Shin Y , Kim M, Eom H, Kim E, et al. Feasibility of a virtual
reality-based interactive feedback program for modifying dysfunctional communication:
a preliminary study. BMC Psychol. (2020) 8:50. doi: 10.1186/s40359-020-00418-0
24. Kim J, Jung Y , Shin Y , Kim M, Eom H, Kim E, et al. Development and validation
of a virtual reality-based training program for promoting subjective well-being.Psychiatry
Investig. (2020) 17:1207ñ15. doi: 10.30773/pi.2020.0311
25. Jeong H, Oh J, Paik M, Kim H, Jang S, Kim B, et al. Development and feasibility
assessment of virtual reality-based relaxation self-training program. Front Virtual Real.
(2022) 2:722558. doi: 10.3389/frvir.2021.722558
26. van Dis E, van Veen S, Hagenaars M, Batelaan N, Bockting C, van den Heuvel R,
et al. Long-term outcomes of cognitive behavioral therapy for anxiety-related disorders:
a systematic review and meta-analysis. JAMA Psychiatry. (2019) 77:265ñ73. doi: 10.1001/
jamapsychiatry.2019.3986
27. Brahnam S, Jain L. Advanced computational intelligence paradigms in healthcare 6:
virtual reality in psychotherapy, rehabilitation, and assessment. Berlin: Springer (2011).
28. Otte C. Cognitive behavioral therapy in anxiety disorders: current state of the
evidence. Dialogues Clin Neurosci. (2022) 13:413ñ21. doi: 10.31887/DCNS.2011.13.4/
COTTE
29. Carpenter J, Andrews L, Witcraft S, Powers M, Smits J, Hofmann S. Cognitive
behavioral therapy for anxiety and related disorders: a meta-analysis of randomized
placebo-controlled trials. Depress Anxiety. (2018) 35:502ñ14. doi: 10.1002/DA.22728
30. Lecrubier Y , Sheehan DV , Weiller E, Amorim P , Bonora I, Sheehan K, et al. The
mini international neuropsychiatric interview (MINI). A short diagnostic structured
interview: reliability and validity according to the CIDI. Eur Psychiatry. (1997) 12:224ñ31.
doi: 10.1016/S0924-9338(97)83296-8
31. Schroeder E, Whitsel E, Evans G, Prineas R, Chambless L, Heiss G. Repeatability
of heart rate variability measures. J Electrocardiol. (2004) 37:163ñ72. doi: 10.1016/J.
JELECTROCARD.2004.04.004
32. Vollmer M. A robust, simple and reliable measure of heart rate variability using
relative RR intervals. Comput Cardiol. (2015) 42:609ñ12. doi: 10.1109/CIC.2015.7410984
33. Malik M, Xia R, Odemuyiwa O, Staunton A, Poloniecki J, Camm A. Inﬂuence of
the recognition artefact in automatic analysis of long-term electrocardiograms on time-
domain measurement of heart rate variability. Med Biol Eng Comput. (1993) 31:539ñ44.
doi: 10.1007/BF02441992
34. Chang H, Chang C, Tzeng N, Kuo T, Lu R, Huang S. Generalized anxiety disorder,
comorbid major depression and heart rate variability: a case-control study in Taiwan.
Psychiatry Investig. (2013) 10:326ñ35. doi: 10.4306/PI.2013.10.4.326
35. Pittig A, Arch J, Lam C, Craske M. Heart rate and heart rate variability in panic,
social anxiety, obsessiveñcompulsive, and generalized anxiety disorders at baseline and
in response to relaxation and hyperventilation. Int J of Psychophysiol. (2013) 87:19ñ27.
doi: 10.1016/J.IJPSYCHO.2012.10.012
36. Choi K, Jang E, Kim A, Fava M, Mischoulon D, Papakostas G, et al. Heart rate
variability for treatment response between patients with major depressive disorder versus
panic disorder: a 12-week follow-up study. J Aﬀect Disord. (2019) 246:157ñ65. doi: 10.
1016/J.JAD.2018.12.048
37. Shaikh al arab A, Guédon-Moreau L, Ducrocq F , Molenda S, Duhem S, Salleron J,
et al. Temporal analysis of heart rate variability as a predictor of post traumatic stress
disorder in road traﬃc accidents survivors. J Psychiatr Res. (2012) 46:790ñ6. doi: 10.1016/
J.JPSYCHIRES.2012.02.006
38. Khandoker A, Jelinek H, Palaniswami M. Heart rate variability and complexity in
people with diabetes associated cardiac autonomic neuropathy. Proceedings of the 30th
annual international conference of the IEEE engineering in medicine and biology society,
EMBS’08 - “personalized healthcare through technology” . Vancouver, BC: IEEE (2008).
p. 4696ñ9. doi: 10.1109/iembs.2008.4650261
39. Botella C, Villa H, García-Palacios A, Baños R, Perpiñá C, Alcañiz M. Clinically
signiﬁcant virtual environments for the treatment of panic disorder and agoraphobia.
Cyberpsychol Behav. (2004) 7:527ñ35. doi: 10.1089/CPB.2004.7.527
40. Pompoli A, Furukawa T, Efthimiou O, Imai H, Tajika A, Salanti G.
Dismantling cognitive-behaviour therapy for panic disorder: a systematic
review and component network meta-analysis. Psychol Med. (2018) 48:1945ñ53.
doi: 10.1017/S0033291717003919
41. Shear M, Brown T, Barlow D, Money R, Sholomskas D, Woods S, et al. Multicenter
collaborative panic disorder severity scale. Am J Psychiatry. (1997) 154:1571ñ5. doi: 10.
1176/AJP.154.11.1571
42. Kim J. Development of the Korean version of the panic disorder severity scale.
Korean J Psychopathol. (2001) 10:140ñ51.
43. Shear M, Rucci P , Williams J, Frank E, Grochocinski V , vander Bilt J, et al. Reliability
and validity of the panic disorder severity scale: replication and extension. J Psychiatr Res.
(2001) 35:293ñ6. doi: 10.1016/S0022-3956(01)00028-0
44. Heimberg R, Horner KJ, Juster H, Safren S, Brown E, Schneier F , et al. Psychometric
properties of the liebowitz social anxiety scale. Psychol Med. (1999) 29:199ñ212. doi:
10.1017/S0033291798007879
45. Fresco D, Coles M, Heimberg R, Liebowitz M, Hami S, Stein M. The liebowitz social
anxiety Scale: a comparison of the psychometric properties of self-report and clinician-
administered formats. Psychol Med. (2001) 31:1025ñ35. doi: 10.1017/S003329170100
4056
46. Kang JH, Lee JA, Oh KS, Lim SW. Validation and clinical eﬃcacy of the Korean
liebowitz social anxiety scale: clinician administered. Korean J Clin Psychol. (2013)
32:291ñ312.
Frontiers in Psychiatry 12 frontiersin.org

fpsyt-14-1084255 January 18, 2023 Time: 14:22 # 13
Kim et al. 10.3389/fpsyt.2023.1084255
47. Spitzer R, Kroenke K, Williams J, Löwe B. A brief measure for assessing generalized
anxiety disorder: the GAD-7. Arch Intern Med. (2006) 166:1092ñ7. doi: 10.1001/archinte.
166.10.1092
48. Kertz S, Bigda-Peyton J, Bjorgvinsson T. Validity of the generalized anxiety disorder-
7 Scale in an acute psychiatric sample. Clin Psychol Psychother. (2013) 20:456ñ64. doi:
10.1002/CPP.1802
49. Tiirikainen K, Haravuori H, Ranta K, Kaltiala-Heino R, Marttunen M. Psychometric
properties of the 7-item generalized anxiety disorder scale (GAD-7) in a large
representative sample of Finnish adolescents. Psychiatry Res. (2019) 272:30ñ5. doi: 10.
1016/J.PSYCHRES.2018.12.004
50. Lee B, Kim Y. The psychometric properties of the generalized anxiety disorder scale
(GAD-7) among Korean university students. Psychiatry Clin Psychopharmacol. (2019)
29:864ñ71. doi: 10.1080/24750573.2019.1691320
51. Zigmond A, Snaith R. The hospital anxiety and depression scale. Acta Psychiatr
Scand. (1983) 67:361ñ70.
52. Oh S, Min K, Park D-B. A study on the standardization of the hospital anxiety and
depression scale for Koreans: a comparison of normal, depressed and anxious groups. J
Korean Neuropsychiatr Assoc. (1999) 38:289ñ96.
53. Kennedy R, Lane N, Berbaum K, Lilienthal M. Simulator sickness questionnaire: an
enhanced method for quantifying simulator sickness. Int J Aviat Psychol.(1993) 3:203ñ20.
doi: 10.1207/s15327108ijap0303_3
54. Sevinc V , Berkman M. Psychometric evaluation of Simulator Sickness Questionnaire
and its variants as a measure of cybersickness in consumer virtual environments. Appl
Ergon. (2020) 82:102958. doi: 10.1016/J.APERGO.2019.102958
55. Kim H, Park J, Choi Y , Choe M. Virtual reality sickness questionnaire (VRSQ):
motion sickness measurement index in a virtual reality environment. Appl Ergon. (2018)
69:66ñ73. doi: 10.1016/J.APERGO.2017.12.016
56. Jackson D, Gillaspy J, Purc-Stephenson R. Reporting practices in conﬁrmatory factor
analysis: an overview and some recommendations. Psychol Methods. (2009) 14:6ñ23.
doi: 10.1037/A0014694
57. Hu L, Bentler P. Cutoﬀ criteria for ﬁt indexes in covariance structure analysis:
conventional criteria versus new alternatives. Struct Equ Model. (2009) 6:1ñ55. doi: 10.
1080/10705519909540118
58. Kline T. Psychological testing: a practical approach to design and evaluation .
Thousand Oaks, CA: Sage Publications, Inc (2014). doi: 10.4135/978148338
5693
59. Cosci F , Schruers K, Abrams K, Griez E. Alcohol use disorders and panic disorder:
a review of the evidence of a direct relationship. J Clin Psychiatry. (2007) 68:685. doi:
10.4088/JCP.v68n0608
60. Zvolensky M, Feldner M, Leen-Feldner E, McLeish A. Smoking and panic attacks,
panic disorder, and agoraphobia: a review of the empirical literature. Clin Psychol Rev.
(2005) 25:761ñ89. doi: 10.1016/J.CPR.2005.05.001
61. Kageyama T, Imai H, Kabuto M, Nishikido N, Honda Y , Kurokawa Y , et al. Eﬀects
of obesity, current smoking status, and alcohol consumption on heart rate variability
in male white-collar workers. Int Arch Occup Environ Health. (1997) 69:447ñ54. doi:
10.1007/S004200050173
62. Furukawa T, Shear M, Barlow D, Gorman J, Woods S, Money R, et al. Evidence-
based guidelines for interpretation of the panic disorder severity scale. Depress Anxiety.
(2009) 26:922ñ9. doi: 10.1002/da.20532
63. Spinhoven P , Ormel J, Sloekers P , Kempen G, Speckens A, van Hemert AM. A
validation study of the hospital anxiety and depression scale (HADS) in diﬀerent groups
of dutch subjects. Psychol Med. (1997) 27:363ñ70. doi: 10.1017/S0033291796004382
64. Uhde T, Roy-Byrne P , Vittone B, Boulenger J, Post R. Phenomenology and
Neurobiology of Panic Disorder. In: Tuma AH, Maser J editors. Anxiety and the anxiety
disorders. New York, NY: Routledge (2019). p. 557ñ76. doi: 10.4324/9780203728215-39
65. Sharples S, Cobb S, Moody A, Wilson J. Virtual reality induced symptoms and eﬀects
(VRISE): comparison of head mounted display (HMD), desktop and projection display
systems. Displays. (2008) 29:58ñ69. doi: 10.1016/j.displa.2007.09.005
66. Pot-Kolder R, Veling W, Counotte J, van der Gaag M. Anxiety partially mediates
cybersickness symptoms in immersive virtual reality environments. Cyberpsychol Behav
Soc Netw. (2018) 21:187ñ93. doi: 10.1089/CYBER.2017.0082/ASSET/IMAGES/LARGE/
FIGURE3.JPEG
67. Kim H, Kim D, Chung W, Park K, Kim J, Kim D, et al. Clinical predictors
of cybersickness in virtual reality (VR) among highly stressed people. Sci Rep. (2021)
11:12139. doi: 10.1038/s41598-021-91573-w
68. Bouchard S, St-Jacques J, Renaud P , Wiederhold B. Side eﬀects of immersions in
virtual reality for people suﬀering from anxiety disorders. JCR. (2009) 2:127. doi: 10.3233/
SHTI210961
69. Chalmers J, Quintana D, Abbott M, Kemp A. Anxiety disorders are associated
with reduced heart rate variability: a meta-analysis. Front Psychiatry. (2014) 5:80. doi:
10.3389/FPSYT.2014.00080
70. Tolin D, Davies C, Moskow D, Hofmann S. Biofeedback and neurofeedback for
anxiety disorders: a quantitative and qualitative systematic review. Adv Exp Med Biol.
(2020) 1191:265ñ89. doi: 10.1007/978-981-32-9705-0_16
71. Berwal D, Vandana C, Dewan S, Jiji CV , Baghini M. Motion artifact removal in
ambulatory ECG signal for heart rate variability analysis.IEEE Sens J. (2019) 19:12432ñ42.
doi: 10.1109/JSEN.2019.2939391
72. Li K, Rüdiger H, Ziemssen T. Spectral analysis of heart rate variability: time window
matters. Front Neurol. (2019) 10:545. doi: 10.3389/FNEUR.2019.00545/BIBTEX
