...
full_text_url: "https://pure.manchester.ac.uk/ws/files/30114804/POST-PEER-REVIEW-PUBLISHERS-DOCUMENT.PDF"
oa_status: green
license: other-oa
local_pdf_path: files/DOI_10.1073_pnas.0707383104.pdf
---
...
**DOI:** [10.1073/pnas.0707383104](https://doi.org/10.1073/pnas.0707383104)
...
likewise functional MRI studies often fail to show activations in the
...
ipants: Speciﬁcally, we show that temporary disruption to neural
processing in the ATL produces a selective semantic impairment
leading to signiﬁcant slowing in both picture naming and word
comprehension but not to other equally demanding, nonsemantic
cognitive tasks.
repetitive transcranial magnetic stimulation /H20841semantic cognition /H20841
temporal pole
S
...
therefore, are which parts of the brain support semantic memory,
...
tation, these areas are often overlooked or even disputed in other
...
performed research; G.P. and M.A.L.R. analyzed data; and G.P., E.J., and M.A.L.R. wrote the
paper.
...
www.pnas.org/H20862cgi/H20862doi/H2086210.1073/H20862pnas.0707383104 PNAS /H20841December 11, 2007 /H20841vol. 104 /H20841no. 50 /H2084120137–20141
PSYCHOLOGY


behavior (which we have come to refer to as ‘‘semantic cogni-
...
zation, and, indeed, recent imaging studies have shown that white
...
the preeminence of a single specific region, we suggest a different
...
much more subtle (showing themselves in reaction time) than the
...
shown in Fig. 1 A. Statistical analysis of reaction times yielded a
main effect of task [ F(2,10) /H1100534.39, P /H110210.001], as well as a main
effect of TMS condition [ F(1,10) /H110055.10, P /H110210.05]. Crucially,
there was a significant interaction between TMS and the naming
task [ F(2,10) /H110054.79, P /H110050.03]. Bonferroni tests revealed that
TMS significantly slowed naming responses in the specific-level
task [ t(10) /H110053.87, P /H110210.02] but not in the other two tasks
[t(10) /H110211.5, not significant]. In addition, specific-level naming
was slower than both basic-level naming and number naming
[Bonferroni t(10) /H110225.75, P /H110210.001]. A separate analysis of
response accuracy yielded a main effect of the naming task
[F(2,10) /H1100511.97, P /H110210.001]. This reflected poorer accuracy in
specific-level naming than basic-level or number naming [13%
errors in specific naming vs. 2% in basic-level naming or 4% in
number naming: t(10) /H110223.75, P /H110210.03].
20138 /H20841www.pnas.org/H20862cgi/H20862doi/H2086210.1073/H20862pnas.0707383104 Pobric et al.


The results for synonym vs. number judgments are shown in
Fig. 1 B. Statistical analysis confirmed that there was a differen-
tial effect of temporal pole stimulation on the two tasks [ F(1,9) /H11005
19.1, P /H110050.002]. Despite being the harder and thus slower task,
number judgment was completely unaffected by temporal pole
stimulation [ t(9) /H11005/H110021.08, P /H110050.31] whereas semantic decision
times were slowed, on average, by 9.9% [ t(9) /H110057.58, P /H110210.001].
...
[8.0% and 3.9%, respectively: F(1,9) /H1100514.7, P /H110050.002], but there
was no effect of TMS and no interaction (both F /H110211).
Discussion
...
ing task but not for number naming. Additionally, stimulating the
...
emerge after damage to the prefrontal–temporoparietal controls
...
demonstrated greater activity in the ATL when participants were
...
(seven females; mean age /H1100521.7, SD /H110054.05). Ten participants
took part in the synonym and number judgment tasks (six
females; mean age /H1100522.3 years, SD /H110054.82). All participants
were native English speakers and strongly right-handed, yield-
500
750
1000
1250
Basic Subordinate Num ber
Level/type of nam ing
)sm/( semit gnimaN
No TMS
TMS
A
...
TMS
B
Fig. 1. Effect of rTMS to the left temporal pole on naming ( A) and synonym
...
from the naming tasks (objects and numbers), andB shows the results from the
synonym and number judgment tasks.
Pobric et al . PNAS /H20841December 11, 2007 /H20841vol. 104 /H20841no. 50 /H2084120139
PSYCHOLOGY


ing a laterality quotient of at least /H1100190 on the Edinburgh
...
were suppressed for /H1101520 min after 10 min of 1-Hz rTMS. We
...
neuropsychological assessments (4, 9). For the basic naming task,
...
/H1102295% name agreement at this specific level. For the number
naming task, participants provided English names for six-digit
numbers (e.g., 316,565, ‘‘three hundred and sixteen thousand five
...
removal of /H110153.7% of all responses. One participant made a large
...
contained 144 trials. The format was the same as for the synonym
...
sponse followed by a blank screen interval of 500 ms. Participants
...
using a 70-mm figure-of-eight coil attached to a MagStim Rapid2
...
to an average intensity of 67% /H110066.88 (mean /H11006SD) of maximum
stimulator output for the participants in the naming study and
77 /H110066.88% for those in the matching experiment. Structural
...
used during the coregistration process. The ATL site was defined
as the region 10 mm posterior from the tip of the left temporal
20140 /H20841www.pnas.org/H20862cgi/H20862doi/H2086210.1073/H20862pnas.0707383104 Pobric et al.


pole along the middle temporal gyrus. This point was used in
...
marked with a permanent marker. The average MNI coordinates
for the ATL in standard space were ( /H1100253, 4, /H1100232). At this site
the scalp-to-cortex distance can be greater than for other cortical
...
1. Hodges JR, Patterson K, Oxbury S, Funnell E (1992) Brain 115:1783–1806.
2. Nestor PJ, Fryer TD, Hodges JR (2006) NeuroImage 30:1010–1020.
3. Galton CJ, Patterson K, Graham KS, Lambon Ralph MA, Williams G, Antoun
N, Sahakian BJ, Hodges JR (2001) Neurology 57:216–225.
4. Bozeat S, Lambon Ralph MA, Patterson K, Garrard P, Hodges JR (2000)
Neuropsychologia 38:1207–1215.
5. Lambon Ralph MA, McClelland JL, Patterson K, Galton CJ, Hodges JR (2001)
J Cognit Neurosci 13:341–356.
6. Rogers TT, Lambon Ralph MA, Garrard P, Bozeat S, McClelland JL, Hodges
JR, Patterson K (2004) Psychol Rev 111:205–235.
7. Jefferies E, Lambon Ralph MA (2006) Brain 129:2132–2147.
8. Warrington EK (1975) Q J Exp Psychol 27:635–657.
9. Lambon Ralph MA, Lowe C, Rogers TT (2007) Brain 130:1127–1137.
10. Coccia M, Bartolini M, Luzzi S, Provinciali L, Lambon Ralph MA (2004)
Cognit Neuropsychol 21:513–527.
11. Luzzi S, Snowden JS, Neary D, Coccia M, Provinciali L, Lambon Ralph MA
(2007) Neuropsychologia 45:1823–1831.
12. Lambon Ralph MA, Graham KS, Patterson K, Hodges JR (1999) Brain Lang
70:309–335.
13. Bozeat S, Lambon Ralph MA, Graham KS, Patterson K, Wilkin H, Rowland
J, Rogers TT, Hodges JR (2003) Cognit Neuropsychol 20:27–47.
14. Bozeat S, Lambon Ralph MA, Patterson K, Hodges JR (2002) Cognit Affective
