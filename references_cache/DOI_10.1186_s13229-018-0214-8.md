...
full_text_url: "https://molecularautism.biomedcentral.com/track/pdf/10.1186/s13229-018-0214-8"
oa_status: gold
license: cc-by
local_pdf_path: files/DOI_10.1186_s13229-018-0214-8.pdf
---
...
Hanna den Bakker 1,2,3†, Michael S. Sidorov 1,2,3†, Zheng Fan 4, David J. Lee 5, Lynne M. Bird 6,7, Catherine J. Chu 8,9
and Benjamin D. Philpot 1,2,3*
Abstract
...
gamma band. EEGs from children with AS contained fewe r sleep spindles, and these spindles were shorter in
duration than their neurotypical counterparts.
Conclusions: We demonstrate two quantitative readouts of dy sregulated sleep composition in children with
AS— gamma coherence and spindles — and describe how functional connectivity patterns may be disrupted
during wakefulness. Quantitative EEG phenotypes h ave potential as biomarkers and readouts of target
engagement for future clinical trials and provide clues into how neural circuits are dysregulated in children
with AS.
Keywords: Angelman syndrome, UBE3A, EEG, Coherence, Spindles, Biomarker
Background
...
2Carolina Institute for Developmental Disabilities, University of North Carolina,
Chapel Hill, NC 27599, USA
...
den Bakker et al. Molecular Autism  (2018) 9:32 
https://doi.org/10.1186/s13229-018-0214-8

Coherence is a measure of how two simultaneously re-
...
EEG signals during wakefulness (NT: n =5 4 ; A S :n = 26),
and one consisting of periods of NREM sleep (NT:
n = 54; AS: n = 13).
den Bakker et al. Molecular Autism  (2018) 9:32 Page 2 of 12
...
Coherence analysis
We made group coherence co mparisons (AS versus NT)
separately in periods of wakefulness (Fig.2, Additional file1:
Figure S1) and periods of NREM sleep (Fig. 3,
Additional file 2:F i g u r eS 2 ) .W i t h i ne a c hE E Gr e c o r d i n g ,
...
49] .T h em s c o h e r ef u n c t i o ncalculates the magnitude-
...
den Bakker et al. Molecular Autism  (2018) 9:32 Page 3 of 12

d2
ab ¼ xa−xbðÞ 2 þ ya−ybðÞ 2
...
den Bakker et al. Molecular Autism  (2018) 9:32 Page 4 of 12

instantaneous amplitude of the filtered signal crossed a
...
frequency and spindle duration (Fig. 4e– f )r e p r e s e n t
...
(Fig. 4e, left panel; n =1 3 ) ; t h e r e f o r e , w e e x c l u d e d
t h e s er e c o r d i n g sf r o ma n a l y s e so fs p i n d l ed u r a t i o n
...
genotype (Fig. 2b; F(1, 390) =8 . 3 2 ,p = 0.0041), there was no
...
den Bakker et al. Molecular Autism  (2018) 9:32 Page 5 of 12

Comparison of NT and AS long-range maps suggests
...
(Additional file 1:F i g u r eS 1 H– I). Overall, we con-
...
(Fig. 2f;d e l t a :p = 0.0037, theta: p = 0.0401, alpha: p =
...
broadly increased relative to short-range coherence within AS individuals. NT (black): n = 54, AS (red): n =2 6
den Bakker et al. Molecular Autism  (2018) 9:32 Page 6 of 12

genotype (Fig. 3b; F(1,315) = 0.002, p = 0.9672) and no
...
processing phase [ 56]( s e et h e “Methods” section).
...
Fig. 3 Long-range gamma-band coherence during sleep is increased in AS.a Average short-range coherence across all frequency bands (deltaδ,t h e t a
θ, alpha α,b e t aβ,g a m m aγ). b Short-range coherence analyses grouped across all frequencies (“overall”) and by frequency. c Average long-range
...
(black): n = 53, AS (red): n =1 2
den Bakker et al. Molecular Autism  (2018) 9:32 Page 7 of 12

differences in coherence between AS and NT groups are
...
[59]( F i g . 4d). Children with AS had fewer spindles
...
threshold (gray) was used to define spindle duration. e Automated detection— spindle rate (NT: n =5 4 ,A S :n = 13) and duration (NT: n =5 4 ,A S :n =1 1 )
...
den Bakker et al. Molecular Autism  (2018) 9:32 Page 8 of 12

blind to genotype. Results from expert 1 revealed a trend
...
(Figs. 2, 3,a n d 4). In a prior study, we reported that chil-
...
connections (Fig. 2e, Additional file 1:F i g u r eS 1 ) .T h e r e
...
connectivity in AS, both in mouse models [ 65]a n d
...
den Bakker et al. Molecular Autism  (2018) 9:32 Page 9 of 12

delta activity that is pervasive in the AS EEG; however,
...
measures of target engageme nt are especially valuable.
...
(T able 1), these phenotypes are likely linked to sleep
...
two-way ANOVA: genotype:F(1,315) =1 . 4 8 4 ,p = 0.2240; genotype × frequency
interaction: F(4,315) =2 . 9 4 3 ,p = 0.0206; post hoc tests: delta, theta, alpha, beta:
...
den Bakker et al. Molecular Autism  (2018) 9:32 Page 10 of 12

coherence through individual elec trodes and (I) electrodes grouped
...
electroencephalogram cortical osci llations and large-scale functional
...
and quantitative EEG in neurodegener ative disorders. J Psychosom Res.
2004;56:487 –96.
