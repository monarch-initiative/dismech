...
| Exposure factors | % cases (n = 32) | % controls (n = 128) | ORM-H | 95%CI |
...
*An area on the lakeshore which was protected by rocks and a fence to protect water collectors from attacks by lake animals (such as crocodiles and hippopotamuses); #Boiling, filtering, or chlorination with chlorine tablets.