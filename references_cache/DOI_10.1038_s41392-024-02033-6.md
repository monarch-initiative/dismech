...
signiﬁcantly contribute to the global challenges of anemia and blood shortages. Current treatments like erythropoietin (EPO) or
...
(HSPCs). We discovered that BRAF inhibitors (BRAFi), commonly used to treat BRAF
V600E melanoma, can unexpectedly and
...
exhibited pronounced ef ﬁcacy even under cytokine-restricted conditions and in patient samples of DBA. Mechanistically, although
these BRAFi inhibit the MAPK cascade in BRAF V600E mutant cells, they paradoxically act as ampli ﬁers in wild-type BRAF cells,
potently enhancing the cascade. Furthermore, we found that while the oncogenic BRAF V600E mutation disrupts hematopoiesis and
...
shown that BRAFi can enhance human hematopoiesis and erythropoiesis in severe immunode ﬁcient mouse models and alleviate
anemia in the Rpl11 haploinsufﬁciency DBA model, as well as other relevant anemia models. This discovery underscores the role of
...
Signal Transduction and Targeted Therapy           (2024) 9:338 ; https://doi.org/10.1038/s41392-024-02033-6
INTRODUCTION
Erythropoiesis, essential for the daily production of roughly
2×1 0
11 red blood cells, is a key process compromised in various
...
(CFU-Es), are critical for erythroid production.
3 Erythropoietin
(EPO) supports CFU-Es survival and differentiation and is a
common treatment for anemia, especially in chronic kidney
diseases.
4,5 However, its effectiveness is limited in cases where
progenitor cells are de ﬁcient, including anemias caused by
...
for treating EPO-resistant anemias. Agents like corticosteroids,
9
HIF-PHD inhibitors, 10 TGF-β inhibitors,5 and PPAR α agonists4 can
...
cell proliferation, survival, and differentiation, signi ﬁcantly impact-
ing erythropoiesis.
11,12 Activation of this pathway is mediated by
cytokines like EPO and stem cell factor (SCF), which bind to their
respective receptors (EPOR and KIT), initiating downstream
signaling processes.
13 The SCF-KIT interaction is pivotal for the
...
development.
13,14 The transition from self-renewal to differentia-
tion in erythropoiesis necessitates a decline in KIT-mediated ERK/
MAPK signaling, which coincides with the cell ’s reduced
Received: 2 July 2024 Revised: 23 October 2024 Accepted: 24 October 2024
1The MOE Key Laboratory of Cell Proliferation and Differentiation, School of Life Sciences, Peking University, Beijing 100871, China; 2Peking-Tsinghua Center for Life Sciences,
Academy for Advanced Interdisciplinary Studies, Peking University, Beijing 100871, China; 3School of Life Sciences, Westlake University, Hangzhou, Zhejiang, China; 4Westlake
Laboratory of Life Sciences and Biomedicine, Hangzhou, Zhejiang, China; 5Department of Chemical Biology, College of Chemistry and Molecular Engineering, Peking University,
Beijing 100871, China; 6Hematology Center, Beijing Key Laboratory of Pediatric Hematology Oncology; National Key Discipline of Pediatrics (Capital Medical University); Key
Laboratory of Major Diseases in Children, Ministry of Education; Beijing Children ’s Hospital, Capital Medical University, National Center for Children ’s Health, Beijing, China;
7Peking University People ’s Hospital, Peking University Institute of Hematology, National Clinical Research Center for Hematologic Disease, Beijing Key Laboratory of
Hematopoietic Stem Cell Transplantation, Collaborative Innovation Center of Hematology, Peking University, Beijing 100871, China and 8Department of Hematology, Zhejiang
Provincial People ’s Hospital, Hangzhou, Zhejiang, China
Correspondence: Xiangmin Tong (tongxiangmin@163.com) or Xiaofei Gao (gaoxiaofei@westlake.edu.cn) or Hsiang-Ying Lee (slee@pku.edu.cn)
These authors contributed equally: Shunkang Wu, Yuelin Deng.
www.nature.com/sigtransSignal Transduction and Targeted Therapy
© The Author(s) 2024
1234567890();,:

proliferative capacity, as supported by recent proteomic and
...
gene.
17 The predominant BRAF mutation, BRAF V600E, found in over
...
cancers.
17 In hematopoietic stem and progenitor cells (HSPCs),
the BRAF V600E mutation disrupts normal hematopoiesis and
...
treat melanomas with the BRAF V600E mutation, can prominently
...
enhanced hematopoiesis and erythropoiesis in immunode ﬁcient
NPSG and NCG-X mice and various anemia models,
21 including
the Rpl11 haploinsufﬁciency mouse model of DBA. Our research
...
9 Despite existing methodolo-
gies to purify BFU-Es, their scant presence presents signi ﬁcant
hurdles for ef ﬁcient compound screening. 22,23 To address the
...
(CD71
+CD235a− and CD71 +CD235a+) (Supplementary Fig. 1a, b).
...
the expansion of erythroid progenitor cells. Our ﬁndings
unexpectedly identi ﬁed BRAF inhibitors, including Dabrafenib,
...
(SB), and FDA-approved Encorafenib are signi ﬁcantly more potent
...
Collectively, these ﬁndings indicate that BRAFi have the potential
...
delay in erythroid differentiation in the human CD34
+ erythroid
...
1e, f). Moreover, treatment with BRAFi signi ﬁcantly increased
...
progenitor cells and treated them with BRAF inhibitors.
24 We
...
erythroid progenitor cells, we con ﬁrmed that BRAFi continued to
exert a signi ﬁcant proliferative effect in later stages (erythroid
differentiation Day 5-9 and Day 9-13) when administered for 4
days (Supplementary Fig. 1h). These ﬁndings suggest that BRAFi
...
can be ef ﬁciently expanded and thus can serve as a valuable
source for ex vivo RBC generation.
25 Evaluations of PBMCs from
...
role in MAPK activation, de ﬁciency in either can result in
ineffective erythropoiesis.
13–15 Consequently, we investigated
...
ﬁnd that BRAFi treatment nearly rescued the inef ﬁcient differ-
...
BRAF inhibitors enhance erythropoiesis and treat anemia through. . .
Wu et al.
2
Signal Transduction and Targeted Therapy           (2024) 9:338 

Fig. 1 BRAF inhibitors promoted the self-renewal of primary erythroid progenitors in vitro .a Drug treatment work ﬂow in UCB-CD34 +-derived
...
the control group. c The growth curve of UCB-CD34
+-derived erythroid culture over 14 days in vitro, starting from 1.2 × 10 4 cells on Day 0. The
...
(DMSO) group. d Representative ﬂow cytometry analysis of UCB-CD34
+-derived erythroid cells in the control group (DMSO) and the GDC-
...
14 days. (Left) Whole-plate view; (Right) BFU-E colony. Scale bar = 10 mm (Left), 500 μm (Right). f, g Colony number and ratio statics of panel
(e). There was no signi ﬁcant difference between the two groups in the proportion of either colony in panel ( f). h Quantiﬁcation of total cell
...
Erythroid cells are identi ﬁed as CD235a +, and myeloid cells as CD11b +. i UCB-CD34+ cells were differentiated for 5 days, after which erythroid
...
Scale bar = 10 mm (Left), 500 μm (Right). k, l Colony number and quanti ﬁcation of cell number of cells washed from Methocult medium on
...
counts, with declines of 24.7-fold and 5.6-fold, respectively,
...
BRAF cells rather than blocking the MAPK cascade in BRAF
V600E
...
of Vemurafenib,
29,30 neither increased cell numbers nor induced
...
pathway, we conducted intracellular ﬂow cytometry staining for
phosphorylated ERK in CD34
+ cells that had undergone erythroid
...
derived erythroid cells in the control group and GDC-0879-treated group on differentiation Day 9 under normal and speci ﬁed conditions (5%
...
cells under different cytokine-restricted conditions on Day 14. d Cell pellets of UCB-CD34
+ derived erythroid cells cultured under different
...
derived erythroid cells, starting from 1.2 × 10 4 cells, treated with 2 μM GDC-0879 under the indicated conditions from Day 0 to Day 14. The
...
ANOVA under the speci ﬁed culture conditions. n = 3. f Flow cytometry analysis of UCB-CD34 +-derived erythroid cells treated with DMSO or
...
(Encorafenib, GDC, or SB)-treated or control conditions for 14 days. Scale bar = 10 mm. h Statistical analysis of the area of 75 individual
...
differentiation for 7 days. At all 6 treatment intervals, ranging from
10 min to 24 h, BRAFi treatment consistently and signi ﬁcantly
elevated ERK phosphorylation levels across every erythroid cell
subpopulation, including hematopoietic progenitors
(CD71
−CD235a−), erythroid progenitors (CD71 +CD235a−) and
precursors (CD71 +CD235a+) (Fig. 3c, Supplementary Fig. 3a, b),
and we also validated the upregulated ERK phosphorylation in
erythroid cells through immuno ﬂuorescence staining (Fig. 3d).
Notably, intracellular ﬂow cytometry analysis revealed that the
...
pronounced in the erythroid progenitor stage (CD235a -) and less
...
erythropoiesis, showing a decreasing trend from CD71
−CD235a−
...
K562 cells,
31 its capacity to induce ERK phosphorylation in primary
...
insulin-like growth factor 1 (IGF1) and basic ﬁbroblast growth
factor (bFGF), while the control group showed no noticeable
increase in pERK, BRAFi treatment for just 30 min resulted in a
signiﬁcant elevation in pERK levels, as revealed by intracellular
ﬂow cytometry (Fig. 3e, Supplementary Fig. 3e). Similarly, in the
presence of EPO and IL3, BRAFi signi ﬁcantly induced pERK in K562
...
from already activated RAS/MAPK pathways, leading to signi ﬁ-
...
phosphorylation varied depending on the speci ﬁc cytokine
(Supplementary Fig. 3g).
Furthermore, knocking down different RAF proteins in human
CD34
+ erythroid cultures revealed that targeting CRAF led to a
signiﬁcant reduction in both cell proliferation and MAPK pathway
activation (Supplementary Fig. 3h –j). These ﬁndings underscore
...
dimerization of RAF proteins, particularly with CRAF.
29,32–34 To
...
In summary, these ﬁndings indicate that BRAFi stimulate
...
Constitutive activation by BRAF
V600E, unlike BRAF inhibitors, disrupted
hematopoietic stem cell maintenance and abolished erythropoiesis
While the BRAF V600E mutation is predominantly associated with a
high incidence of mutation in solid tumors, such as melanoma, it
has also been identi ﬁed in various hematological malignan-
...
originating from myeloid progenitors, often exhibits the BRAF V600E
...
Fig. 3 BRAF inhibitor-induced ampli ﬁcation of the ERK/MAPK cascade in erythroid progenitor cells was dependent on CRAF and the active
...
conditions and treated on Day 9 with Encorafenib (0.5 μM), GDC-0879 (2 μM), or SB-590885 (0.5 μM) for 30 min. b Levels of phosphorylated and
...
for 30 min. c Median ﬂuorescence intensity (MFI) statistics of intracellular ﬂow cytometry of phosphorylated-ERK-FITC of 7-day differentiated
erythroid cells from UCB-CD34 + treated with 2 μM GDC or 200 nM PMA for different time period. The dashed line indicates the ﬂuorescence
intensity of the negative control. n = 3. d Immunoﬂuorescence staining of phosphorylated-ERK-FITC, erythroid markers CD235a-APC and
CD71-PE, and DAPI of 7-day differentiated erythroid cells from UCB-CD34 + treated for 30 min. Scale bar = 10 μm. e Representative intracellular
ﬂow cytometry histograms and MFI statistics of phosphorylated-ERK-FITC in 293 T cells under different culture system treated in different
chemicals and concentration for 30 min. DMEM: DMEM with 10% FBS; bFGF (basic ﬁbroblast growth factor), 50 ng/mL; IGF1 (insulin-like
growth factor 1), 50 ng/mL. n = 3. f Heatmap of the top 20 proteins that were most signi ﬁcantly upregulated and downregulated respectively
by 3 × Flag-BRAF interaction proteins in the control group (DMSO) and the 30-minute 1 μM SB-treated group, identi ﬁed through ﬂag-afﬁnity
...
proteins that were most signi ﬁcantly upregulated and downregulated respectively by 3 × Flag-BRAF interaction proteins in the control group
(DMSO) and the 30-minute 200 nM PMA-treated group, identi ﬁed through Flag-af ﬁnity IP-MS of 3 × Flag-BRAF in BRAF-overexpressing K562
cells. cutoff, p < 0.01. i Volcano plot of the differentially expressed genes (DEGs) between CD71
+ erythroid progenitor cells treated with 2 μM
GDC for 72 h and control (DMSO) groups. DEGs were de ﬁned with a cutoff fold change > 1.5, FDR (false discovery rate) < 0.1. j The Molecular
...
from the paradoxical activation triggered by BRAFi in erythropoi-
...
constitutive activation triggered by BRAF
V600E both activating ERK,
but leading to contradictory phenotypes.
We ﬁrst overexpressed the BRAF V600E mutant and wild-type
...
erythroid colony formation, while BRAF
V600E overexpression
nearly completely inhibited eryth roid colony formation, without
impacting the number of granulocytes and monocytes colonies
(Fig. 4b, c), suggesting BRAF
V600E did not result in a HSPC
lineage skewing towards other myeloid lineages. Then we
found cells expressing BRAF V600E exhibited a rapid decline in the
...
In UCB-CD34
+ cell erythroid differentiation culture, BRAF V600E
...
Interestingly, BRAF
WT overexpression did not affect cell pro-
liferation or interrupt the pro-p roliferative effect of BRAFi
(Supplementary Fig. 5e, f).
These ﬁndings suggest that overexpression of BRAF V600E nearly
...
BRAF
V600E disrupted hematopoiesis and erythropoiesis by
hyperactivating AP-1 family transcription factors
To understand the divergent phenotypes resulting from BRAF
V600E
overexpression compared to BRAFi treatment, we conducted RNA-
seq analysis on HSPCs overexpressing BRAF
V600E, and control, with or
without GDC treatment. K-means clustering of the most variable
2000 genes yielded three cluster s. Cluster A, which included 1532
genes, such as MMP9, MMP1, CD207, CD1A, CD11C (ITGAX), and JUN,
characterized a CD1a + Langerhans cells phenotype with pathway
enrichment in the MAPK cascade and in ﬂammatory response,
indicating a dendritic cell-like expression proﬁle consistent with the
...
MPO,a n d KIT associated with HSPC maintenance, were enriched in
the control and GDC groups, suggesting that BRAF V600E disrupts
genes crucial for sustaining HSPCs (Fig.5a, Supplementary Fig. 6b, c).
Unlike BRAF V600E, BRAFi treatment only slightly affected the
...
patterns in the BRAF V600E group, differing from the control, GDC-
treated, and BRAF WT groups in HSPC retention culture system (Fig.
5c, d). In comparing BRAF V600E to the common peaks found in the
control, GDC, and BRAF WT (CGW) group, motif analysis from whole
genome and promoters both underscored a signi ﬁcant
...
(b). Scale bar = 10 mm. d Flow cytometry analysis of HSPC surface markers on Day 12 in HSPC retention medium (top), and erythroid cell
...
enrichment (genome, p-value < 1e−7000) of AP-1 family transcrip-
tion factors in BRAF V600E-speciﬁc peaks, while the peaks for the
control, GDC, and BRAF WT groups were associated with ETS family
motifs, known for their roles in hematopoietic maintenance and
differentiation (Fig. 5d, e, Supplementary Fig. 6f).
Integrating transcriptome proﬁling, it was observed that BRAFi
modestly activated genes related to proliferation, including MYB,
CDK2, CDK6 . Conversely, overexpression of BRAF
V600E markedly
increased the overall expression of AP-1 family transcription factors
and related genes such as JUN, FOS,a n d JUNB, which did not show
BRAF inhibitors enhance erythropoiesis and treat anemia through. . .
Wu et al.
8
Signal Transduction and Targeted Therapy           (2024) 9:338 

signiﬁcant upregulation with BRAFi treatment (Supplementary Fig.
7a, b). Furthermore, Gene Set Enrichment Analysis (GSEA) conﬁrmed
...
BRAFV600E group (Supplementary Fig. 7 e). Interestingly, RNA-seq
...
on Day 10 of erythroid differentia tion. Consistently, our results
showed that the BRAF V600E group exhibited enrichment of AP-1-
related motifs in the genomic promoter regions compared to the
control group, while the BRAF inh ibitor-treated group exhibited
...
proteomics between BRAF
WT in the presence of a BRAF inhibitor
and BRAF V600E, we conducted IP-MS using 3 × Flag-BRAF WT and
3 × Flag-BRAFV600E overexpressing 293 T cells. Consistent with the
ﬁndings in K562 cells, the abundance of BRAF WT-interacting
...
and BRAF compared to the BRAF
V600E group. Interestingly, the
...
to the BRAF
V600E and BRAF WT control groups (Fig. 5j).
Collectively, our multi-omics analyses reveal that the prefer-
ential interaction of AP-1 with BRAF V600E provides insights into the
distinct erythroid and HSPC phenotypes induced by paradoxical
BRAFi activation versus BRAF V600E’s constitutive activation, despite
...
CD34
+ HSPCs were transplanted into NPSG mice for 10 weeks,
then followed by a 4-week administration of GDC (Fig. 6a). We
observed a signi ﬁcant increase in the percentage of human
...
(hCD71
−hCD235a+) (Fig. 6c). The HSPC (hCD45RA − hCD34+) ratio
...
efﬁciency, making them less than ideal for our model, we repeated
...
efﬁciency without the need for irradiation (Fig. 6d).
21 Consistent
...
was a signi ﬁcant elevation in the percentage of erythroid cells and
...
commonly results in anemia.
41 Treatment with GDC mitigated this
...
represents the log10( p-value), and bubble size re ﬂects the geneset size of the GO term in the Gene Ontology Biological Process (GOBP)
...
WT, BRAFWT; V600E, BRAF V600E. d Differential chromatin accessibility peaks in the UCB-CD34 + ATAC-seq analysis, comparing the Ctrl (DMSO),
GDC and BRAF WT (CGW) group ’s common region to the BRAF V600E (V) group. The value 0 represents the peak center in ATAC-seq. e Known
motif enrichment analysis of differential ATAC-seq peaks in genome from the CGW group and the BRAF V600E group using HOMER software.
...
BRAFV600E vs. control groups and GDC vs. control groups. g Schematic diagram of the experimental work ﬂow for electroporation BRAF V600E
...
seq peaks of promoter region between the GDC group and the BRAF V600E group cells compared with control group in panel ( g) using HOMER
...
BRAFV600E group compared with control group (Bottom, red shade). i Number of proteins up- and down-regulated in Flag-af ﬁnity IP-MS in
BRAFWT overexpressing cells treated with 1 μM SB for 30 min, or in BRAF V600E overexpressing 293 T, compared to the BRAF WT overexpressing
...
with Flag-BRAF WT (with or without BRAFi) or Flag-BRAF V600E in IP-MS. For ATAC-seq and RNA-seq, both the control and GDC groups were
...
Fig. 6 BRAF inhibitors promoted erythroid and megakaryocytic engraftment in human hematopoietic reconstitution, and alleviated anemia
...
b Representative ﬂow cytometry analysis of the proportion of erythroid cells and megakaryocytes in human engraftment and erythroid
...
Representative ﬂow cytometry analysis of the proportion of erythroid cells and megakaryocytes in human engraftment and erythroid
...
in Week 2 and bone marrow cell composition was analyzed in Week 3 through ﬂow cytometry. Each dot represents one mouse. h Red blood
...
enhanced population of CD71 + Ter119+ erythroblasts (Supple-
...
anemia in the Rpl11 haploinsufﬁciency mouse model in vivo
...
biogenesis.
7,8 Less than half of the patients respond to steroids,
the primary treatment option, and the only de ﬁnitive cure is
...
mutations (Fig. 7a, b).
The Rpl11 haploinsufﬁciency DBA mouse model, reported to
...
observed in vitro to their ef ﬁcacy in DBA animal models, offering
...
EPO treatment due to a scarcity and functional de ﬁciency of
erythroid progenitor cells.
4,8 Newly approved drugs like HIF-PHD
inhibitors and activin receptor ligand traps are dependent on the
late erythroid progenitors for ef ﬁcacy.45,46 Our understanding of
the mechanisms driving BFU-E cells self-renewal and the
development of drugs to enhance their proliferation remains
incomplete. To address this, we devised an ef ﬁcient primary
human UCB-CD34 + HSPC-based screening system that identi ﬁed
...
signaling.
15,16 These inhibitors work by enhancing the ERK/MAPK
...
on maturation or enucleation. Our intracellular ﬂow cytometry
experiments in primary erythroid progenitor cells, as well as in
Fig. 7 BRAF inhibitors improved erythroid proliferation in cells from DBA patients in vitro and alleviated anemia in Rpl11 haploinsufﬁciency
mice in vivo. a Representative images of erythroid colonies derived from 10 5 PBMCs of DBA patients with RPL5 or RPL11 mutations, seeded in
Methocult H4435 for 14 days. b Quantiﬁcation of erythroid colony area from DBA patients ’ PBMCs, as shown in panel ( a) on Day 14. c Rpl11
...
count were measured after 5 weeks of GDC administration in the Rpl11 haploinsufﬁciency DBA mouse model ( n = 5 or 6). Each dot represents
...
293T and K562 cell lines, demonstrate that BRAF inhibitors can
...
not elicit such signi ﬁcant increase in MAPK activity. Moreover, we
highlight that the role of BRAF inhibitors as signaling ampli ﬁers is
...
Contrarily, the BRAF
V600E, a primary cause of hematological
...
entiation.
35,38,39 While the exact mechanisms of BRAF V600E-
...
temporarily delaying differentiation, leading to increased RBC production. (Bottom Panel: BRAF
V600E-Mediated Erythroid Disruption) The
constitutive activation of BRAF (BRAF V600E mutation) disrupts erythroid differentiation, leading to abnormal cell fate decisions and impaired
...
induced LCH in HSPCs are still being decoded, it is known to
trigger a senescence program in early multipotent HSPCs. 35,36,39
Our study recapitulated the previously reported BRAF V600E
...
biasing towards monocyte differentiation or signi ﬁcant stemness
...
and variations in proteins interacting with BRAF
V600E. In contrast,
BRAFi pharmacologically ampli ﬁes and prolongs the typical
...
ampliﬁed MAPK phosphorylation induced by BRAF inhibitors
...
BRAF and CRAF.
32,33,47,48 The mass spectrometry results from our
study not only con ﬁrmed the role of BRAF in the MAPK cascade
and its activation through dimerization with CRAF but also
identiﬁed other interacting proteins potentially impacted by BRAF
...
enhanced interaction between BRAF
V600E and translation initiation
factors hints at a possible link between BRAF and the regulation of
translation.
RAF kinase inhibitors are classi ﬁed based on the kinase
...
interaction in this conformation.
29,30,33,48 Although paradoxical
activation limits the use of type I BRAFi in cancer therapy, their
role is bene ﬁcial in scenarios where this activation is desired, such
as wound healing,
49 promoting podocytes survival, 50 and here,
erythropoiesis.
...
effect, favorable safety pro ﬁle, and the natural downregulation of
...
ampliﬁer or favorable activator under speci ﬁc circumstances may
...
Medical Af ﬁliated Beijing Children ’s Hospital approved the
...
pMSCV-3×Flag-T2A-GFP, including pMSCV-3×Flag-BRAF
WT-T2A-
GFP and pMSCV-3×Flag-BRAF V600E-T2A-GFP.
Cell lines
...
and authenticated by short tandem repeat identi ﬁcation. HEK293T
...
the intracellular ﬂow cytometry of drug treatment, 293T cells were
...
UCB-CD34+ cells) were puriﬁed from cord blood samples obtained
...
PEG-300 and 50% PBS at concentrations of 2, 3, and 5 mg/mL.
Cell proliferation assay
Cell proliferation was assessed by a Luna automated ﬂuorescence
...
cell culture incubator for 3 h. The ﬂuorescence of optical density
...
USA), with the baseline ratio (measured in no-cell control wells)
subtracted.
Immunoﬂuorescence staining
For immuno ﬂuorescence staining, cells were ﬁrst ﬁxed in 4% PFA
...
at room temperature. To block non-speci ﬁc binding, the cells were
...
with appropriate ﬂuorophore-conjugated secondary antibodies
...
A total of 100 –300 UCB-derived CD34
+ cells or 5 × 10 4–2×1 0 5
PBMCs were resuspended in 1 –2 mL methylcellulose medium
(StemCell Technologies, Methocult H4435 or Methocult H4330
EPO only) containing 1 –2 μL ciproﬂoxacin and 1 –2 μL compounds
...
following which PBS was added for elution, counting, and ﬂow
cytometry, if necessary. The colony area was measured using
ImageJ v. 1.53q. Except where speci ﬁcally mentioned: SB, 1 μM SB-
590885; GDC, 2 μM GDC-0879; Enco, 500 nM Encorafenib, and
these compounds were only added once at the beginning of
seeding.
DATA AVAILABILITY
High-throughput sequencing data are available in the NCBI Gene Expression
Omnibus database GSE221242, GSE261119 and GSE275226. The mass spectrometry
proteomics data have been deposited to the ProteomeXchange Consortium with the
dataset ID PXD055730.
ACKNOWLEDGEMENTS
The authors thank the National Center for Protein Sciences at Peking University in
Beijing, China, for the support of ﬂow cytometry and mass spectrometry, and Drs.
Hongxia Lv, Huan Yang, Xuefang Zhang, Jia Luo and Yabin Bian for the help with cell
sorting, Liqin Fu for the help with using confocal microscope, and Qi Zhang and
Dong Liu for their help on mass spectrometry experiments. The authors express their
gratitude to the High-Performance Computing Platform of the Center for Life
Sciences (Peking University) for their support in data analysis, and to Beijing
Jiachenhong Bio-Tech Co., LTD (Beijing Cord Blood Bank) for providing the cord
blood samples. The authors thank the Laboratory Animal Centre PKU for assistance
with the construction of the mouse model, with Dr. Yonglu Tian and Dr. Xiaying Li for
technical help. The authors also thank innomodel inc. for their technical support with
the immune system humanized model. This study received grant support from the
National Key R&D Program of China (2022YFA1103300), SLS-Qidong Innovation Fund
(8410101639), the Peking-Tsinghua Center for Life Sciences and School of Life
Sciences, Peking University to H.-Y.L.; grant support from the Zhejiang Provincial
Natural Science Foundation of China (LR20C070001), “Leading Goose ” R&D Program
(2024C03089), and the Science and Technology Department of Zhejiang Province
(Key Project, 2021C03011) ” to X.G.
AUTHOR CONTRIBUTIONS
S.W., Y.D., and H.-Y.L. designed the study; S.W., Y.D., H.Z., H.L., and X.Z. performed the
experiments; S.Z. and F.W. conducted the bioinformatic analysis. F.G. and XG.L.
provided the compounds for screening; J.Z., M.L., Y.K., Q.H., S.X. and X.-J.H. provided
the materials for in vitro cultures; XW.L., HB.S., SC.Z., Q.Y., N.L., XM.T. and X.G. helped
with in vivo experiments. S.W., Y.D., and H.-Y.L. wrote the manuscript, and all authors
have read and approved the article.
ADDITIONAL INFORMATION
Supplementary information The online version contains supplementary material
available at https://doi.org/10.1038/s41392-024-02033-6.
Competing interests: The authors declare no competing interests. Schematic ﬁgures
were generated with BioRender ( https://app.biorender.com/).
REFERENCES
1. Dzierzak, E. & Philipsen, S. Erythropoiesis: development and differentiation. Csh
Perspect. Med. 3, a011601 (2013).
2. Hattangadi, S. M., Wong, P., Zhang, L., Flygare, J. & Lodish, H. F. From stem cell to
red cell: regulation of erythropoiesis at multiple levels by multiple proteins, RNAs,
and chromatin modi ﬁcations. Blood 118, 6258 –6268, (2011).
3. Palis, J. Primitive and de ﬁnitive erythropoiesis in mammals. Front. Physiol. 5,3
(2014).
4. Lee, H. Y. et al. PPAR-alpha and glucocorticoid receptor synergize to promote
erythroid progenitor self-renewal. Nature 522, 474 –477 (2015).
5. Gao, X. et al. TGF-beta inhibitors stimulate red blood cell production by enhan-
cing self-renewal of BFU-E erythroid progenitors. Blood 128, 2637 –2641 (2016).
6. Sankaran, V. G. & Weiss, M. J. Anemia: progress in molecular mechanisms and
therapies. Nat. Med. 21, 221 –230, (2015).
7. Ball, S. Diamond Blackfan anemia. Hematol. Am. Soc. Hematol. Educ. Program
2011, 487 –491 (2011).
8. Da Costa, L., Leblanc, T. & Mohandas, N. Diamond-Blackfan anemia. Blood 136,
1262–1273 (2020).
9. Li, H. J. et al. Rate of progression through a continuum of transit-amplifying pro-
genitor cell states regulates blood cell production. Dev. Cell 49,1 1 8–129, (2019).
10. Flygare, J., Rayon Estrada, V., Shin, C., Gupta, S. & Lodish, H. F. HIF1alpha syner-
gizes with glucocorticoids to promote BFU-E progenitor self-renewal. Blood 117,
3435–3444, (2011).
11. Lavoie, H., Gagnon, J. & Therrien, M. ERK signalling: a master regulator of cell
behaviour, life and fate. Nat. Rev. Mol. Cell Biol. 21, 607 –632 (2020).
12. Geest, C. R. & Coffer, P. J. MAPK signaling pathways in the regulation of hema-
topoiesis. J. Leukoc. Biol. 86, 237 –250, (2009).
13. Wu, H., Klingmuller, U., Besmer, P. & Lodish, H. F. Interaction of the Erythropoietin
and stem-cell-factor receptors. Nature 377, 242 –246, (1995).
14. Sui, X. W., Krantz, S. B., You, M. & Zhao, Z. Z. Synergistic activation of MAP kinase
(ERK1/2) by erythropoietin and stem cell factor is essential for expanded ery-
thropoiesis. Blood 92, 1142 –1149 (1998).
15. Karayel, O. et al. Integrative proteomics reveals principles of dynamic phospho-
signaling networks in human erythropoiesis. Mol. Syst. Biol.
16, e9813 (2020).
16. Peng, Y. et al. Comprehensive proteomic analysis reveals dynamic phospho-
proﬁling in human early erythropoiesis. Br. J. Haematol. 199, 427 –442 (2022).
17. Dhillon, A. S., Hagan, S., Rath, O. & Kolch, W. MAP kinase signalling pathways in
cancer. Oncogene 26, 3279 –3290, (2007).
18. Davies, H. et al. Mutations of the BRAF gene in human cancer. Nature 417,
949–954 (2002).
19. Ahmadzadeh, A. et al. BRAF mutation in hairy cell leukemia. Oncol. Rev. 8, 253
(2014).
20. Allen, C. E., Merad, M. & McClain, K. L. Langerhans-cell histiocytosis. N. Engl. J. Med.
379, 856 –868 (2018).
21. Rahmig, S. et al. Improved human erythropoiesis and platelet formation in
humanized NSGW41 mice. Stem Cell Rep. 7, 591 –601 (2016).
22. Dulmovits, B. M., Hom, J., Narla, A., Mohandas, N. & Blanc, L. Characterization,
regulation, and targeting of erythroid progenitors in normal and disordered
human erythropoiesis. Curr. Opin. Hematol. 24, 159 –166 (2017).
23. Li, J. et al. Isolation and transcriptome analyses of human erythroid progenitors:
BFU-E and CFU-E. Blood 124, 3636 –3645 (2014).
24. Li, D. et al. Multidimensional pro ﬁling reveals GATA1-modulated stage-speci ﬁc
chromatin states and functional associations during human erythropoiesis.
Nucleic Acids Res. 51, 6634 –6653 (2023).
25. Heshusius, S. et al. Large-scale in vitro production of red blood cells from human
peripheral blood mononuclear cells. Blood Adv. 3, 3337 –3350 (2019).
26. Hatzivassiliou, G. et al. RAF inhibitors prime wild-type RAF to activate the MAPK
pathway and enhance growth. Nature 464, 431 –435 (2010).
27. Heidorn, S. J. et al. Kinase-dead BRAF and Oncogenic RAS cooperate to drive
...
28. Poulikakos, P. I., Zhang, C., Bollag, G., Shokat, K. M. & Rosen, N. RAF inhibitors
transactivate RAF dimers and ERK signalling in cells with wild-type BRAF. Nature
464, 427 –430, (2010).
29. Zhang, C. et al. RAF inhibitors that evade paradoxical MAPK pathway activation.
Nature 526, 583 –586 (2015).
30. Yao, Z. et al. RAF inhibitor PLX8394 selectively disrupts BRAF dimers and RAS-
independent BRAF-mutant-driven signaling. Nat. Med. 25, 284 –291 (2019).
31. Herrera, R., Hubbell, S., Decker, S. & Petruzzelli, L. A role for the MEK/MAPK
pathway in PMA-induced cell cycle arrest: modulation of megakaryocytic differ-
entiation of K562 cells. Exp. Cell Res. 238, 407 –414 (1998).
32. Koelblinger, P., Thuerigen, O. & Dummer, R. Development of encorafenib for
BRAF-mutated advanced melanoma. Curr. Opin. Oncol. 30, 125 –133 (2018).
33. Karoulia, Z. et al. An integrated model of RAF inhibitor action predicts inhibitor
activity against oncogenic BRAF signaling. Cancer Cell 30, 501 –503 (2016).
34. Durrant, D. E. & Morrison, D. K. Targeting the Raf kinases in human cancer: the Raf
dimer dilemma. Brit J. Cancer 118,3 –8 (2018).
35. Bigenwald, C. et al. BRAF(V600E)-induced senescence drives Langerhans cell
histiocytosis pathophysiology. Nat. Med. 27, 851 –861 (2021).
36. Milne, P. et al. Hematopoietic origin of Langerhans cell histiocytosis and Erdheim-
Chester disease in adults. Blood 130, 167 –175 (2017).
37. Chung, S. S. et al. Hematopoietic stem cell origin of BRAFV600E mutations in hairy
cell leukemia. Sci. Transl. Med. 6, 238ra71 (2014).
38. Sconocchia, T. et al. BRAF(V600E) promotes DC3/monocyte differentiation in
human gene-engineered HSPCs and causes multisystem histiocytosis. Leukemia
37, 2292 –2296 (2023).
39. Ra ﬁei, A. et al. BRAFV 600E or mutant MAP2K1 human CD34 + cells establish
Langerhans cell-like histiocytosis in immune-de ﬁcient mice. Blood Adv. 4,
4912–4917 (2020).
40. Rodriguez-Galindo, C. & Allen, C. E. Langerhans cell histiocytosis. Blood 135,
1319–1331 (2020).
41. Zhang, X. et al. Discovery of clinical candidate (5-(3-(4-Chlorophenoxy)prop-1-yn-
1-yl)-3-hydroxypicolinoyl)glycine, an orally bioavailable prolyl hydroxylase inhi-
bitor for the treatment of anemia. J. Med. Chem. 63, 10045 –
10060 (2020).
42. Ashley, R. J. et al. Steroid resistance in Diamond Blackfan anemia associates with
p57Kip2 dysregulation in erythroid progenitors. J. Clin. Invest. 130, 2097 –2110
(2020).
43. Morgado-Palacin, L. et al. Partial loss of Rpl11 in adult mice recapitulates
diamond-blackfan anemia and promotes lymphomagenesis. Cell Rep. 13,
712–722 (2015).
44. Doty, R. T. et al. Single-cell analysis of erythropoiesis in Rpl11 haploinsuf ﬁcient
mice reveals insight into the pathogenesis of Diamond-Blackfan anemia. Exp.
Hematol. 97,6 6 –78, (2021).
45. Kubasch, A. S., Fenaux, P. & Platzbecker, U. Development of luspatercept to treat
ineffective erythropoiesis. Blood Adv. 5, 1565 –1575 (2021).
46. Kapitsinou, P. P. et al. Hepatic HIF-2 regulates erythropoietic responses to hypoxia
in renal anemia. Blood 116, 3039 –3048 (2010).
47. Gibney, G. T., Messina, J. L., Fedorenko, I. V., Sondak, V. K. & Smalley, K. S. M.
Paradoxical oncogenesis-the long-term effects of BRAF inhibition in melanoma.
Nat. Rev. Clin. Oncol. 10, 390 –399, (2013).
48. Agianian, B. & Gavathiotis, E. Current insights of BRAF inhibitors in cancer. J. Med.
Chem. 61, 5775 –5793 (2018).
49. Escuin-Ordinas, H. et al. Cutaneous wound healing through paradoxical MAPK
activation by BRAF inhibitors. Nat. Commun. 7, 12348 (2016).
50. Sieber, J. et al. GDC-0879, a BRAF(V600E) inhibitor, protects kidney podocytes
from death. Cell Chem. Biol. 25, 175 –184.e4 (2018).
