...
full_text_url: "http://hdl.handle.net/1765/55866"
oa_status: green
license: other-oa
---
...
D. Schepers (Dorien),A.J. Doyle (Alexander),P. Oswald,D.L. Sparks (David),L.A. Myers (Loretha),P.J. Willems (Patrick),M.R. Mansour (Marc),M.A. Simpson (Michael A),H. Frysira (Helena),A.A. Maat-Kievit (Anneke),et al.A.S. Thornton (Andrew),A.J.M. Hoogeboom (Jeannette),G. Mortier (Geert),H. Titheradge (Hannah),L. Brueton (Louise),L. Starr (Lois),Z. Stark (Zornitza),C. Ockeloen (Charlotte),T. Lourenco (Tania),E.M. Blair (Ed),K.A. Hobson (Keith),J.A. Hurst (Jane),I. Maystadt (Isabelle),A. Destrée (Anne),K.M. Girisha (Katta M),M. Miller (Michelle),H.C. Dietz (Harry ),B.L. Loeys (Bart)andL. van Laer (Lut)
