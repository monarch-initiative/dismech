...
full_text_url: "https://www.nature.com/articles/s41380-019-0442-0.pdf"
oa_status: hybrid
license: cc-by
local_pdf_path: files/DOI_10.1038_s41380-019-0442-0.pdf
---
...
David Mataix-Cols 1 ●
Ralf Kuja-Halkola 2
Received: 4 January 2019 / Revised: 4 April 2019 / Accepted: 29 April 2019 / Published online: 3 June 2019
...
between 1997 and 2013, 11,665 received a BPD-diagnosis. We identi ﬁed relatives and estimated sex and birth year adjusted
...
with genetic relatedness. The hazard ratio was 11.5 (95% con ﬁdence interval (CI) = 1.6–83.8) for monozygotic twins; 7.4
...
ple sub-components that may be in ﬂuenced both genetic
...
These authors contributed equally: Charlotte Skoglund, Annika Tiger
...
1 Centre for Psychiatry Research, Department of Clinical
...
Stockholm, Sweden
4 Social, Genetic and Developmental Psychiatry Centre, Institute of
Psychiatry, Psychology, and Neuroscience, King ’s College,
London, UK
Supplementary information The online version of this article ( https://
doi.org/10.1038/s41380-019-0442-0) contains supplementary
material, which is available to authorized users.
1234567890();,:
1234567890();,:

ﬁrst-degree relatives, corresponding to a 3.9 times increased
...
whose biological parents could not be identi ﬁed (16,387),
were excluded. In all, our analytical sample comprised
1,851,755 individuals.
Using the MGR and the STR we identi ﬁed all pairs of
...
with each relative of the different types that were identi ﬁ-
...
Comorbidities
In addition, we identi ﬁed ICD-10 diagnoses of psychiatric
...
cumulative incidence for the full cohort, strati ﬁed per sex
...
individuals (column percent) Not BPD BPD ICD-10 codes
...
NA not applicable. All variables are statistically signi ﬁcantly different between Not BPD and BPD group
according to Pearson χ
2-tests, with p-values < 0.001
aIn Supplemental eTable 4 the included disorder codes are explained in more detail
Familial risk and heritability of diagnosed borderline personality disorder: a register study of the. . . 1001

various loci affect the phenotypic outcome independently
...
heritability (A + D), re ﬂecting the total variance due to
genetic in ﬂuences. We estimated shared family environ-
mental effects (C), i.e., environmental in ﬂuences that have
...
sample identi ﬁed equivalently as outlined above. Finally,
...
further strati ﬁcation by birth categories (Supplemental eFi-
...
Female
Male
1118155 1504075 1313047 878810 492212 87291
541524 727507 634632 424846 238099 42340
576631 776568 678415 453964 254113 44951
Fig. 1 Cumulative incidence in
full cohort and sub-cohorts of
females and males. Kaplan-
Meier estimates with 95%
conﬁdence intervals. Note:
Cohort, full cohort. Female, all
females in cohort. Male, all
males in cohort
Hazard ratio
12 5 1 0
Relative
...
1.1 (0.7−1.8)
1.9 (1.2−2.9)
Fig. 2 Familial aggregation. Hazard ratios (95% con ﬁdence interval). Note: X-axis uses logarithmic scale; plot with non-logarithmic scale can be
found in Supplemental eFigure 2
Table 2 Concordances and tetrachoric correlations (95% con ﬁdence interval)
Concordant without BPD Discordant BPD Concordant BPD Concordance rate a Tetrachoric correlation
...
Familial risk and heritability of diagnosed borderline personality disorder: a register study of the. . . 1003

1.9–3.0), a 5-fold increase compared to the baseline pro-
...
combinations of sex was statistically signi ﬁcant. For birth
...
vious studies demonstrating the heritability of dimensional
Table 3 Quantitative genetic analysis. Fitted sub-models compared to full ADCE model
Model comparison measures Explained variance, percent (95% con ﬁdence interval)
Models No.
parameters
...
Total genetic (broad
sense heritability)
ADCE 9 −2,564,587.58 104,710.42 NA NA 29 (0 –52) 18 (0 –59) 4 (0 –16) 49 (27 –69) 47 (18 –73)
ACE 8 −2,564,588.84 104,711.16 0.74 0.388 39 (16 –53) NA 3 (0 –14) 57 (47 –71) 39 (16 –53)
ADE 8 −2,564,589.02 104,710.98 0.56 0.454 40 (19 –53) 14 (0 –52) NA 47 (25 –61) 53 (39 –75)
DCE 8 −2,564,586.96 104,713.04 2.62 0.106 NA 44 (15 –69) 12 (6 –18) 44 (24 –67) 44 (15 –69)
AE 7 −2,564,590.49 104,711.51 1.09 0.581 46 (39 –53) NA NA 54 (47 –61) 46 (39 –53)
CE 7 −2,564,580.14 104,721.86 11.45 0.003 NA NA 21 (17 –24) 79 (76 –83) NA
DE 7 −2,564,574.55 104,727.45 17.03 < 0.001 NA 80 (68 –89) NA 20 (11 –32) 80 (68 –89)
E6 −2,564,463.52 104,840.48 130.06 < 0.001 NA NA NA 100 (NA) NA
No. parameters number of estimated parameters in model, NA not applicable. Analysis based on sub-sample presented in Table 2
aLower value indicates better ﬁt
bDifference in −2 log likelihood, and p-value for likelihood ratio test thereof, between model and ADCE model
1004 C. Skoglund et al.

BPD-traits in general population twin samples. The best
...
that genetic factors play a signi ﬁcant role in the risk of
...
individuals, as re ﬂected in the narrow con ﬁdence intervals
...
this is due to genetic, and not environmental, in ﬂuences.
...
polymorphism (genetic variant) have been identi ﬁed that
reach genome-wide signi ﬁcance [ 53, 54], future molecular
genetic studies may, given suf ﬁcient sample sizes, identify
...
environment did not in ﬂuence the statistical goodness of ﬁt,
...
Further, these environmental associations could also re ﬂect
gene-environment correlations, additionally complicating
the identi ﬁcation of speci ﬁc environmental risks. The
...
ventable or modi ﬁable via early interventions.
...
partly re ﬂect non-speci ﬁc genetic effects that acts across
mental health disorders. Here we did not adjust our analyses
for any comorbid conditions since adjustment would most
likely in ﬂuence our results in a non-interpretable way.
...
underlying de ﬁcits are largely genetically predetermined.
Such regulatory processes are thought to involve widely
distributed large-scale neural networks, including speci ﬁc
prefrontal and anterior ci ngulate regions, networks
...
tinuous trait [ 61], although no study speci ﬁcally addressing
...
rating questionnaires [ 16, 19, 21–28, 30]r a t h e rt h a n
...
cases would be identi ﬁed if everyone in the cohort was
...
remained stable in women, but we did not have suf ﬁcient
power to perform the quantitative genetic analysis in men;
Familial risk and heritability of diagnosed borderline personality disorder: a register study of the. . . 1005

thus, generalization of our ﬁndings to men with BPD should
be made with caution. Third, the BPD-diagnosis is based on
fulﬁlling at least ﬁve out of nine symptom criteria leading to
clinically signi ﬁcant distress or functional impairment in
important life areas, and thus a substantial heterogeneity of
symptom pro ﬁles exists. Although heterogeneity may
hamper speci ﬁcity of the diagnosis, our previous medical
chart validation study demonstrated the correspondence of
the register-based diagnoses with the DSM-IV criteria [ 45].
Further, identi ﬁed individuals with a diagnosis of BPD in
...
valence decreases signi ﬁcantly towards the age of 24 [ 19].
...
lihood of being identi ﬁed as carrying a diagnosis in the
current study.
In conclusion, BPD aggregates in families and the
heritability was estimated at 46%, with the remaining
variance explained by non-sha red environmental factors.
This ﬁnding is important for further expanding our
understanding of BPD. The time is ripe for identi ﬁcation
of genetic variants associated with BPD through large
scale genome-wide studies, for identi ﬁcation of environ-
mental risk factors, and of how these correlate or interact
to increase the risk of BPD.
Acknowledgements We acknowledge the Swedish Twin Registry
for access to data. The Swedish Twin Registry is managed by Kar-
olinska Institutet and receives funding through the Swedish Research
Council under the grant no 2017 –00641.
Funding Dr Tiger was supported by Psykiatri Nordväst, SLL
(Stockholm County Council). Dr Petrovic was supported by grants
provided by the Stockholm County Council (PPG) and Karolinska
Institutet.
...
org/licenses/by/4.0/.
References
1. Petrovic P, Castellanos FX. Top-down dysregulation-from ADHD
to emotional instability. Front Behav Neurosci. 2016;10:70.
2. Sebastian A, Jung P, Krause-Utz A, Lieb K, Schmahl C, Tuscher
O. Frontal dysfunctions of impulse control — a systematic review
in borderline personality disorder and attention-de ﬁcit/hyper-
activity disorder. Front Hum Neurosci. 2014;8:698.
3. Leichsenring F, Leibing E, Kruse J, New AS, Leweke F. Bor-
derline personality disorder. Lancet. 2011;377:74 –84.
4. Grant BF, Chou SP, Goldstein RB, Huang B, Stinson FS, Saha
TD, et al. Prevalence, correlates, disability, and comorbidity of
DSM-IV borderline personality disorder: results from the Wave 2
National Epidemiologic Survey on Alcohol and Related Condi-
tions. J Clin Psychiatry. 2008;69:533 –45.
5. Lenzenweger MF, Lane MC, Loranger AW, Kessler RC. DSM-IV
personality disorders in the National Comorbidity Survey Repli-
cation. Biol Psychiatry. 2007;62:553 –64.
6. Torgersen S. The nature (and nurture) of personality disorders.
Scand J Psychol. 2009;50:624 –32.
7. Loranger AW, Oldham JM, Tulis EH. Familial transmission of
DSM-III borderline personality disorder. Arch Gen Psychiatry.
1982;39:795–9.
8. Bandelow B, Krause J, Wedekind D, Broocks A, Hajak G,
Ruther E. Early traumatic life events, parental attitudes,
family history, and birth risk factors in patients with borderline
personality disorder and healthy controls. Psychiatry Res.
2005;134:169–79.
9. Baron M, Gruen R, Asnis L, Lord S. Familial transmission of
schizotypal and borderline personality disorders. Am J Psychiatry.
1985;142:927–34.
10. Johnson BA, Brent DA, Connolly J, Bridge J, Matta J, Constantine
D, et al. Familial aggregation of adolescent personality disorders. J
Am Acad Child Adolesc Psychiatry. 1995;34:798–804.
11. Zanarini MC, Frankenburg FR, Yong L, Raviola G, Bradford
Reich D, Hennen J, et al. Borderline psychopathology in the ﬁrst-
degree relatives of borderline and axis II comparison probands. J
Pers Disord. 2004;18:439 –47.
1006 C. Skoglund et al.

12. Gunderson JG, Zanarini MC, Choi-Kain LW, Mitchell KS, Jang
KL, Hudson JI. Family study of borderline personality disorder
and its sectors of psychopathology. Arch Gen Psychiatry.
2011;68:753–62.
13. Zanarini MC, Gunderson JG, Marino MF, Schwartz EO, Fran-
kenburg FR. DSM-III Disorders in the families of Borderline
outpatients. J Pers Disord. 1988;2:292 –302.
14. Links P, Steiner M, Huxley G. The occurrence of borderline
personality disorder in the families of borderline patients. J Pers
Disord. 1988;2:14 –20.
15. Pope HG Jr., Jonas JM, Hudson JI, Cohen BM, Gunderson JG.
The validity of DSM –III Borderline Personality Disorder. A
phenomenologic, family history, treatment response, and long-
term follow-up study. Arch Gen Psychiatry. 1983;40:23 –30.
16. Reich JH. Familiality of DSM-III dramatic and anxious person-
ality clusters. J Nerv Ment Dis. 1989;177:96 –100.
17. Gunderson JG, Herpertz SC, Skodol AE, Torgersen S, Zanarini
MC. Borderline personality disorder. Nat Rev Dis Primers.
2018;4:18029.
18. Boomsma D, Busjahn A, Peltonen L. Classical twin studies and
beyond. Nat Rev Genet. 2002;3:872 –82.
19. Bornovalova MA, Hicks BM, Iacono WG, McGue M. Stability,
change, and heritability of borderline personality disorder traits
from adolescence to adulthood: a longitudinal twin study. Dev
Psychopathol. 2009;21:1335 –53.
20. Czajkowski N, Aggen SH, Krueger RF, Kendler KS, Neale MC,
Knudsen GP, et al. A twin study of normative personality and
DSM-IV personality disorder criterion counts: evidence for
separate genetic in ﬂuences. Am J Psychiatry. 2018;175:649 –56.
21. Distel MA, Carlier A, Middeldorp CM, Derom CA, Lubke GH,
Boomsma DI. Borderline personality traits and adult attention-
deﬁcit hyperactivity disorder symptoms: a genetic analysis of
comorbidity. Am J Med Genet B Neuropsychiatr Genet.
2011;156B:817–25.
22. Distel MA, Hottenga JJ, Trull TJ, Boomsma DI. Chromosome 9:
linkage for borderline personality disorder features. Psychiatr
Genet. 2008;18:302 –7.
23. Distel MA, Middeldorp CM, Trull TJ, Derom CA, Willemsen G,
Boomsma DI. Life events and borderline personality features: the
inﬂuence of gene-environment interaction and gene-environment
correlation. Psychol Med. 2011;41:849 –60.
24. Distel MA, Rebollo-Mesa I, Willemsen G, Derom CA, Trull TJ,
Martin NG, et al. Familial resemblance of borderline personality
disorder features: genetic or cultural transmission? PLoS ONE.
2009;4:e5334.
25. Distel MA, Roeling MP, Tielbeek JJ, van Toor D, Derom CA,
Trull TJ, et al. The covariation of trait anger and borderline per-
sonality: a bivariate twin-siblings study. J Abnorm Psychol.
2012;121:458–66.
26. Distel MA, Trull TJ, de Moor MM, Vink JM, Geels LM, van Beek
JH, et al. Borderline personality traits and substance use: genetic
factors underlie the association with smoking and ever use of
cannabis, but not with high alcohol consumption. J Pers Disord.
2012;26:867–79.
27. Distel MA, Trull TJ, Derom CA, Thiery EW, Grimmer MA, Martin
NG, et al. Heritability of borderline personality disorder features is
similar across three countries. Psychol Med. 2008;38:1219 –29.
28. Distel MA, Willemsen G, Ligthart L, Derom CA, Martin NG,
Neale MC, et al. Genetic covariance structure of the four main
features of borderline personality disorder. J Pers Disord.
2010;24:427–44.
29. Kendler KS, Aggen SH, Czajkowski N, Roysamb E, Tambs K,
Torgersen S, et al. The structure of genetic and environmental risk
factors for DSM-IV personality disorders: a multivariate twin
study. Arch Gen Psychiatry. 2008;65:1438 –46.
30. Kendler KS, Myers J, Reichborn-Kjennerud T. Borderline per-
sonality disorder traits and their relationship with dimensions of
normative personality: a web-based cohort and twin study. Acta
Psychiatr Scand. 2011;123:349 –59.
31. Reichborn-Kjennerud T, Czajkowski N, Roysamb E, Orstavik RE,
Neale MC, Torgersen S, et al. Major depression and dimensional
representations of DSM-IV personality disorders: a population-
based twin study. Psychol Med. 2010;40:1475 –84.
32. Reichborn-Kjennerud T, Czajkowski N, Ystrom E, Orstavik R,
Aggen SH, Tambs K, et al. A longitudinal twin study of border-
line and antisocial personality disorder traits in early to middle
adulthood. Psychol Med. 2015;45:3121 –31.
33. Reichborn-Kjennerud T, Ystrom E, Neale MC, Aggen SH, Maz-
zeo SE, Knudsen GP, et al. Structure of genetic and environmental
risk factors for symptoms of DSM-IV borderline personality dis-
order. JAMA. Psychiatry. 2013;70:1206 –14.
34. Torgersen S. Genetic and nosological aspects of schizotypal and
borderline personality disorders. A twin study. Arch Gen Psy-
chiatry. 1984;41:546 –54.
35. Torgersen S, Czajkowski N, Jacobson K, Reichborn-Kjennerud T,
Roysamb E, Neale MC, et al. Dimensional representations of
DSM-IV cluster B personality disorders in a population-based
sample of Norwegian twins: a multivariate study. Psychol Med.
2008;38:1617–25.
36. Torgersen S, Lygren S, Oien PA, Skre I, Onstad S, Edvardsen J,
et al. A twin study of personality disorders. Compr Psychiatry.
2000;41:416–25.
37. Torgersen S, Myers J, Reichborn-Kjennerud T, Roysamb E,
Kubarych TS, Kendler KS. The heritability of Cluster B person-
ality disorders assessed both by personal interview and ques-
tionnaire. J Pers Disord. 2012;26:848 –66.
38. Ludvigsson JF, Andersson E, Ekbom A, Feychting M, Kim
JL, Reuterwall C, et al. External review and validation of the
Swedish national inpatient register. BMC Public Health.
2011;11:450.
39. Ekbom A. The Swedish Multi-generation Register. Methods Mol
Biol. 2011;675:215 –20.
40. Magnusson PK, Almqvist C, Rahman I, Ganna A, Viktorin A,
Walum H, et al. The Swedish Twin Registry: establishment of a
biobank and other recent developments. Twin Res Hum Genet.
2013;16:317–29.
41. Ludvigsson JF, Almqvist C, Bonamy AK, Ljung R, Michaelsson
K, Neovius M, et al. Registers of the Swedish total population
and their use in medical research. Eur J Epidemiol.
2016;31:125–36.
42. National Board of Health and Welfare. Dödsorsaksregistret. The
Swedish cause of death register. http://www.socialstyrelsen.se/
register/dodsorsaksregistret. 2015. Accessed 4 Feb 2019.
43. Axelsson O. The Swedish medical birth register. Acta Obstet
Gynecol Scand. 2003;82:491 –2.
44. National Board of Health and Welfare. Psychiatric codes.
http://www.socialstyrelsen.se/klassiﬁceringochkoder/dia
gnoskodericd-10/psykiatrikoder. Accessed 6 Dec 2018.
45. Kuja-Halkola R, Lind Juto K, Skoglund C, Ruck C, Mataix-Cols
D, Perez-Vigil A et al. Do borderline personality disorder and
attention-deﬁcit/hyperactivity disorder co-aggregate in families? A
population-based study of 2 million Swedes. Mol Psychiatry.
2018. Epub ahead of print.
46. Sandin S, Lichtenstein P, Kuja-Halkola R, Larsson H, Hultman
CM, Reichenberg A. The familial risk of autism. J Am Med
Assoc. 2014;311:1770 –7.
47. Chen Q, Brikell I, Lichtenstein P, Serlachius E, Kuja-Halkola R,
Sandin S, et al. Familial aggregation of attention-de ﬁcit/hyper-
activity disorder. J Child Psychol Psychiatry. 2017;
58:231–9.
Familial risk and heritability of diagnosed borderline personality disorder: a register study of the. . . 1007

48. Neale M, Maes HH. Methodology for genetic studies of twins
and families. http://ibgwww.colorado.edu/workshop2006/cdrom/
HTML/book2004a.pdf. Accessed 7 Mar 2019.
49. Therneau T. A Package for Survival Analysis in S_. version 2.38.
2015.
50. Zetterqvist J, Sjölander A. Doubly robust estimation with the R
package drgee. Epidemiologic Methods. 2015;4:69 –86.
51. Fox J. Polychoric and Polyserial Correlations. R package 0.7-9.
edn. 2016.
52. Neale MC, Hunter MD, Pritikin JN, Zahery M, R. BT, Kirkpatrick
RM, et al. OpenMx 2.0: Extended structural equation and statis-
tical modeling. Psychometrika. 2016;81:535 –49.
53. Witt SH, Streit F, Jungkunz M, Frank J, Awasthi S, Reinbold CS,
et al. Genome-wide association study of borderline personality
disorder reveals genetic overlap with bipolar disorder, major
depression and schizophrenia. Transl Psychiatry. 2017;7:e1155.
54. Lubke GH, Laurin C, Amin N, Hottenga JJ, Willemsen G, van
Grootheest G, et al. Genome-wide analyses of borderline per-
sonality features. Mol Psychiatry. 2014;19:923 –9.
55. Paris J. Does childhood trauma cause personality disorders in
adults? Can J Psychiatry. 1998;43:148 –53.
56. Zanarini MC, Williams AA, Lewis RE, Reich RB, Vera SC,
Marino MF, et al. Reported pathological childhood experiences
associated with the development of borderline personality dis-
order. Am J Psychiatry. 1997;154:1101 –6.
57. Jovev M, Jackson HJ. The relationship of borderline personality
disorder, life events and functioning in an Australian psychiatric
sample. J Pers Disord. 2006;20:205 –17.
58. Horesh N, Ratner S, Laor N, Toren P. A comparison of life events
in adolescents with major depression, borderline personality
disorder and matched controls: a pilot study. Psychopathology.
2008;41:300–6.
59. Amad A, Ramoz N, Thomas P, J ardri R, Gorwood P. Genetics
of borderline personality disorder: systematic review and pro-
posal of an integrative model. Neurosci Biobehav Rev.
2014;40:6 –19.
60. Pettersson E, Larsson H, Lichtenstein P. Common psychiatric
disorders share the same genetic origin: a multivariate
sibling study of the Swedish population. Mol Psychiatry.
2016;21:717–21.
61. Taylor MJ, Martin J, Lu Y, Brikell I, Lundstrom S, Larsson H
et al. Association of genetic risk factors for psychiatric disorders
and traits of these disorders in a Swedish population twin sample.
JAMA Psychiatry. 2019;76:280 –9.
62. Bach B, Sellbom M. Continuity between DSM-5 categorical cri-
teria and traits criteria for borderline personality disorder. Can J
Psychiatry. 2016;61:489 –94.
63. Evans CM, Simms LJ. Assessing inter-model continuity
between the Section II and Section III conceptualizations of
borderline personality disorde r in DSM-5. Personal Disord.
2018;9:290 –6.
64. Oltmanns TF, Balsis S. Personality disorders in later life: ques-
tions about the measurement, course, and impact of disorders.
Annu Rev Clin Psychol. 2011;7:321 –49.
65. Fossati A, Madeddu F, Maffei C. Borderline personality disorder
and childhood sexual abuse: a meta-analytic study. J Pers Disord.
1999;13:268–80.
66. New AS, Triebwasser J, Charney DS. The case for shifting bor-
derline personality disorder to Axis I. Biol Psychiatry.
2008;64:653–9.
1008 C. Skoglund et al.