...
full_text_url: "https://public-pages-files-2025.frontiersin.org/journals/oncology/articles/10.3389/fonc.2024.1328728/pdf"
oa_status: gold
license: cc-by
local_pdf_path: files/DOI_10.3389_fonc.2024.1328728.pdf
---

# Mechanisms of resistance to KRASG12C inhibitors in KRASG12C-mutated non-small cell lung cancer
**Authors:** Ali Chour, Anne-Claire Toffart, Elodie Berton, Michael Duruisseaux
**Journal:** Frontiers in Oncology (2024)
**DOI:** [10.3389/fonc.2024.1328728](https://doi.org/10.3389/fonc.2024.1328728)
...
frequent. In this review, after brie ﬂy summarizing the KRAS pathway and the
...
KEYWORDS
non-small cell lung cancer, KRASG12C mut ation, KRASG12C inhibitor resistance,
...
doi: 10.3389/fonc.2024.1328728
COPYRIGHT
©2 0 2 4C h o u r ,T o f f a r t ,B e r t o na n d
...
autophosphorylation of their receptors (GFRs). Speci ﬁc tyrosine
...
Those GAPs (such as RASA1, neuro ﬁbromin, or DAB2IP) aid,
...
(KRAS
G12C, KRASG12V, KRASG12D… ) and 11% involve a glycine on
...
hydrophobic pockets and its picomolar af ﬁnity for GTP/GDP,
...
GTP (10) thereby inhibiting RAS-effector interaction in KRAS
G12C
mutant cells. Despite the KRAS G12C mutation inducing the
...
ad e c r e a s ei ns a m p l es i z ea f t e rp rotocol amendment and a 26% cross-
over rate in the docetaxel group.
Adagrasib is another OFF-state KRASG12C inhibitor with results
from the recently publishedphase I/II KRYSTAL-1 study (13)s h o w i n g
promising outcomes with adagrasibin the same second-line setting as
...
clinicaltrials.gov). A summary of the main ef ﬁcacy results in the
second-line setting is described inTable 1.
...
preclinical and clinical datasets sug g e s tt h a tr e s i s t a n c em e c h a n i s m st o
...
This review aims to descri be and examine emerging
...
primary resistance
Genomic alterations were correlated with long-term bene ﬁt
...
the CodeBreaK100 study dataset ( 14). The most signi ﬁcant
...
codon to another mutant variant on the same allele ( cis)o ra
secondary KRAS mutation on the trans-KRAS allele. CfDNA
analysis of a 67-year-old patient with KRASG12C-mutant NSCLC
after progression on adagrasib showed a new (trans) KRAS G12V
mutation ( 11), coexisting with the (cis) KRAS G12C mutation and
...
and DNA repair, has been shown to fac ilitate effector activation by
stabilizing the interaction between newly formed KRASG12C protein
and RAF, thus aiding cell cycle progression inin vitro models (19).
...
already been described with MEK inhibitors ( 20)a n dB R A F
inhibitors ( 21).
FIGURE 1
...
acids, X: any amino acid and residues coding for a lipid tail; not shown here). Selected structural regions of the KRAS protein G-domain are highlighte d:
...
behind Switch II region, near mutated Cysteine-12). The mutated Cystein-12 residue is shown in yellow. Adagrasib interacts with the P2 binding pocke ti n
...
- Ampli ﬁcations or mutations of upstream RTK genes (such
as EGFR).
...
ALK), or ampli ﬁcation (e.g., MET). An important limitation of this
...
resistance mechanism). The MET ampli ﬁcation was found in vitro
...
KRASG12C inhibitors
A large majority of patients have no identi ﬁable genetic
...
inhibition in KRAS
G12C-mutant cell lines ( 19). RTKs such as
...
TABLE 1 Ef ﬁcacy data from Phase II/III trials involving KRASG12C inhibitors sotorasib and adagrasib in pretreated advanced non-small cell lung cancer.
KRASG12C
Inhibitor
Study Phase Control Number of patients Objective Response a
-% ,
(95% CI)
Median duration of
responseb,m o
...
Median OS, mo
(95% IC)
Control KRASG12Ci Control KRASG12Ci Control KRASG12Ci Control KRASG12Ci Control KRASG12Ci
Sotorasib CodeBreak
100
II15 126 37.1
(28.6-46.2)
...
10.6
(8.9-14.0)
Adagrasib Krystal-1 II 14 116 42.9
(33.5-52.6)
8.5
(6.2-13.8)
6.5
...
12.6
(9.2-19.2)
aObjective response was de ﬁned as a complete or partial response.
bDuration of response was evaluated based on patients with a complete or partial response. KRASG12Ci, KRASG12C inhibitor; CI, con ﬁdence interval; mo, months; NE, not evaluated.
Chour et al. 10.3389/fonc.2024.1328728
...
Two KRAS G12C mutant lung adenocarcinomas treated with
...
induced squamous transition in KRAS G12D -mutant lung
adenocarcinoma cell lines. In a p reclinical study, adagrasib-
...
include ampli ﬁcation or mutations of other oncogenes, upstream reactivation of wild-type KRAS and other RAS isoforms, epithelial-to-mesenchymal
...
can be induced by numerous biological drivers such as TGF b, TNF-
a,H I F -a, Wnt signaling, interleukins, Hedgehog, and Hippo
pathways ( 32). Genes related to EMT were enriched in sotorasib-
resistant NSCLC cell lines ( 33). Induction of EMT via chronic
TGFb treatment was suf ﬁcient to induce resistance to sotorasib. In
...
vitro models, with promising ef ﬁcacy for CDK4 inhibitors in
...
SMARCA4 ,a n d CDKN2A )d e ﬁne different subgroups of
...
state KRASG12C inhibitors, should be integrated as strati ﬁcation
factors in clinical trials, and may guide escalated or de-escalated
treatment strategies. The key role of co-mutations in de ﬁning
...
across RAS-addicted tumor mod els and showed early clinical
activity (36, 37).
...
supporting KRASG12C inhibitors and immunotherapy, speci ﬁcally
...
strategies in KRAS G12C-mutant NSCLC. ctDNA sample analysis
can be a highly valuable tool for identifying early signals of ef ﬁcacy
...
and non- ﬁnancial support from P ﬁzer, personal fees and non-
...
GSK, Sano ﬁ, MSD, AstraZeneca, Abbvie, Takeda, Boehringer
Ingelheim, Merus, Amgen, Guardant, P ﬁzer; consulting fees from
Roche, BMS, MSD, AstraZeneca, AbbVie, Takeda, Boehringer
Ingelheim, Gamamabs Pharma, P ﬁzer; research grants from
...
downstream targets. Biochim Biophys Acta . (2007) 1773:1177 –9 5 .d o i :1 0 . 1 0 1 6 /
...
8 . C o xA D ,D e rC J .R a sh i s t o r y .Small GTPases. (2010) 1:2–27. doi: 10.4161/sgtp.1.1.12178
...
11. Reita D, Pabst L, Pencreach E, Gue ́rin E, Dano L, Rimelen V, et al. Direct
...
1 2 . d eL a n g e nA J ,J o h n s o nM L ,M a z i e r e sJ ,D i n g e m a n sA M C ,M o u n t z i o sG ,P l e s sM ,e ta l .
...
W i l d - t y p eK R A Sa l l e l ee f f e c t so nd r u g g a b l et a r g e t si nK R A Sm u t a n tl u n g
...
Ampli ﬁcation of the driving oncogene, KRAS or BRAF, underpins acquired
...
23. Mainardi S, Mulero-Sa ́nchez A, Prahallad A, Germano G, Bosma A,
Krimpenfort P, et al. SHP2 is required for growth of KRAS-mutant non-small-cell
lung cancer in vivo.
Nat Med . (2018) 24:961 –7. doi: 10.1038/s41591-018-0023-9
...
adenocarcinoma in mice with Lkb1 de ﬁciency to squamous cell carcinoma. Nat
...
inhibition on tumor immunity. Cancer Cell . (2024) 42:338 –5 7 .d o i :1 0 . 1 0 1 6 /
j.ccell.2024.02.012
36. Jiang J, Jiang L, Maldonato BJ, Wang Y, Holder ﬁeld M, Aronchik I, et al.
...
OA03.06 codeBreaK 100/101: ﬁrst report of safety/ef ﬁcacy of sotorasib in combination
...
Preliminary safety and ef ﬁcacy of adagrasib with pembrolizumab in treatment-naïve
patients with advanced non-small cell l ung cancer (NSCLC) harboring a KRASG12C
...
49. Mok TSK, Yao W, Duruisseaux M, Doucet L, Azka ́rate Martı́nez A, Gregorc V,
