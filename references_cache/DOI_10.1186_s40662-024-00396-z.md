...
Schematic workflow of DeepDrARN. a Data acquisition from two ophthalmic centers in China. b and c Schematic diagram and workflow of DeepDrARN for uveitis screening and ARN identification. d Multi-perspective evaluation and analysis. UWFCFPs, ultra-widefield color fundus photographs; ARN, acute retinal necrosis; NAU, non-ARN uveitis; SEN, sensitivity; SPE, specificity; PRE, precision; REC, recall
...
Wang, Y., Yang, Z., Guo, X. et al. Automated early detection of acute retinal necrosis from ultra-widefield color fundus photography using deep learning.
                    Eye and Vis 11, 27 (2024). https://doi.org/10.1186/s40662-024-00396-z
