...
full_text_url: "https://www.frontiersin.org/journals/cell-and-developmental-biology/articles/10.3389/fcell.2024.1442488/pdf"
oa_status: gold
license: cc-by
local_pdf_path: files/DOI_10.3389_fcell.2024.1442488.pdf
---

# Desmoplastic small round cell tumor: from genomics to targets, potential paths to future therapeutics
**Authors:** Justin W. Magrath, Madelyn Espinosa-Cotton, Dane A. Flinchum, Shruthi Sanjitha Sampath, Nai Kong Cheung, Sean B. Lee
**Journal:** Frontiers in Cell and Developmental Biology (2024)
**DOI:** [10.3389/fcell.2024.1442488](https://doi.org/10.3389/fcell.2024.1442488)
...
Desmoplastic small round cell
tumor: from genomics to targets,
potential paths to future
therapeutics
Justin W. Magrath 1*, Madelyn Espinosa-Cotton 2,
Dane A. Flinchum 1, Shruthi Sanjitha Sampath 1, Nai Kong Cheung 2
and Sean B. Lee 1*
1Department of Pathology and Laboratory Medicine, Tulane University School of Medicine, New Orleans,
LA, United States, 2Department of Pediatrics, Memorial Sloan Kettering Cancer Center, New York, NY,
United States
Desmoplastic Small Round Cell Tumor (DSRCT) is a highly aggressive pediatric
...
DSRCT biology and the identi ﬁcation of potentially promising targeted
...
KEYWORDS
DSRCT, pediatric cancer, sarcoma, fusion oncogene, targeted therapy
1 Background
...
histologic appearance which includes nests of small round cells imbedded in ﬁbrous
OPEN ACCESS
EDITED BY
Ren Xu,
...
CITATION
Magrath JW, Espinosa-Cotton M, Flinchum DA,
Sampath SS, Cheung NK and Lee SB (2024),
Desmoplastic small round cell tumor: from
genomics to targets, potential paths to
future therapeutics.
Front. Cell Dev. Biol. 12:1442488.
doi: 10.3389/fcell.2024.1442488
COPYRIGHT
© 2024 Magrath, Espinosa-Cotton, Flinchum,
Sampath, Cheung and Lee. This is an open-
...
stroma. The cell of origin is unknown and DSRCT cells stain positive
...
2018; Gedminas et al., 2022a ). Nishio et al. established the ﬁrst
...
light of these ﬁndings, RNA sequencing (RNA-seq) may be more
...
(abbreviated: KTS) between zinc ﬁngers 3 and 4 of WT1 ( Kim et al.,
...
in JN-DSRCT-1 as well as isoform speci ﬁc binding in the MeT-5A
...
and characterizing the landscape of histone modi ﬁcations
(Lamhamedi-Cherradi et al., 2022 ). Together, these datasets have
not only led to many novel ﬁndings but also provide a critical tool kit
for future research.
...
ﬁnal three zinc ﬁngers at the C-terminus of WT1. The
...
in ﬁve independent studies (Kang et al., 2014; Gedminas et al., 2020;
Bleijs et al., 2021 ; Hartono et al., 2022 ; Magrath et al., 2024a ) across
ﬁve DSRCT cell lines and more recently in vivo using doxycycline-
...
223 downregulated genes identi ﬁed across 2 cell lines by Gedminas
et al., 2020 and a set of 175 upregulated and 166 downregulated
genes identiﬁed across 4 cell lines in our lab ( Magrath et al., 2024a ).
...
proﬁle of EWSR1::WT1 in DSRCT differs signi ﬁcantly from
WT1 in leukemia cells ( Magrath et al., 2024a ). This could be due
to differences in cell type/epigenetic state or binding speci ﬁcity and
...
of three amino acids between zinc ﬁngers 3 and 4 of the WT1 DNA
binding domain. These isoform variants also occur in native WT1,
where the difference in distance between zinc ﬁngers 3 and 4 leads to
Frontiers in Cell and Developmental Biology frontiersin.org02
Magrath et al. 10.3389/fcell.2024.1442488

differences in DNA binding and transcription ( Potluri et al., 2021 ).
...
These ﬁndings have been validated and expanded in human cell lines
...
to tumor formation in NIH3T3 mouse ﬁbroblast cells ( Kim et al.,
1998). In contrast, Bandopadhayay et al., 2013 . found that neither
isoform was able to transform p53 wildtype murine embryonic
ﬁbroblasts, while either isoform led to increased colony formation in
p53 mutant murine embryonic ﬁbroblasts. This suggests
...
own hands, we ﬁnd that transduction of normal human mesothelial
cell line LP9 with one or both isoforms is insuf ﬁcient to induce
...
temozolomide signi ﬁcantly reduced
...
immunotherapy directed toward highly expressed surface proteins.
Tables 1 , 2 summarize the candidate targets identi ﬁed and
...
targets. While most therapeutic targets have been identi ﬁed due
to their role as downstream targets of EWSR1::WT1, a few
therapeutic targets are not regulated by EWSR1::WT1 and were
instead identiﬁed due to their high expression in DSRCT tumors. In
...
the most promising ﬁndings to date and their potential for clinical
translation.
...
been identiﬁed in fusion oncoproteins such as ETV6::NTRK3 which
drives secretory breast cancer and infantile ﬁbrosarcoma ( Cocco
et al., 2018 ). Ogura et al. identi ﬁed NTRK3 as 1 of 1501 human
...
ERBB2/HER2 No Traztuzumab* Bispeci ﬁc antibody treatment led to tumor
regression in 2 cell line derived orthotopic
xenograft models
Espinosa-Cotton et al. (2023)
EGFR No Cetuximab* Bispeci ﬁc antibody treatment did not reduce
tumor growth in 1 cell line derived
orthotopic xenograft model
Espinosa-Cotton et al. (2023)
Mesothelin No MORAb-009 Bispeci ﬁc antibody treatment did not reduce
tumor growth in 1 cell line derived
orthotopic xenograft model
Espinosa-Cotton et al. (2023)
EWSR1::
...
lines ( Ogura et al., 2021 ). Transcriptomic analysis of EWSR1::
...
conﬁrmed genetically via depletion with two independent
shRNAs which led to reduced cell viability in both DSRCT cell
lines. Examination of entrectinib ef ﬁcacy in three patient-derived
...
included in an ongoing clinical trial testing the ef ﬁcacy of the
...
SIK1 was identi ﬁed as a potential target due to its high
...
from JN- and BER-DSRCT-shSIK1 cells was signi ﬁcantly reduced
with SIK1 depletion. These ﬁndings suggest SIK1 as a promising
DSRCT therapeutic target. However, no speci ﬁc SIK1 small
...
JN-DSRCT-1 may be explained by the lack of speci ﬁcity of this
inhibitor and suggest the development of a SIK1 speci ﬁc inhibitor as
an urgent priority to help translate these preclinical ﬁndings to
DSRCT patients.
4.1.3 BLK
...
suggesting BLK-speci ﬁc inhibitors may have few on-target off-
tumor effects ( Texido et al., 2000 ). We identi ﬁed BLK as a kinase
...
growth of JN-DSRCT-1 xenografts. Together, these ﬁndings suggest
...
demonstrated preclinical ef ﬁcacy in Ewing sarcoma ( Kennedy
et al., 2015 ) and neuroblastoma ( Rader et al., 2013 ). We
identiﬁed CDK4/6 inhibitors as a promising therapeutic for
...
phosphorylation and signi ﬁcantly decreased tumor growth in
...
2021a; Wu C.-C. et al., 2022 ) have not identi ﬁed frequent RB
...
(Sigismund et al., 2018 ; Talukdar et al., 2020 ; Uribe et al., 2021 ).
EGFR was identiﬁed in DSRCT by Smith et al. due to the enrichment
...
a 49-day treatment (Smith et al., 2022). While likely insufﬁcient as a
...
et al. found that several ligands of the ERBB system were upregulated
...
identiﬁed AR positivity in immunohistochemistry samples from
10 of 27 DSRCT patients and discovered that ﬂutamide treatment
reduced DSRCT growth in vitro . Translating these ﬁndings to the
...
Lamhamedi-Cherradi et al., 2022 expanded on these ﬁndings and
...
lines respond to high dose treatment with enzalutamide, ﬂutamide,
and darolutamide ( Magrath et al., 2024c ). Using
immunoprecipitation, we identi ﬁed an interaction between AR
and EWSR1::WT1 which may explain some of their shared
binding locations in the genome. However, despite these ﬁndings
...
viability and that enzalutamide and ﬂutamide cytotoxicity remained
after AR depletion (Magrath et al., 2024c). These ﬁndings suggest the
...
which could explain its ef ﬁcacy. Further research is necessary to
...
prostate cancer, better elucidation of their ef ﬁcacy and
...
EWSR1 and WT1 (Lamhamedi-Cherradi et al., 2022; Magrath et al.,
...
can improve lethality. In DSRCT, PARP was identiﬁed as a potential
...
olaparib reduced the viability of JN-DSRCT-1 cells with an IC
50 of
1.38 µM 72. Intriguingly, the combination of olaparib with
temozolomide induced synergistic reductions in viability and
increased apoptosis. In a JN-DSRCT-1 xenograft model, neither
olaparib nor temozolomide monotherapy signi ﬁcantly reduced
tumor growth. However, in combination, a signi ﬁcant growth
...
4.1.8 Unknown target of trabectedin/lurbinectedin
...
efﬁcacy in the treatment of liposarcoma, leiomyosarcoma, and
...
Trabectedin was ﬁrst investigated preclinically in DSRCT by
Uboldi et al. who showed that JN-DSRCT-1 cells are sensitive to
trabectedin with an IC
50 around 4.5 nM 80. Using Chromatin
Immunoprecipitation assays, they found that trabectedin
treatment signi ﬁcantly reduced EWSR1::WT1 binding to the
promoter of three genes highly expressed in DSRCT ( Uboldi
et al., 2017 ). Gedminas et al. extended these ﬁndings to
lurbinectedin, ﬁnding that exposing DSRCT cells to lurbinectedin
...
WT1 protein expression. In vivo , lurbinectedin led to signi ﬁcant
...
involved in the DNA damage response, speci ﬁcally homologous
...
38 pediatric sarcoma CDX and PDX models treated with prexasertib
...
cell-engaging bispeci ﬁc antibodies [T-BsAbs]), radionuclides
(radioimmunotherapy [RIT]), and chemotherapeutic drugs
(antibody-drug conjugates [ADC]) with speci ﬁcity for tumors by
...
genetically engineered ex vivo to express receptors speci ﬁc for these
...
within a tumor comprised of chaotic vasculature and a stiff, ﬁbrotic
Frontiers in Cell and Developmental Biology frontiersin.org07
Magrath et al. 10.3389/fcell.2024.1442488

extra-cellular matrix. DSRCT, as its name suggests, is densely
stromal, similar in some ways to pancreatic ductal
adenocarcinoma, protected by what has been described as a
“ﬁbrotic fortress ” (Myo Min et al., 2023 ). This tumor
microenvironment (TME) rich in cancer-associated ﬁbroblasts
(CAFs) results in not only a physical barrier to drug diffusion
and immune cell traf ﬁcking, but also promotes
...
challenges speci ﬁcally in the context of CAR T cells for pediatric
sarcomas (Terry et al., 2021 ), but any of these could be employed to
improve ef ﬁcacy of other immunotherapy strategies as well.
Immune checkpoint inhibitors (ICIs), which disrupt
immunosuppressive interactions between T cells and tumor cells,
rely on both the presence of suf ﬁcient numbers of immune cells in
...
While ICIs have led to signiﬁcant beneﬁts for adult cancers with high
...
testing previously identiﬁed DSRCT immunotherapy targets such as
...
identifying new, more speci ﬁc DSRCT immunotherapy targets.
4.2.1 B7-H3
B7 homolog 3 (B7-H3) was the ﬁrst target antigen identi ﬁed in
...
et al., 2023 ). A Phase I trial of intraperitoneal
131I-omburtamab (a
...
represent the ﬁrst new treatment for DSRCT in decades, and could
...
(enoblituzumab), but aside from a 2017 abstract con ﬁrming that
...
Because it is a growth factor rece ptor, anti-HER2 antibody-based
therapeutics can inhibit tumor cell growth by downregulating
proliferative pathways as well b y redirecting immune cells or
delivering cytotoxic payloads ( Smith et al., 2022 ). Our group
recently investigated a set of 8p o t e n t i a li m m u n o t h e r a p y
...
in a humanized immunode ﬁcient mouse model of intraperitoneal
DSRCT. While T-BsAb targeting EGFR and mesothelin failed to
signiﬁcantly reduce tumor growth, HER2-targeted T-BsAbs
displayed potent anti-tumor a ctivity, eliminating tumors
derived from two different cell lines with durable responses
(Espinosa-Cotton et al., 2023 ). These ﬁndings are bolstered by
...
However, it should be noted that this patient ’st u m o r sw e r e
...
administered to DSRCT patients t o maintain remission. While yet
untested clinically in DSRCT, HER2 ADCs are likely to be
investigated in the future owi ng to their success in other
...
(Nakano, 2023 ). Speci ﬁcally, patients with as few as 10%
HER2 positive tumor cells were included, and the type of drug
included in the payload, a topoiso merase I inhibitor, has not been
s h o w nt ob ee f f e c t i v ea g a i n s tO S .I nD S R C T ,t h et o p o i s o m e r a s eI
inhibitor irinotecan is under clin ical investigation in numerous
...
identiﬁed neogenes induced by the EWSR1::FLI oncoprotein in Ewing
sarcoma including a few which aretranslated into neopeptides (Vibert
et al., 2022). Vibert et al. further identi ﬁed neogenes in 17 additional
fusion protein driven cancers, including 37 neogenes in DSRCT.
Building on this work, we examined the expression of these
neogenes in an independent set of 22 DSRCT samples, ﬁnding that
...
neogenes across four DSRCT cell lines and identiﬁed seven neogenes
...
beneﬁts in preclinical models, almost all have failed to induce durable
...
chemotherapy drugs, and small mole cule targets are often cytostatic
hence requiring continuous long term administration unlike CARTs
which are living drugs. When drugs that do not share toxicity proﬁles
...
signiﬁcant gains in survival (VanArsdale et al., 2015; Cristofanilli et al.,
2016; Turner et al., 2018). A similar strategy in DSRCT could combine
an EWSR1::WT1 upstream regulator (yet to be identi ﬁed) with
entrectinib to inhibit NTRK3 or palbociclib to inhibit the CCND-
CDK4/6-RB axis. It may also be bene ﬁcial to simultaneously inhibit
EWSR1::WT1 dependent and indepe ndent pathways: for example,
combination of EGFR inhibition (EWSR1::WT1 independent) and
inhibition of NTRK3 or the CCND-CDK4/6-RB axis (EWSR1::
WT1 dependent).
Combining multiple immunotherapy targets may be bene ﬁcial
to increase speci ﬁcity or account for expression heterogeneity
among tumor cells. Dual targeting antibodies ( Huang et al., 2020 ;
Long et al., 2024 ) combining speci ﬁcities for HER2 and B7-H3, or
HER2 and EGFR may be more speci ﬁc than bispeci ﬁc antibodies
targeting HER2 alone and thereby reduce on-target off-tumor side
effects. Instead of carrying both speci ﬁcities on the same antibody,
multi-speciﬁc T cells can be created ex vivo by simple arming of
polyclonal T cells with multiple BsAb speci ﬁc for individual targets
before iv injection (Park et al., 2021; Park and Cheung, 2022). Single
cell RNA sequencing, proteomics and surfaceomics on DSRCT
samples in the future can shed light on the heterogeneity pro ﬁle
...
ramiﬁcations. Inhibitors could affect not only the DSRCT cells
...
or antagonistic effects which will likely be inhibitor-speci ﬁc. BRAF
and CDK4/6 inhibitors have recently been shown to increase
immune cell in ﬁltration and cytotoxic T cell activity, leading to
synergistic effects when combined with immune checkpoint
inhibitors in melanoma and lung cancer models ( Hooijkaas et al.,
2012; Wilmott et al., 2012 ;
Liu et al., 2013 ; Deng et al., 2018 ; Lelliott
et al., 2022 ). As CDK4/6 inhibitors have demonstrated ef ﬁcacy in
DSRCT ( Magrath et al., 2024a ), it may be bene ﬁcial to combine
them with effective immunotherapy approaches, such as HER2-
directed bispeci ﬁc antibodies. NTRK3 is a particularly interesting
...
efﬁcacy of immune system mediated cytotoxicity induced by the
...
of NTRK3 kinase activity combined with NTRK3 targeting bispeciﬁc
...
NTRK3 expression and thus the ef ﬁcacy of NTRK3-directed
...
the identi ﬁcation of a variety of new therapeutic targets. Several of
...
these targets have demonstrated ef ﬁcacy in cell line-derived and/or
patient-derived xenograft models. NTRK3 inhibition demonstrated
efﬁcacy in the highest number of PDXs at three and an active study is
...
Writing– original draft, Writing – review and editing. ME-C:
Methodology, Writing – original draft, Writing – review and
editing. DF: Writing – original draft, Writing – review and editing.
SS: Writing – original draft, Writing – review and editing. NKC:
Funding acquisition, Resources, Supervision, Writing – review
and editing. SL: Conceptualizatio n, Funding acquisition, Project
...
was supported by NCI 1R01CA222856 (SL).
Conﬂict of interest
Both Memorial Sloan Kettering Cancer Center and NKC have
ﬁnancial interest in Y-mAbs and Eureka Therapeutics. NKC reports
receiving past commercial research grants from Y-mAbs
Therapeutics. NKC was named as inventor on multiple patents
ﬁled by Memorial Sloan Kettering Cancer Center, including those
licensed to Ymabs Therapeutics and Biotec Pharmacon. Y-mAbs
Therapeutics, Eureka Therapeutics and Biotec Pharmacon were not
involved in the study design, collection, analysis, interpretation of
data, the writing of this manuscript or the decision to submit it for
publication.
...
References
Ahmed, N., Brawley, V. S., Hegde, M., Robertson, C., Ghazi, A., Gerken, C., et al.
(2015). Human epidermal growth factor receptor 2 (HER2) -speci ﬁc chimeric antigen
receptor-modiﬁed T cells for the immunotherapy of HER2-positive sarcoma. J. Clin.
Oncol. 33, 1688 – 1696. doi:10.1200/jco.2014.58.0225
Amé, J. C., Spenlehauer, C., and de Murcia, G. (2004). The PARP superfamily.
Bioessays 26, 882 – 893. doi:10.1002/bies.20085
Anzar, I., Malone, B., Samarakoon, P., Vardaxis, I., Simovski, B., Fontenelle, H., et al.
(2023). The interplay between neoantigens and immune cells in sarcomas treated with
checkpoint inhibition. Front. Immunol. 14, 1226445. doi:10.3389/ ﬁmmu.2023.1226445
Bandopadhayay, P., Jabbour, A. M., Riffkin, C., Salmanidis, M., Gordon, L., Popovski,
D., et al. (2013). The oncogenic properties of EWS/WT1 of desmoplastic small round
cell tumors are unmasked by loss of p53 in murine embryonic ﬁbroblasts. BMC Cancer
13, 585. doi:10.1186/1471-2407-13-585
Banks, L., Arkin, H., Chandran, S. S., Slotkin, E., Shukla, N., Morris, L., et al. (2023).
343 De ﬁning and therapeutically targeting a fusion-derived public neoantigen in
desmoplastic small round cell tumor using T-cell receptor gene therapy.
J. Immunother. Cancer 11, A392. doi:10.1136/jitc-2023-SITC2023.0343
Blay, J. Y., Chevret, S., Le Cesne, A., Brahmi, M., Penel, N., Cousin, S., et al. (2023).
Pembrolizumab in patients with rare and ultra-rare sarcomas (AcSé Pembrolizumab):
analysis of a subgroup from a non-randomised, open-label, phase 2, basket trial. Lancet
Oncol. 24, 892 – 902. doi:10.1016/s1470-2045(23)00282-6
Bleijs, M., Pleijte, C., Engels, S., Ringnalda, F., Meyer-Wentrup, F., van de Wetering,
M., et al. (2021). EWSR1-WT1 target genes and therapeutic options identiﬁed in a novel
DSRCT in vitro model. Cancers (Basel) 13, 6072. doi:10.3390/cancers13236072
B o n ,H . ,W a d h w a ,K . ,S c h r e i n e r ,A . ,O s b o r n e ,M . ,C a r r o l l ,T . ,R a m o s - M o n t o y a ,A . ,
et al. (2015). Salt-inducible kinase 2 regulates mitotic progression and transcription
in prostate cancer. Mol. Cancer Res. 13, 620 – 635. doi:10.1158/1541-7786.MCR-13-
0182-T
Bulbul, A., Fahy, B. N., Xiu, J., Rashad, S., Mustafa, A., Husain, H., et al. (2017).
Desmoplastic small round blue cell tumor: a review of treatment and potential
therapeutic genomic alterations. Sarcoma 2017, 1278268. doi:10.1155/2017/1278268
Chang, F. (2006). Desmoplastic small round cell tumors: cytologic, histologic, and
immunohistochemical features. Archives Pathology Laboratory Med. 130, 728 – 732.
doi:10.5858/2006-130-728-dsrctc
Cheng, H., Liu, P., Wang, Z. C., Zou, L., Santiago, S., Garbitt, V., et al. (2009).
SIK1 couples LKB1 to p53-dependent anoikis and suppresses metastasis. Sci. Signal. 2,
ra35. doi:10.1126/scisignal.2000369
Chow, W. A., Yee, J. K., Tsark, W., Wu, X., Qin, H., Guan, M., et al. (2020). Recurrent
secondary genomic alterations in desmoplastic small round cell tumors. BMC Med.
Genet. 21, 101. doi:10.1186/s12881-020-01034-w
Cocco, E., Scaltriti, M., and Drilon, A. (2018). NTRK fusion-positive cancers and
TRK inhibitor therapy. Nat. Rev. Clin. Oncol. 15, 731 – 747. doi:10.1038/s41571-018-
0113-0
Cristofanilli, M., Turner, N. C., Bondarenko, I., Ro, J., Im, S. A., Masuda, N., et al.
...
previous endocrine therapy (PALOMA-3): ﬁnal analysis of the multicentre, double-
blind, phase 3 randomised controlled trial. Lancet Oncol. 17, 425 –
439. doi:10.1016/
s1470-2045(15)00613-0
Darling, N. J., and Cohen, P. (2021). Nuts and bolts of the salt-inducible kinases
(SIKs). Biochem. J. 478, 1377 – 1397. doi:10.1042/BCJ20200502
Demetri, G. D., von Mehren, M., Jones, R. L., Hensley, M. L., Schuetze, S. M., Staddon,
A., et al. (2016). Ef ﬁcacy and safety of trabectedin or dacarbazine for metastatic
liposarcoma or leiomyosarcoma after failure of conventional chemotherapy: results
of a phase III randomized multicenter clinical trial. J. Clin. Oncol. 34, 786– 793. doi:10.
1200/JCO.2015.62.4734
Frontiers in Cell and Developmental Biology frontiersin.org10
Magrath et al. 10.3389/fcell.2024.1442488

Deng, J., Wang, E. S., Jenkins, R. W., Li, S., Dries, R., Yates, K., et al. (2018). CDK4/
6 inhibition augments antitumor immunity by enhancing T-cell activation. Cancer
Discov. 8, 216 – 233. doi:10.1158/2159-8290.Cd-17-0915
Desantes, K., Maris, J. M., McDowell, K., Mackall, C., Shankar, S., Vasselli, J., et al.
(2017). A phase 1, open-label, dose escalation study of enoblituzumab (MGA271) in
pediatric patients with B7-H3-expressing relapsed or refractory solid tumors. J. Clin.
Oncol. 35, TPS2596. doi:10.1200/JCO.2017.35.15_suppl.TPS2596
Devecchi, A., De Cecco, L., Dugo, M., Penso, D., Dagrada, G., Brich, S., et al. (2018).
The genomics of desmoplastic small round cell tumor reveals the deregulation of genes
related to DNA damage response, epithelial – mesenchymal transition, and immune
response. Cancer Commun. 38, 70. doi:10.1186/s40880-018-0339-3
Di Giandomenico, S., Frapolli, R., Bello, E., Uboldi, S., Licandro, S. A., Marchini, S.,
et al. (2014). Mode of action of trabectedin in myxoid liposarcomas. Oncogene 33,
5201– 5210. doi:10.1038/onc.2013.462
Dymecki, S. M., Niederhuber, J. E., and Desiderio, S. V. (1990). Speci ﬁc expression of
a tyrosine kinase gene, blk, in B lymphoid cells. Science 247, 332 – 336. doi:10.1126/
science.2404338
Espinosa-Cotton, M., Guo, H. F., Tickoo, S. K., and Cheung, N. V. (2023).
Identiﬁcation of immunotherapy and radioimmunotherapy targets on desmoplastic
small round cell tumors. Front. Oncol. 13, 1104693. doi:10.3389/fonc.2023.1104693
Ferrari, A., Chiaravalli, S., Bergamaschi, L., Nigro, O., Livellara, V., Sironi, G., et al.
(2023). Trabectedin-irinotecan, a potentially promising combination in relapsed
desmoplastic small round cell tumor: report of two cases. J. Chemother. 35,
163– 167. doi:10.1080/1120009x.2022.2067706
Fine, R. L., Shah, S. S., Moulton, T. A., Yu, I. R., Fogelman, D. R., Richardson, M., et al.
(2007). Androgen and c-Kit receptors in desmoplastic small round cell tumors resistant
to chemotherapy: novel targets for therapy. Cancer Chemother. Pharmacol. 59, 429– 437.
doi:10.1007/s00280-006-0280-z
Gao, T., Zhang, X., Zhao, J., Zhou, F., Wang, Y., Zhao, Z., et al. (2020). SIK2 promotes
reprogramming of glucose metabolism through PI3K/AKT/HIF-1 α pathway and Drp1-
mediated mitochondrial ﬁssion in ovarian cancer. Cancer Lett. 469, 89 – 101. doi:10.
1016/j.canlet.2019.10.029
Gedminas, J. M., Chasse, M. H., McBrairty, M., Beddows, I., Kitchen-Goosen, S. M.,
and Grohar, P. J. (2020). Desmoplastic small round cell tumor is dependent on the
EWS-WT1 transcription factor. Oncogenesis 9, 41. doi:10.1038/s41389-020-0224-1
Gedminas, J. M., Kaufman, R., Boguslawski, E. A., Gross, A. C., Adams, M., Beddows,
I., et al. (2022a). Lurbinectedin inhibits the EWS-WT1 transcription factor in
desmoplastic small round cell tumor. Mol. Cancer Ther. 21, 1296 – 1305. doi:10.1158/
1535-7163.Mct-21-1003
Gedminas, J. M., Kaufman, R., Boguslawski, E. A., Gross, A. C., Adams, M., Beddows,
I., et al. (2022b). Lurbinectedin inhibits the EWS – WT1 transcription factor in
desmoplastic small round cell tumor. Mol. cancer Ther. 21, 1296 – 1305. doi:10.1158/
1535-7163.MCT-21-1003
Gerald, W. L., and Haber, D. A. (2005). The EWS-WT1 gene fusion in desmoplastic
small round cell tumor. Semin. Cancer Biol. 15, 197– 205. doi:10.1016/j.semcancer.2005.
01.005
Gerald, W. L., Rosai, J., and Ladanyi, M. (1995). Characterization of the genomic
breakpoint and chimeric transcripts in the EWS-WT1 gene fusion of desmoplastic small
round cell tumor. Proc. Natl. Acad. Sci. U. S. A. 92, 1028– 1032. doi:10.1073/pnas.92.4.
1028
Goydel, R. S., and Rader, C. (2021). Antibody-based cancer therapy. Oncogene 40,
3655– 3664. doi:10.1038/s41388-021-01811-8
Grosso, F., Jones, R. L., Demetri, G. D., Judson, I. R., Blay, J. Y., Le Cesne, A., et al.
(2007). Ef ﬁcacy of trabectedin (ecteinascidin-743) in advanced pretreated myxoid
liposarcomas: a retrospective study. lancet Oncol. 8, 595 – 602. doi:10.1016/S1470-
2045(07)70175-4
Grosso, F., San ﬁlippo, R., Virdis, E., Piovesan, C., Collini, P., Dileo, P., et al. (2009).
Trabectedin in myxoid liposarcomas (MLS): a long-term analysis of a single-institution
series. Ann. Oncol. 20, 1439 – 1444. doi:10.1093/annonc/mdp004
Haigis, K. M., and Sweet-Cordero, A. (2011). New insights into oncogenic stress. Nat.
Genet. 43, 177 – 178. doi:10.1038/ng0311-177
Harlow, M. L., Maloney, N., Roland, J., Guillen Navarro, M. J., Easton, M. K., Kitchen-
Goosen, S. M., et al. (2016). Lurbinectedin inactivates the ewing sarcoma oncoprotein
EWS-FLI1 by redistributing it within the nucleus. Cancer Res. 76, 6657 – 6668. doi:10.
1158/0008-5472.Can-16-0568
Hartono, A. B., Kang, H. J., Shi, L., Phipps, W., Ungerleider, N., Giardina, A., et al.
(2022). Salt-inducible kinase 1 is a potential therapeutic target in desmoplastic small
round cell tumor. Oncogenesis 11, 18. doi:10.1038/s41389-022-00395-6
Hayes-Jordan, A., LaQuaglia, M. P., and Modak, S. (2016). Management of
desmoplastic small round cell tumor. Semin. Pediatr. Surg. 25, 299 – 304. doi:10.
1053/j.sempedsurg.2016.09.005
Hingorani, P., Dinu, V., Zhang, X., Lei, H., Shern, J. F., Park, J., et al. (2020).
Transcriptome analysis of desmoplastic small round cell tumors identi ﬁes actionable
therapeutic targets: a report from the Children ’s Oncology Group. Sci. Rep. 10, 12318.
doi:10.1038/s41598-020-69015-w
Hingorani, P., Zhang, W., Zhang, Z., Xu, Z., Wang, W. L., Roth, M. E., et al. (2022).
Trastuzumab deruxtecan, antibody-drug conjugate targeting HER2, is effective in
pediatric malignancies: a report by the pediatric preclinical testing consortium. Mol.
Cancer Ther. 21, 1318 – 1325. doi:10.1158/1535-7163.Mct-21-0758
Hollstein, P. E., Eichner, L. J., Brun, S. N., Kamireddy, A., Svensson, R. U., Vera, L. I.,
et al. (2019). The AMPK-related kinases SIK1 and SIK3 mediate key tumor-suppressive
effects of LKB1 in NSCLC. Cancer Discov. 9, 1606 – 1627. doi:10.1158/2159-8290.CD-
18-1261
Honoré, C., Delhorme, J. B., Nassif, E., Faron, M., Ferron, G., Bompas, E., et al. (2019).
Can we cure patients with abdominal Desmoplastic Small Round Cell Tumor? Results
of a retrospective multicentric study on 100 patients. Surg. Oncol. 29, 107– 112. doi:10.
1016/j.suronc.2019.04.002
Hooijkaas, A., Gadiot, J., Morrow, M., Stewart, R., Schumacher, T., and Blank, C. U.
(2012). Selective BRAF inhibition decreases tumor-resident lymphocyte frequencies in a
mouse model of human melanoma. Oncoimmunology 1, 609 – 617. doi:10.4161/onci.
20226
Hovsepyan, S., Giani, C., Pasquali, S., Di Giannatale, A., Chiaravalli, S., Colombo, C.,
et al. (2023). Desmoplastic small round cell tumor: from state of the art to future clinical
prospects. Expert Rev. Anticancer Ther. 23, 471 – 484. doi:10.1080/14737140.2023.
2200171
Hsu, J. Y., Seligson, N. D., Hays, J. L., Miles, W. O., and Chen, J. L. (2022). Clinical
utility of CDK4/6 inhibitors in sarcoma: successes and future challenges. JCO Precis.
Oncol. 6, e2100211. doi:10.1200/po.21.00211
Huang, S., van Duijnhoven, S. M. J., Sijts, A. J. A. M., and van Elsas, A. (2020).
Bispeciﬁc antibodies targeting dual tumor-associated antigens in cancer therapy.
J. Cancer Res. Clin. Oncol. 146, 3111 – 3122. doi:10.1007/s00432-020-03404-6
Kang, H. J., Park, J. H., Chen, W., Kang, S. I., Moroz, K., Ladanyi, M., et al. (2014). EWS-
WT1 oncoprotein activates neuronal reprogramming factor ASCL1 and promotes neural
differentiation. Cancer Res. 74, 4526– 4535. doi:10.1158/0008-5472.Can-13-3663
Kauffmann-Guerrero, D., and Huber, R. M. (2020) “Orphan drugs in development
for the treatment of small-cell lung cancer: emerging data on lurbinectedin, ” in Lung
cancer: targets and therapy ,2 7 – 31.
Kennedy, A. L., Vallurupalli, M., Chen, L., Crompton, B., Cowley, G., Vazquez, F.,
et al. (2015). Functional, chemical genomic, and super-enhancer screening identify
sensitivity to cyclin D1/CDK4 pathway inhibition in Ewing sarcoma. Oncotarget 6,
30178– 30193. doi:10.18632/oncotarget.4903
Kim, J., Lee, K., and Pelletier, J. (1998). The desmoplastic small round cell tumor t(11;
22) translocation produces EWS/WT1 isoforms with differing oncogenic properties.
Oncogene 16, 1973 – 1979. doi:10.1038/sj.onc.1201716
Kontos, F., Michelakos, T., Kurokawa, T., Sadagopan, A., Schwab, J. H., Ferrone, C. R.,
et al. (2021). B7-H3: an attractive target for antibody-based immunotherapy. Clin.
Cancer Res. 27, 1227 – 1235. doi:10.1158/1078-0432.Ccr-20-2584
Krejsgaard, T., Vetter-Kauczok, C. S., Woetmann, A., Kneitz, H., Eriksen, K. W.,
Lovato, P., et al. (2009). Ectopic expression of B-lymphoid kinase in cutaneous T-cell
lymphoma. Blood 113, 5896 – 5904. doi:10.1182/blood-2008-09-181024
Kushner, B. H., LaQuaglia, M. P., Wollner, N., Meyers, P. A., Lindsley, K. L., Ghavimi,
F., et al. (1996). Desmoplastic small round-cell tumor: prolonged progression-free
survival with aggressive multimodality therapy. J. Clin. Oncol. 14, 1526 – 1531. doi:10.
1200/JCO.1996.14.5.1526
Ladanyi, M., and Gerald, W. (1994). Fusion of the EWS and WT1 genes in the
desmoplastic small round cell tumor. Cancer Res. 54, 2837 – 2840.
Lal, D. R., Su, W. T., Wolden, S. L., Loh, K. C., Modak, S., and La Quaglia, M. P.
(2005). Results of multimodal treatment for desmoplastic small round cell tumors.
J. Pediatr. Surg. 40, 251 – 255. doi:10.1016/j.jpedsurg.2004.09.046
Lamhamedi-Cherradi, S. E., Maitituoheti, M., Menegaz, B. A., Krishnan, S., Vetter, A.
M., Camacho, P., et al. (2022). The androgen receptor is a therapeutic target in
desmoplastic small round cell sarcoma. Nat. Commun. 13, 3057. doi:10.1038/
s41467-022-30710-z
Larson, S. M., Carrasquillo, J. A., Cheung, N.-K. V., and Press, O. W. (2015).
Radioimmunotherapy of human tumours. Nat. Rev. Cancer 15, 347 – 360. doi:10.
1038/nrc3925
Lelliott, E. J., Sheppard, K. E., and McArthur, G. A. (2022). Harnessing the
immunotherapeutic potential of CDK4/6 inhibitors in melanoma: is timing
everything? npj Precis. Oncol. 6, 26. doi:10.1038/s41698-022-00273-9
Lettieri, C. K., Garcia-Filion, P., and Hingorani, P. (2014). Incidence and outcomes of
desmoplastic small round cell tumor: results from the surveillance, epidemiology, and
end results database. J. Cancer Epidemiol. 2014, 680126. doi:10.1155/2014/680126
Liu, C., Peng, W., Xu, C., Lou, Y., Zhang, M., Wargo, J. A., et al. (2013). BRAF
inhibition increases tumor in ﬁltration by T cells and enhances the antitumor activity of
adoptive immunotherapy in mice. Clin. Cancer Res. 19, 393 – 403. doi:10.1158/1078-
0432.Ccr-12-1626
Long, A. W., Xu, H., Santich, B. H., Guo, H., Hoseini, S. S., de Stanchina, E., et al.
(2024). Heterodimerization of T cell engaging bispeci ﬁc antibodies to enhance
speciﬁcity against pancreatic ductal adenocarcinoma. J. Hematol. Oncol. 17, 20.
doi:10.1186/s13045-024-01538-5
Frontiers in Cell and Developmental Biology frontiersin.org11
Magrath et al. 10.3389/fcell.2024.1442488

Lowery, C. D., Dowless, M., Renschler, M., Blosser, W., VanWye, A. B., Stephens, J. R.,
et al. (2019). Broad spectrum activity of the checkpoint kinase 1 inhibitor prexasertib as
a single agent or chemopotentiator across a range of preclinical pediatric tumor models.
Clin. Cancer Res. 25, 2278 – 2289. doi:10.1158/1078-0432.Ccr-18-2728
Magrath, J. W., Flinchum, D. A., Hartono, A. B., Goldberg, I. N., Espinosa-Cotton, M.,
Moroz, K., et al. (2023a). Genomic breakpoint characterization and transcriptome
analysis of metastatic, recurrent desmoplastic small round cell tumor. Sarcoma 2023,
6686702. doi:10.1155/2023/6686702
Magrath, J. W., Flinchum, D. A., Hartono, A. B., Sampath, S. S., O ’Grady, T. M.,
Baddoo, M., et al. (2024b). Transcriptomic analysis identi ﬁes B-lymphocyte kinase as a
therapeutic target for desmoplastic small round cell tumor cancer stem cell-like cells.
Oncogenesis 13, 2. doi:10.1038/s41389-023-00504-z
Magrath, J. W., Goldberg, I. N., Truong, D. D., Hartono, A. B., Sampath, S. S., Jackson,
C. E., et al. (2023b). Enzalutamide induces cytotoxicity in desmoplastic small round cell
tumor independent of the androgen receptor. bioRxiv565842. doi:10.1101/2023.11.06.
565842
Magrath, J. W., Goldberg, I. N., Truong, D. D., Hartono, A. B., Sampath, S. S., Jackson,
C. E., et al. (2024c). Enzalutamide induces cytotoxicity in desmoplastic small round cell
tumor independent of the androgen receptor. Commun. Biol. 7, 411. doi:10.1038/
s42003-024-06003-0
Magrath, J. W., Kang, H. J., Hartono, A., Espinosa-Cotton, M., Somwar, R., Ladanyi,
M., et al. (2022). Desmoplastic small round cell tumor cancer stem cell-like cells resist
chemotherapy but remain dependent on the EWSR1-WT1 oncoprotein. Front. Cell.
Dev. Biol. 10, 1048709. doi:10.3389/fcell.2022.1048709
M a g r a t h ,J .W . ,S a m p a t h ,S .S . ,F l i n c h u m ,D .A . ,H a r t o n o ,A .B . ,G o l d b e r g ,I .N . ,
Boehling, J. R., et al. (2024a). Comprehens ive transcriptomic analysis of EWSR1::
WT1 targets identi ﬁes CDK4/6 inhibitors as an effective therapy for desmoplastic
small round cell tumors. Cancer Res. 84, 1426 – 1442. doi:10.1158/0008-5472.Can-23-
3334
Malek, S. N., Dordai, D. I., Reim, J., Dintzis, H., and Desiderio, S. (1998). Malignant
transformation of early lymphoid progenitors in mice expressing an activated Blk
tyrosine kinase. Proc. Natl. Acad. Sci. U. S. A. 95, 7351 – 7356. doi:10.1073/pnas.95.13.
7351
Modak, S., Gerald, W., and Cheung, N. K. (2002). Disialoganglioside GD2 and a novel
tumor antigen: potential targets for immunotherapy of desmoplastic small round cell
tumor. Med. Pediatr. Oncol. 39, 547 – 551. doi:10.1002/mpo.10151
Modak, S., Zanzonico, P., Grkovski, M., Slotkin, E. K., Carrasquillo, J. A.,
Lyashchenko, S. K., et al. (2020). B7H3-Directed intraperitoneal
radioimmunotherapy with radioiodinated omburtamab for desmoplastic small
round cell tumor and other peritoneal tumors: results of a phase I study. J. Clin.
Oncol. 38, JCO2001974 – 4291. doi:10.1200/jco.20.01974
Monteran, L., and Erez, N. (2019). The dark side of ﬁbroblasts: cancer-associated
ﬁbroblasts as mediators of immunosuppression in the tumor microenvironment. Front.
Immunol. 10, 1835. doi:10.3389/ ﬁmmu.2019.01835
Myo Min, K. K., Ffrench, C. B., Jessup, C. F., Shepherdson, M., Barreto, S. G., and
Bonder, C. S. (2023). Overcoming the ﬁbrotic fortress in pancreatic ductal
adenocarcinoma: challenges and opportunities. Cancers (Basel) 15, 2354. doi:10.
3390/cancers15082354
Nakano, K. (2023). The future of HER2-targeted treatment for osteosarcoma: lessons
from the negative trastuzumab deruxtecan results. Int. J. Mol. Sci. 24, 16823. doi:10.
3390/ijms242316823
Negri, T., Brich, S., Bozzi, F., Volpi, C. V., Gualeni, A. V., Stacchiotti, S., et al. (2017).
New transcriptional-based insights into the pathogenesis of desmoplastic small round
cell tumors (DSRCTs). Oncotarget 8, 32492 – 32504. doi:10.18632/oncotarget.16477
Nicholas, T. R., Metcalf, S. A., Greulich, B. M., and Hollenhorst, P. C. (2021).
Androgen signaling connects short isoform production to breakpoint formation at
Ewing sarcoma breakpoint region 1. Nar. Cancer 3, zcab033. doi:10.1093/narcan/
zcab033
Nishio, J., Iwasaki, H., Ishiguro, M., Ohjimi, Y., Fujita, C., Yanai, F., et al. (2002).
Establishment and characterization of a novel human desmoplastic small round cell
tumor cell line, JN-DSRCT-1. Lab. Investig. 82, 1175 – 1182. doi:10.1097/01.lab.
0000028059.92642.03
Ogura, K., Somwar, R., Hmeljak, J., Magnan, H., Benayed, R., Momeni-Boroujeni, A.,
et al. (2021). Therapeutic potential of NTRK3 inhibition in desmoplastic small round
cell tumor. Clin. Cancer Res. 27, 1184 – 1194. doi:10.1158/1078-0432.Ccr-20-2585
Park, J. A., and Cheung, N. V. (2022). Overcoming tumor heterogeneity by ex vivo
arming of T cells using multiple bispeci ﬁc antibodies. J. Immunother. Cancer 10,
e003771. doi:10.1136/jitc-2021-003771
Park, J. A., Santich, B. H., Xu, H., Lum, L. G., and Cheung, N. V. (2021). Potent ex vivo
armed T cells using recombinant bispeci ﬁc antibodies for adoptive immunotherapy
with reduced cytokine release. J. Immunother. Cancer 9, e002222. doi:10.1136/jitc-2020-
002222
Patra, K. C., Kato, Y., Mizukami, Y., Widholz, S., Boukhali, M., Revenco, I., et al.
(2018). Mutant GNAS drives pancreatic tumourigenesis by inducing PKA-mediated
SIK suppression and reprogramming lipid metabolism. Nat. Cell. Biol. 20, 811 – 822.
doi:10.1038/s41556-018-0122-3
Petersen, D. L., Berthelsen, J., Willerslev-Olsen, A., Fredholm, S., Dabelsteen, S.,
Bonefeld, C. M., et al. (2017). A novel BLK-induced tumor model. Tumour Biol. 39,
1010428317714196. doi:10.1177/1010428317714196
Petersen, D. L., Krejsgaard, T., Berthelsen, J., Fredholm, S., Willerslev-Olsen, A.,
Sibbesen, N. A., et al. (2014). B-lymphoid tyrosine kinase (Blk) is an oncogene and a
potential target for therapy with dasatinib in cutaneous T-cell lymphoma (CTCL).
Leukemia 28, 2109 – 2112. doi:10.1038/leu.2014.192
Potluri, S., Assi, S. A., Chin, P. S., Coleman, D. J. L., Pickin, A., Moriya, S., et al. (2021).
Isoform-speciﬁc and signaling-dependent propagation of acute myeloid leukemia by
Wilms tumor 1. Cell. Rep. 35, 109010. doi:10.1016/j.celrep.2021.109010
Rader, J., Russell, M. R., Hart, L. S., Nakazawa, M. S., Belcastro, L. T., Martinez, D.,
et al. (2013). Dual CDK4/CDK6 inhibition induces cell-cycle arrest and senescence in
neuroblastoma. Clin. Cancer Res. 19, 6173 – 6182. doi:10.1158/1078-0432.Ccr-13-1675
Sakamoto, K., Bultot, L., and Göransson, O. (2018). The salt-inducible kinases:
emerging metabolic regulators. Trends Endocrinol. Metabolism 29, 827 – 840. doi:10.
1016/j.tem.2018.09.007
...
damage to Cdk regulation through Cdc25. Science 277, 1497– 1501. doi:10.1126/science.
277.5331.1497
Santich, B. H., Cheal, S. M., Ahmed, M., McDevitt, M. R., Ouerfelli, O., Yang, G., et al.
(2021). A self-assembling and disassembling (SADA) bispeci ﬁc antibody (BsAb)
platform for curative two-step pretargeted radioimmunotherapy. Clin. Cancer Res.
27, 532 – 541. doi:10.1158/1078-0432.Ccr-20-2150
Saouaf, S. J., Mahajan, S., Rowley, R. B., Kut, S. A., Fargnoli, J., Burkhardt, A. L., et al.
(1994). Temporal differences in the activation of three classes of non-transmembrane
protein tyrosine kinases following B-cell antigen receptor surface engagement. Proc.
Natl. Acad. Sci. U. S. A. 91, 9524 – 9528. doi:10.1073/pnas.91.20.9524
Sato, Y., Nabeta, Y., Tsukahara, T., Hirohashi, Y., Syunsui, R., Maeda, A., et al. (2002).
Detection and induction of CTLs speciﬁc for SYT-SSX-derived peptides in HLA-A24(+)
patients with synovial sarcoma. J. Immunol. 169, 1611 – 1618. doi:10.4049/jimmunol.
169.3.1611
Scaltriti, M., Verma, C., Guzman, M., Jimenez, J., Parra, J. L., Pedersen, K., et al.
...
Oncogene 28, 803 – 814. doi:10.1038/onc.2008.432
Schöffski, P., Bahleda, R., Wagner, A. J., Burgess, M. A., Junker, N., Chisamore, M.,
et al. (2023). Results of an open-label, phase ia/b study of pembrolizumab plus
olaratumab in patients with unresectable, locally advanced, or metastatic soft-tissue
sarcoma. Clin. Cancer Res. 29, 3320 – 3328. doi:10.1158/1078-0432.Ccr-23-0742
Shiravand, Y., Khodadadi, F., Kashani, S. M. A., Hosseini-Fard, S. R., Hosseini, S.,
Sadeghirad, H., et al. (2022). Immune checkpoint inhibitors in cancer therapy. Curr.
Oncol. 29, 3044 – 3060. doi:10.3390/curroncol29050247
Sigismund, S., Avanzato, D., and Lanzetti, L. (2018). Emerging functions of the EGFR
in cancer. Mol. Oncol. 12, 3 – 20. doi:10.1002/1878-0261.12155
Slotkin, E. K., Bowman, A. S., Levine, M. F., Dela Cruz, F., Coutinho, D. F., Sanchez, G.
I., et al. (2021a). Comprehensive molecular pro ﬁling of desmoplastic small round cell
tumor. Mol. Cancer Res. 19, 1146 – 1155. doi:10.1158/1541-7786.Mcr-20-0722
Slotkin, E. K., Bowman, A. S., Levine, M. F., Dela Cruz, F., Coutinho, D. F., Sanchez, G.
I., et al. (2021b). Comprehensive molecular pro ﬁling of desmoplastic small round cell
tumor. Mol. Cancer Res. 19, 1146 – 1155. doi:10.1158/1541-7786.Mcr-20-0722
Slotkin, E. K., Mauguen, A., Ortiz, M. V., Dela Cruz, F. S., O ’Donohue, T.,
Kinnaman, M. D., et al. (2022). A phase I/II study of prexasertib in combination
with irinotecan in patients with relapsed/refractory desmoplastic small round cell
tumor and rhabdomyosarcoma. J. Clin. Oncol. 40, 11503. doi:10.1200/JCO.2022.40.
16_suppl.11503
Smith, R. S., Odintsov, I., Liu, Z., Lui, A. J. W., Hayashi, T., Vojnic, M., et al. (2022).
Novel patient-derived models of desmoplastic small round cell tumor con ﬁrm a
targetable dependency on ERBB signaling. Dis. Model. Mech. 15, dmm047621.
doi:10.1242/dmm.047621
Sterner, R. C., and Sterner, R. M. (2021). CAR-T cell therapy: current limitations and
potential strategies. Blood Cancer J. 11, 69. doi:10.1038/s41408-021-00459-7
Stiles, Z. E., Dickson, P. V., Glazer, E. S., Murphy, A. J., Davidoff, A. M., Behrman, S.
W., et al. (2018). Desmoplastic small round cell tumor: a nationwide study of a rare
sarcoma. J. Surg. Oncol. 117, 1759 – 1767. doi:10.1002/jso.25071
Subbiah, V., Lamhamedi-Cherradi, S. E., Cuglievan, B., Menegaz, B. A., Camacho, P.,
Huh, W., et al. (2018). Multimodality treatment of desmoplastic small round cell tumor:
chemotherapy and complete cytoreductive surgery improve patient survival. Clin.
Cancer Res. 24, 4865 – 4873. doi:10.1158/1078-0432.Ccr-18-0202
Tabak, S. A., Khalifa, S. E., and Fathy, Y. (2018). HER-2 immunohistochemical
expression in bone sarcomas: a new hope for osteosarcoma patients.
Open Access
Maced. J. Med. Sci. 6, 1555 – 1560. doi:10.3889/oamjms.2018.318
Talukdar, S., Emdad, L., Das, S. K., and Fisher, P. B. (2020). EGFR: an essential
receptor tyrosine kinase-regulator of cancer stem cells. Adv. Cancer Res. 147, 161– 188.
doi:10.1016/bs.acr.2020.04.003
Frontiers in Cell and Developmental Biology frontiersin.org12
Magrath et al. 10.3389/fcell.2024.1442488

Tarumoto, Y., Lu, B., Somerville, T. D. D., Huang, Y. H., Milazzo, J. P., Wu, X. S., et al.
(2018). LKB1, salt-inducible kinases, and MEF2C are linked dependencies in acute
myeloid leukemia. Mol. Cell. 69, 1017 – 1027. doi:10.1016/j.molcel.2018.02.011
Tawbi, H. A., Burgess, M., Bolejack, V., Van Tine, B. A., Schuetze, S. M., Hu, J., et al.
(2017). Pembrolizumab in advanced soft-tissue sarcoma and bone sarcoma (SARC028):
a multicentre, two-cohort, single-arm, open-label, phase 2 trial. Lancet Oncol. 18,
1493– 1501. doi:10.1016/s1470-2045(17)30624-1
Teplinsky, E., and Herzog, T. J. (2017). The ef ﬁcacy of trabectedin in treating ovarian
cancer. Expert Opin. Pharmacother. 18, 313 – 323. doi:10.1080/14656566.2017.1285282
Terry, R. L., Meyran, D., Fleuren, E. D. G., Mayoh, C., Zhu, J., Omer, N., et al. (2021). Chimeric
antigen receptor T cell therapy and the immu nosuppressive tumor microenvironment in
pediatric sarcoma.Cancers (Basel)13, 4704. doi:10.3390/cancers13184704
Texido, G., Su, I. H., Mecklenbräuker, I., Saijo, K., Malek, S. N., Desiderio, S., et al.
(2000). The B-cell-speci ﬁc Src-family kinase Blk is dispensable for B-cell development
and activation. Mol. Cell. Biol. 20, 1227 – 1233. doi:10.1128/mcb.20.4.1227-1233.2000
Truong, D., Magrath, J., Lee, S., and Ludwig, J. (2024). Abstract 2851: characterization
of neogenes in desmoplastic small round cell tumors. Cancer Res. 84, 2851. doi:10.1158/
1538-7445.Am2024-2851
Truong, D. D., Lamhamedi-Cherradi, S. E., Porter, R. W., Krishnan, S., Swaminathan,
J., Gibson, A., et al. (2023). Dissociation protocols used for sarcoma tissues bias the
transcriptome observed in single-cell and single-nucleus RNA sequencing. BMC Cancer
23, 488. doi:10.1186/s12885-023-10977-1
Turner, N. C., Slamon, D. J., Ro, J., Bondarenko, I., Im, S. A., Masuda, N., et al. (2018).
Overall survival with palbociclib and fulvestrant in advanced breast cancer. N. Engl.
J. Med. 379, 1926 – 1936. doi:10.1056/NEJMoa1810527
Uboldi, S., Craparotta, I., Colella, G., Ronchetti, E., Beltrame, L., Vicario, S., et al.
(2017). Mechanism of action of trabectedin in desmoplastic small round cell tumor cells.
BMC Cancer 17, 107. doi:10.1186/s12885-017-3091-1
Uribe, M. L., Marrocco, I., and Yarden, Y. (2021). EGFR in cancer: signaling
mechanisms, drugs, and acquired resistance. Cancers (Basel) 13, 2748. doi:10.3390/
cancers13112748
...
21, 2905 – 2910. doi:10.1158/1078-0432.Ccr-14-0816
van Erp, A. E. M., Hillebrandt-Roeffen, M. H. S., van Bree, N. F. H. N., Plüm, T. A.,
Flucke, U. E., Desar, I. M. E., et al. (2022). Targeting the FAK-src complex in
desmoplastic small round cell tumors, ewing sarcoma, and rhabdomyosarcoma.
Sarcoma 2022, 3089424. doi:10.1155/2022/3089424
van Erp, A. E. M., van Houdt, L., Hillebrandt-Roeffen, M. H. S., van Bree, N. F. H. N.,
Flucke, U. E., Mentzel, T., et al. (2020). Olaparib and temozolomide in desmoplastic
small round cell tumors: a promising combination in vitro and in vivo . J. Cancer Res.
Clin. Oncol. 146, 1659 – 1670. doi:10.1007/s00432-020-03211-z
Vibert, J., Saulnier, O., Collin, C., Petit, F., Borgman, K. J. E., Vigneau, J., et al. (2022).
Oncogenic chimeric transcription factors drive tumor-speci ﬁc transcription,
processing, and translation of silent genomic regions. Mol. Cell. 82, 2458 – 2471.e9.
doi:10.1016/j.molcel.2022.04.019
Wang, L., Liang, C., Li, F., Guan, D., Wu, X., Fu, X., et al. (2017). PARP1 in
carcinomas and PARP1 inhibitors as antineoplastic drugs. Int. J. Mol. Sci. 18, 2111.
doi:10.3390/ijms18102111
Wang, Y., Shi, T., Song, X., Liu, B., and Wei, J. (2021). Gene fusion neoantigens:
emerging targets for cancer immunotherapy. Cancer Lett. 506, 45 – 54. doi:10.1016/j.
canlet.2021.02.023
Waqar, S. H. B., and Ali, H. (2022). Changing incidence and survival of desmoplastic
small round cell tumor in the USA. Proc. Bayl Univ. Med. Cent. 35, 415 – 419. doi:10.
1080/08998280.2022.2049581
Wilmott, J. S., Long, G. V., Howle, J. R., Haydu, L. E., Sharma, R. N., Thompson, J. F.,
et al. (2012). Selective BRAF inhibitors induce marked T-cell in ﬁltration into human
metastatic melanoma. Clin. Cancer Res. 18, 1386– 1394. doi:10.1158/1078-0432.Ccr-11-
2479
W u ,C .C . ,B e i r d ,H .C . ,L a m h a m e d i - C h e r r a d i ,S .E . ,S o e u n g ,M . ,I n g r a m ,D . ,
Truong, D. D., et al. (2022a). Multi-site desmoplastic small round cell tumors are
genetically related and immune-cold. NPJ Precis. Oncol. 6, 21. doi:10.1038/s41698-
022-00257-9
Wu, C.-C., Beird, H. C., Lamhamedi-Cherradi, S. E., Soeung, M., Ingram, D., Truong,
D. D., et al. (2022b). Multi-site desmoplastic small round cell tumors are genetically
related and immune-cold. npj Precis. Oncol. 6, 21. doi:10.1038/s41698-022-00257-9
Xiang, T., Zhang, S. Y., Wang, S. S., Fei, R. S., and Li, H. (2020). A nationwide analysis
of desmoplastic small round cell tumor. Med. Baltim. 99, e21337. doi:10.1097/md.
0000000000021337
Yang, W., Lee, K. W., Srivastava, R. M., Kuo, F., Krishna, C., Chowell, D., et al. (2019).
Immunogenic neoantigens derived from gene fusions stimulate T cell responses. Nat.
Med. 25, 767 – 775. doi:10.1038/s41591-019-0434-2
Yotnda, P., Firat, H., Garcia-Pons, F., Garcia, Z., Gourru, G., Vernant, J. P., et al.
(1998). Cytotoxic T cell response against the chimeric p210 BCR-ABL protein in
patients with chronic myelogenous leukemia. J. Clin. Investig. 101, 2290– 2296. doi:10.
1172/jci488
Zhang, P. J., Goldblum, J. R., Pawel, B. R., Fisher, C., Pasha, T. L., and Barr, F. G.
(2003). Immunophenotype of desmoplastic small round cell tumors as detected in cases
with EWS-WT1 gene fusion product. Mod. Pathol. 16, 229 – 235. doi:10.1097/01.Mp.
0000056630.76035.F3
Zhu, L., Keck, J., Stommel, J., Johnson, B., Corless, C. L., Ryan, C. W., et al. (2023).
Deep multi-omic analyses to identify targetable pathways in desmoplastic small round
cell tumor (DSRCT) with opportunities for clinical intervention. J. Clin. Oncol. 41,
e22006. doi:10.1200/JCO.2023.41.16_suppl.e22006
Zuco, V., Pasquali, S., Tortoreto, M., Percio, S., Doldi, V., Barisella, M., et al. (2023a).
Effectiveness of irinotecan plus trabectedin on a desmoplastic small round cell tumor
patient-derived xenograft. Dis. Model. Mech. 16, dmm049649. doi:10.1242/dmm.
049649
Zuco, V., Pasquali, S., Tortoreto, M., Percio, S., Doldi, V., Barisella, M., et al. (2023b).
Effectiveness of irinotecan plus trabectedin on a desmoplastic small round cell tumor
patient-derived xenograft. Dis. Models Mech. 16, dmm049649. doi:10.1242/
dmm.049649
