...
Claim extraction example output is checked in under
[`claim-extraction/Asthma.claims.csv`](claim-extraction/Asthma.claims.csv) and can
be regenerated with:

```bash
uv run dismech extract-claims kb/disorders/Asthma.yaml --out examples/claim-extraction/Asthma.claims.csv
```
