...
Boomer grounding analysis for [`kb/disorders/AFG2A-Related_Encephalopathy.yaml`](../../../../kb/disorders/AFG2A-Related_Encephalopathy.yaml).

- **Entry term:** [`MONDO:0014698`](http://purl.obolibrary.org/obo/MONDO_0014698) microcephaly-intellectual disability-sensorineural hearing loss-epilepsy-abnormal muscle tone syndrome
- **Grounded subtypes:** 0
