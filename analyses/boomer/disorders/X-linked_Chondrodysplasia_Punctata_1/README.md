...
Boomer grounding analysis for [`kb/disorders/X-linked_Chondrodysplasia_Punctata_1.yaml`](../../../../kb/disorders/X-linked_Chondrodysplasia_Punctata_1.yaml).

- **Entry term:** [`MONDO:0010555`](http://purl.obolibrary.org/obo/MONDO_0010555) X-linked chondrodysplasia punctata 1
- **Grounded subtypes:** 0
