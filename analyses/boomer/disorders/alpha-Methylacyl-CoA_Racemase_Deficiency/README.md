...
Boomer grounding analysis for [`kb/disorders/alpha-Methylacyl-CoA_Racemase_Deficiency.yaml`](../../../../kb/disorders/alpha-Methylacyl-CoA_Racemase_Deficiency.yaml).

- **Entry term:** [`MONDO:0013681`](http://purl.obolibrary.org/obo/MONDO_0013681) alpha-methylacyl-CoA racemase deficiency
- **Grounded subtypes:** 0
