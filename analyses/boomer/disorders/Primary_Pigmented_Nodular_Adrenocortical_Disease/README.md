...
Boomer grounding analysis for [`kb/disorders/Primary_Pigmented_Nodular_Adrenocortical_Disease.yaml`](../../../../kb/disorders/Primary_Pigmented_Nodular_Adrenocortical_Disease.yaml).

- **Entry term:** [`MONDO:0015999`](http://purl.obolibrary.org/obo/MONDO_0015999) primary pigmented nodular adrenocortical disease
- **Grounded subtypes:** 0
