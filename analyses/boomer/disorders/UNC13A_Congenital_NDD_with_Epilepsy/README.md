...
Boomer grounding analysis for [`kb/disorders/UNC13A_Congenital_NDD_with_Epilepsy.yaml`](../../../../kb/disorders/UNC13A_Congenital_NDD_with_Epilepsy.yaml).

- **Entry term:** [`MONDO:0980940`](http://purl.obolibrary.org/obo/MONDO_0980940) neurodevelopmental disorder with hypotonia, epilepsy, and absent speech
- **Grounded subtypes:** 0
