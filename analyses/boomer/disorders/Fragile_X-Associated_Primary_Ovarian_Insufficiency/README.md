...
Boomer grounding analysis for [`kb/disorders/Fragile_X-Associated_Primary_Ovarian_Insufficiency.yaml`](../../../../kb/disorders/Fragile_X-Associated_Primary_Ovarian_Insufficiency.yaml).

- **Entry term:** [`MONDO:0010706`](http://purl.obolibrary.org/obo/MONDO_0010706) premature ovarian failure 1
- **Grounded subtypes:** 0
