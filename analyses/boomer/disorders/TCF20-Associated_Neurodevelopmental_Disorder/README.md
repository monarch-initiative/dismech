...
Boomer grounding analysis for [`kb/disorders/TCF20-Associated_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/TCF20-Associated_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0032745`](http://purl.obolibrary.org/obo/MONDO_0032745) developmental delay with variable intellectual impairment and behavioral abnormalities
- **Grounded subtypes:** 0
