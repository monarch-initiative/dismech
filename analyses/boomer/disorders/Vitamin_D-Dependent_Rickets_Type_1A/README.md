...
Boomer grounding analysis for [`kb/disorders/Vitamin_D-Dependent_Rickets_Type_1A.yaml`](../../../../kb/disorders/Vitamin_D-Dependent_Rickets_Type_1A.yaml).

- **Entry term:** [`MONDO:0020723`](http://purl.obolibrary.org/obo/MONDO_0020723) vitamin D-dependent rickets, type 1A
- **Grounded subtypes:** 0
