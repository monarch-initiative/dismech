...
Boomer grounding analysis for [`kb/disorders/Multiple_Epiphyseal_Dysplasia_Al-Gazali_Type.yaml`](../../../../kb/disorders/Multiple_Epiphyseal_Dysplasia_Al-Gazali_Type.yaml).

- **Entry term:** [`MONDO:0011778`](http://purl.obolibrary.org/obo/MONDO_0011778) multiple epiphyseal dysplasia, Al-Gazali type
- **Grounded subtypes:** 0
