...
Boomer grounding analysis for [`kb/disorders/Spondyloepimetaphyseal_Dysplasia_Strudwick_Type.yaml`](../../../../kb/disorders/Spondyloepimetaphyseal_Dysplasia_Strudwick_Type.yaml).

- **Entry term:** [`MONDO:0008476`](http://purl.obolibrary.org/obo/MONDO_0008476) spondyloepimetaphyseal dysplasia, Strudwick type
- **Grounded subtypes:** 0
