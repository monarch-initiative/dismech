...
Boomer grounding analysis for [`kb/disorders/LAMB1-Related_Cobblestone_Lissencephaly.yaml`](../../../../kb/disorders/LAMB1-Related_Cobblestone_Lissencephaly.yaml).

- **Entry term:** [`MONDO:0014077`](http://purl.obolibrary.org/obo/MONDO_0014077) cobblestone lissencephaly without muscular or ocular involvement
- **Grounded subtypes:** 0
