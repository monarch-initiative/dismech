...
Boomer grounding analysis for [`kb/disorders/Neurodegeneration_Childhood-onset_With_Cerebellar_Atrophy.yaml`](../../../../kb/disorders/Neurodegeneration_Childhood-onset_With_Cerebellar_Atrophy.yaml).

- **Entry term:** [`MONDO:0032650`](http://purl.obolibrary.org/obo/MONDO_0032650) neurodegeneration, childhood-onset, with cerebellar atrophy
- **Grounded subtypes:** 0
