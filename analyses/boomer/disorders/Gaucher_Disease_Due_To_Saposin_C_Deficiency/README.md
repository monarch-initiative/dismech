...
Boomer grounding analysis for [`kb/disorders/Gaucher_Disease_Due_To_Saposin_C_Deficiency.yaml`](../../../../kb/disorders/Gaucher_Disease_Due_To_Saposin_C_Deficiency.yaml).

- **Entry term:** [`MONDO:0012517`](http://purl.obolibrary.org/obo/MONDO_0012517) Gaucher disease due to saposin C deficiency
- **Grounded subtypes:** 0
