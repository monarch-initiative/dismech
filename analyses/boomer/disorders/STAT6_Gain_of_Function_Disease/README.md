...
Boomer grounding analysis for [`kb/disorders/STAT6_Gain_of_Function_Disease.yaml`](../../../../kb/disorders/STAT6_Gain_of_Function_Disease.yaml).

- **Entry term:** [`MONDO:0957807`](http://purl.obolibrary.org/obo/MONDO_0957807) hyper-IgE syndrome 6, autosomal dominant, with recurrent infections
- **Grounded subtypes:** 0
