...
Boomer grounding analysis for [`kb/disorders/Familial_Focal_Epilepsy_With_Variable_Foci.yaml`](../../../../kb/disorders/Familial_Focal_Epilepsy_With_Variable_Foci.yaml).

- **Entry term:** [`MONDO:0020310`](http://purl.obolibrary.org/obo/MONDO_0020310) familial focal epilepsy with variable foci
- **Grounded subtypes:** 0
