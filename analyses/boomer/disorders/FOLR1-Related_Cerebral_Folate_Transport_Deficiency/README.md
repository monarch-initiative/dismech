...
Boomer grounding analysis for [`kb/disorders/FOLR1-Related_Cerebral_Folate_Transport_Deficiency.yaml`](../../../../kb/disorders/FOLR1-Related_Cerebral_Folate_Transport_Deficiency.yaml).

- **Entry term:** [`MONDO:0013110`](http://purl.obolibrary.org/obo/MONDO_0013110) neurodegenerative syndrome due to cerebral folate transport deficiency
- **Grounded subtypes:** 0
