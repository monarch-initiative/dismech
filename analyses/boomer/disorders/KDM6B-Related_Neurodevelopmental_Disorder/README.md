...
Boomer grounding analysis for [`kb/disorders/KDM6B-Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/KDM6B-Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0032790`](http://purl.obolibrary.org/obo/MONDO_0032790) neurodevelopmental disorder with coarse facies and mild distal skeletal abnormalities
- **Grounded subtypes:** 0
