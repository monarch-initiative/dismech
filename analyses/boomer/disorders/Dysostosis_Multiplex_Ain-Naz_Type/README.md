...
Boomer grounding analysis for [`kb/disorders/Dysostosis_Multiplex_Ain-Naz_Type.yaml`](../../../../kb/disorders/Dysostosis_Multiplex_Ain-Naz_Type.yaml).

- **Entry term:** [`MONDO:0859156`](http://purl.obolibrary.org/obo/MONDO_0859156) dysostosis multiplex, Ain-Naz type
- **Grounded subtypes:** 0
