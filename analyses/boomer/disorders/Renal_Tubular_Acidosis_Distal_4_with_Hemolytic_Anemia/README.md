...
Boomer grounding analysis for [`kb/disorders/Renal_Tubular_Acidosis_Distal_4_with_Hemolytic_Anemia.yaml`](../../../../kb/disorders/Renal_Tubular_Acidosis_Distal_4_with_Hemolytic_Anemia.yaml).

- **Entry term:** [`MONDO:0012700`](http://purl.obolibrary.org/obo/MONDO_0012700) renal tubular acidosis, distal, 4, with hemolytic anemia
- **Grounded subtypes:** 0
