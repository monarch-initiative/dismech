...
Boomer grounding analysis for [`kb/disorders/Biotin_Thiamine_Responsive_Basal_Ganglia_Disease.yaml`](../../../../kb/disorders/Biotin_Thiamine_Responsive_Basal_Ganglia_Disease.yaml).

- **Entry term:** [`MONDO:0011841`](http://purl.obolibrary.org/obo/MONDO_0011841) biotin-responsive basal ganglia disease
- **Grounded subtypes:** 0
