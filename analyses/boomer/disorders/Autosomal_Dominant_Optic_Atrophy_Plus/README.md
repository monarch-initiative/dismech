...
Boomer grounding analysis for [`kb/disorders/Autosomal_Dominant_Optic_Atrophy_Plus.yaml`](../../../../kb/disorders/Autosomal_Dominant_Optic_Atrophy_Plus.yaml).

- **Entry term:** [`MONDO:0014720`](http://purl.obolibrary.org/obo/MONDO_0014720) autosomal dominant optic atrophy plus syndrome
- **Grounded subtypes:** 0
