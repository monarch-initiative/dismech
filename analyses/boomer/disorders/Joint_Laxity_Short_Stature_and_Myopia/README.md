...
Boomer grounding analysis for [`kb/disorders/Joint_Laxity_Short_Stature_and_Myopia.yaml`](../../../../kb/disorders/Joint_Laxity_Short_Stature_and_Myopia.yaml).

- **Entry term:** [`MONDO:0060556`](http://purl.obolibrary.org/obo/MONDO_0060556) joint laxity, short stature, and myopia
- **Grounded subtypes:** 0
