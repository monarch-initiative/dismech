...
Boomer grounding analysis for [`kb/disorders/Retinitis_Pigmentosa_With_or_Without_Situs_Inversus.yaml`](../../../../kb/disorders/Retinitis_Pigmentosa_With_or_Without_Situs_Inversus.yaml).

- **Entry term:** [`MONDO:0014186`](http://purl.obolibrary.org/obo/MONDO_0014186) retinitis pigmentosa with or without situs inversus
- **Grounded subtypes:** 0
