...
Boomer grounding analysis for [`kb/disorders/3-Methylcrotonyl-CoA_Carboxylase_Deficiency.yaml`](../../../../kb/disorders/3-Methylcrotonyl-CoA_Carboxylase_Deficiency.yaml).

- **Entry term:** [`MONDO:0018950`](http://purl.obolibrary.org/obo/MONDO_0018950) 3-methylcrotonyl-CoA carboxylase deficiency
- **Grounded subtypes:** 0
