...
Boomer grounding analysis for [`kb/disorders/Peroxisome_Biogenesis_Disorder_4B.yaml`](../../../../kb/disorders/Peroxisome_Biogenesis_Disorder_4B.yaml).

- **Entry term:** [`MONDO:0013931`](http://purl.obolibrary.org/obo/MONDO_0013931) peroxisome biogenesis disorder 4B
- **Grounded subtypes:** 0
