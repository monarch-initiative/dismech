...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Ataxia_Beauce_Type.yaml`](../../../../kb/disorders/Autosomal_Recessive_Ataxia_Beauce_Type.yaml).

- **Entry term:** [`MONDO:0012549`](http://purl.obolibrary.org/obo/MONDO_0012549) autosomal recessive ataxia, Beauce type
- **Grounded subtypes:** 0
