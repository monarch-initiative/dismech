...
Boomer grounding analysis for [`kb/disorders/Neurodevelopmental_Disorder_with_Hypotonia_Feeding_Difficulties_Facial_Dysmorphism_and_Brain_Abnormalities.yaml`](../../../../kb/disorders/Neurodevelopmental_Disorder_with_Hypotonia_Feeding_Difficulties_Facial_Dysmorphism_and_Brain_Abnormalities.yaml).

- **Entry term:** [`MONDO:0971043`](http://purl.obolibrary.org/obo/MONDO_0971043) neurodevelopmental disorder with hypotonia, feeding difficulties, facial dysmorphism, and brain abnormalities
- **Grounded subtypes:** 0
