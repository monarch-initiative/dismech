...
Boomer grounding analysis for [`kb/disorders/TUBB_TUBB5-related_Microcephaly.yaml`](../../../../kb/disorders/TUBB_TUBB5-related_Microcephaly.yaml).

- **Entry term:** [`MONDO:0014341`](http://purl.obolibrary.org/obo/MONDO_0014341) complex cortical dysplasia with other brain malformations 6
- **Grounded subtypes:** 0
