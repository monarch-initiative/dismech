...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Cutis_Laxa_Type_2A.yaml`](../../../../kb/disorders/Autosomal_Recessive_Cutis_Laxa_Type_2A.yaml).

- **Entry term:** [`MONDO:0018163`](http://purl.obolibrary.org/obo/MONDO_0018163) autosomal recessive cutis laxa type 2A
- **Grounded subtypes:** 0
