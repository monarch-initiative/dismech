...
Boomer grounding analysis for [`kb/disorders/Cardiac_Valvular_Ehlers-Danlos_Syndrome.yaml`](../../../../kb/disorders/Cardiac_Valvular_Ehlers-Danlos_Syndrome.yaml).

- **Entry term:** [`MONDO:0009159`](http://purl.obolibrary.org/obo/MONDO_0009159) Ehlers-Danlos syndrome, cardiac valvular type
- **Grounded subtypes:** 0
