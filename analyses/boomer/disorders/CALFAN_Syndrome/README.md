...
Boomer grounding analysis for [`kb/disorders/CALFAN_Syndrome.yaml`](../../../../kb/disorders/CALFAN_Syndrome.yaml).

- **Entry term:** [`MONDO:0014744`](http://purl.obolibrary.org/obo/MONDO_0014744) acute infantile liver failure-cerebellar ataxia-peripheral sensory motor neuropathy syndrome
- **Grounded subtypes:** 0
