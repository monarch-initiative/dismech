...
Boomer grounding analysis for [`kb/disorders/Peroxisome_Biogenesis_Disorder_11A_Zellweger.yaml`](../../../../kb/disorders/Peroxisome_Biogenesis_Disorder_11A_Zellweger.yaml).

- **Entry term:** [`MONDO:0013949`](http://purl.obolibrary.org/obo/MONDO_0013949) peroxisome biogenesis disorder 11A (Zellweger)
- **Grounded subtypes:** 0
