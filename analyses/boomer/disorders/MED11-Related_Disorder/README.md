...
Boomer grounding analysis for [`kb/disorders/MED11-Related_Disorder.yaml`](../../../../kb/disorders/MED11-Related_Disorder.yaml).

- **Entry term:** [`MONDO:0957225`](http://purl.obolibrary.org/obo/MONDO_0957225) neurodegeneration with developmental delay, early respiratory failure, myoclonic seizures, and brain abnormalities
- **Grounded subtypes:** 0
