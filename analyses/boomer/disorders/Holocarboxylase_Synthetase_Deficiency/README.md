...
Boomer grounding analysis for [`kb/disorders/Holocarboxylase_Synthetase_Deficiency.yaml`](../../../../kb/disorders/Holocarboxylase_Synthetase_Deficiency.yaml).

- **Entry term:** [`MONDO:0009666`](http://purl.obolibrary.org/obo/MONDO_0009666) holocarboxylase synthetase deficiency
- **Grounded subtypes:** 0
