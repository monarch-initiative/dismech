...
Boomer grounding analysis for [`kb/disorders/Autosomal_Dominant_Cerebellar_Ataxia_Type_III.yaml`](../../../../kb/disorders/Autosomal_Dominant_Cerebellar_Ataxia_Type_III.yaml).

- **Entry term:** [`MONDO:0019793`](http://purl.obolibrary.org/obo/MONDO_0019793) autosomal dominant cerebellar ataxia type III
- **Grounded subtypes:** 0
