...
Boomer grounding analysis for [`kb/disorders/Adult_Polyglucosan_Body_Disease.yaml`](../../../../kb/disorders/Adult_Polyglucosan_Body_Disease.yaml).

- **Entry term:** [`MONDO:0009897`](http://purl.obolibrary.org/obo/MONDO_0009897) adult polyglucosan body disease
- **Grounded subtypes:** 0
