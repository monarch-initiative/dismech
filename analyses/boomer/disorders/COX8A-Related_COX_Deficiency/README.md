...
Boomer grounding analysis for [`kb/disorders/COX8A-Related_COX_Deficiency.yaml`](../../../../kb/disorders/COX8A-Related_COX_Deficiency.yaml).

- **Entry term:** [`MONDO:0033650`](http://purl.obolibrary.org/obo/MONDO_0033650) mitochondrial complex IV deficiency, nuclear type 15
- **Grounded subtypes:** 0
