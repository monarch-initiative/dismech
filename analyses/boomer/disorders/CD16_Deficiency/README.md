...
Boomer grounding analysis for [`kb/disorders/CD16_Deficiency.yaml`](../../../../kb/disorders/CD16_Deficiency.yaml).

- **Entry term:** [`MONDO:0014313`](http://purl.obolibrary.org/obo/MONDO_0014313) autosomal recessive primary immunodeficiency with defective spontaneous natural killer cell cytotoxicity
- **Grounded subtypes:** 0
