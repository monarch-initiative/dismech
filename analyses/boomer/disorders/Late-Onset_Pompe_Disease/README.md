...
Boomer grounding analysis for [`kb/disorders/Late-Onset_Pompe_Disease.yaml`](../../../../kb/disorders/Late-Onset_Pompe_Disease.yaml).

- **Entry term:** [`MONDO:0018485`](http://purl.obolibrary.org/obo/MONDO_0018485) glycogen storage disease due to acid maltase deficiency, late-onset
- **Grounded subtypes:** 0
