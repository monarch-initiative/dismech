...
Boomer grounding analysis for [`kb/disorders/Peroxisome_Biogenesis_Disorder_1B.yaml`](../../../../kb/disorders/Peroxisome_Biogenesis_Disorder_1B.yaml).

- **Entry term:** [`MONDO:0011101`](http://purl.obolibrary.org/obo/MONDO_0011101) peroxisome biogenesis disorder 1B
- **Grounded subtypes:** 0
