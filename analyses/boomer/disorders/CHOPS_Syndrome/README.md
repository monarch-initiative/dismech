...
Boomer grounding analysis for [`kb/disorders/CHOPS_Syndrome.yaml`](../../../../kb/disorders/CHOPS_Syndrome.yaml).

- **Entry term:** [`MONDO:0014609`](http://purl.obolibrary.org/obo/MONDO_0014609) cognitive impairment - coarse facies - heart defects - obesity - pulmonary involvement - short stature - skeletal dysplasia syndrome
- **Grounded subtypes:** 0
