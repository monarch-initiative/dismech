...
Boomer grounding analysis for [`kb/disorders/Congenital_Heart_Defects_Multiple_Types_2.yaml`](../../../../kb/disorders/Congenital_Heart_Defects_Multiple_Types_2.yaml).

- **Entry term:** [`MONDO:0014000`](http://purl.obolibrary.org/obo/MONDO_0014000) congenital heart defects, multiple types, 2
- **Grounded subtypes:** 0
