...
Boomer grounding analysis for [`kb/disorders/SDHA-Related_Neurodegeneration_With_Ataxia_And_Optic_Atrophy.yaml`](../../../../kb/disorders/SDHA-Related_Neurodegeneration_With_Ataxia_And_Optic_Atrophy.yaml).

- **Entry term:** [`MONDO:0031006`](http://purl.obolibrary.org/obo/MONDO_0031006) neurodegeneration with ataxia and late-onset optic atrophy
- **Grounded subtypes:** 0
