...
Boomer grounding analysis for [`kb/disorders/Hereditary_Neuropathy_with_Liability_to_Pressure_Palsies.yaml`](../../../../kb/disorders/Hereditary_Neuropathy_with_Liability_to_Pressure_Palsies.yaml).

- **Entry term:** [`MONDO:0008087`](http://purl.obolibrary.org/obo/MONDO_0008087) hereditary neuropathy with liability to pressure palsies
- **Grounded subtypes:** 0
