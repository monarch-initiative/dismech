...
Boomer grounding analysis for [`kb/disorders/X-linked_Chondrodysplasia_Punctata_2.yaml`](../../../../kb/disorders/X-linked_Chondrodysplasia_Punctata_2.yaml).

- **Entry term:** [`MONDO:0020603`](http://purl.obolibrary.org/obo/MONDO_0020603) X-linked chondrodysplasia punctata 2
- **Grounded subtypes:** 0
