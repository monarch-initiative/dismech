...
Boomer grounding analysis for [`kb/disorders/MED27-Related_Disorder.yaml`](../../../../kb/disorders/MED27-Related_Disorder.yaml).

- **Entry term:** [`MONDO:0859137`](http://purl.obolibrary.org/obo/MONDO_0859137) neurodevelopmental disorder with spasticity, cataracts, and cerebellar hypoplasia
- **Grounded subtypes:** 0
