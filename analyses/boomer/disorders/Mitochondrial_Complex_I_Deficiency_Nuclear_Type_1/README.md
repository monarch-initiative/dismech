...
Boomer grounding analysis for [`kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_1.yaml`](../../../../kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_1.yaml).

- **Entry term:** [`MONDO:0100224`](http://purl.obolibrary.org/obo/MONDO_0100224) mitochondrial complex I deficiency, nuclear type 1
- **Grounded subtypes:** 0
