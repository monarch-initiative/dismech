...
Boomer grounding analysis for [`kb/disorders/Multisystemic_Smooth_Muscle_Dysfunction_Syndrome.yaml`](../../../../kb/disorders/Multisystemic_Smooth_Muscle_Dysfunction_Syndrome.yaml).

- **Entry term:** [`MONDO:0013452`](http://purl.obolibrary.org/obo/MONDO_0013452) multisystemic smooth muscle dysfunction syndrome
- **Grounded subtypes:** 0
