...
Boomer grounding analysis for [`kb/disorders/Combined_Oxidative_Phosphorylation_Defect_Type_4.yaml`](../../../../kb/disorders/Combined_Oxidative_Phosphorylation_Defect_Type_4.yaml).

- **Entry term:** [`MONDO:0012534`](http://purl.obolibrary.org/obo/MONDO_0012534) combined oxidative phosphorylation defect type 4
- **Grounded subtypes:** 0
