...
Boomer grounding analysis for [`kb/disorders/TACO1-Related_COX_Deficiency.yaml`](../../../../kb/disorders/TACO1-Related_COX_Deficiency.yaml).

- **Entry term:** [`MONDO:0033638`](http://purl.obolibrary.org/obo/MONDO_0033638) mitochondrial complex IV deficiency, nuclear type 8
- **Grounded subtypes:** 0
