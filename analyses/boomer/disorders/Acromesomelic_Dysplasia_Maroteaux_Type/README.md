...
Boomer grounding analysis for [`kb/disorders/Acromesomelic_Dysplasia_Maroteaux_Type.yaml`](../../../../kb/disorders/Acromesomelic_Dysplasia_Maroteaux_Type.yaml).

- **Entry term:** [`MONDO:0011275`](http://purl.obolibrary.org/obo/MONDO_0011275) acromesomelic dysplasia 1, Maroteaux type
- **Grounded subtypes:** 0
