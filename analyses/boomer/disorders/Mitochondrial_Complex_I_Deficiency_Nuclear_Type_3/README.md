...
Boomer grounding analysis for [`kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_3.yaml`](../../../../kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_3.yaml).

- **Entry term:** [`MONDO:0032608`](http://purl.obolibrary.org/obo/MONDO_0032608) mitochondrial complex I deficiency, nuclear type 3
- **Grounded subtypes:** 0
