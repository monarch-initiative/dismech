...
Boomer grounding analysis for [`kb/disorders/X-linked_Dilated_Cardiomyopathy.yaml`](../../../../kb/disorders/X-linked_Dilated_Cardiomyopathy.yaml).

- **Entry term:** [`MONDO:0010542`](http://purl.obolibrary.org/obo/MONDO_0010542) dilated cardiomyopathy 3B
- **Grounded subtypes:** 0
