...
Boomer grounding analysis for [`kb/disorders/SETD5_Haploinsufficiency_Syndrome.yaml`](../../../../kb/disorders/SETD5_Haploinsufficiency_Syndrome.yaml).

- **Entry term:** [`MONDO:0014336`](http://purl.obolibrary.org/obo/MONDO_0014336) intellectual disability-facial dysmorphism syndrome due to SETD5 haploinsufficiency
- **Grounded subtypes:** 0
