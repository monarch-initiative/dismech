...
Boomer grounding analysis for [`kb/disorders/Combined_Immunodeficiency_Due_To_CTPS1_Deficiency.yaml`](../../../../kb/disorders/Combined_Immunodeficiency_Due_To_CTPS1_Deficiency.yaml).

- **Entry term:** [`MONDO:0014391`](http://purl.obolibrary.org/obo/MONDO_0014391) combined immunodeficiency due to CTPS1 deficiency
- **Grounded subtypes:** 0
