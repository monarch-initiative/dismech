...
Boomer grounding analysis for [`kb/disorders/TNF_Receptor-Associated_Periodic_Syndrome.yaml`](../../../../kb/disorders/TNF_Receptor-Associated_Periodic_Syndrome.yaml).

- **Entry term:** [`MONDO:0007727`](http://purl.obolibrary.org/obo/MONDO_0007727) TNF receptor 1-associated periodic fever syndrome
- **Grounded subtypes:** 0
