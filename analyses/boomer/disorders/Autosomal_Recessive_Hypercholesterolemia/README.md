...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Hypercholesterolemia.yaml`](../../../../kb/disorders/Autosomal_Recessive_Hypercholesterolemia.yaml).

- **Entry term:** [`MONDO:0011374`](http://purl.obolibrary.org/obo/MONDO_0011374) hypercholesterolemia, familial, 4
- **Grounded subtypes:** 0
