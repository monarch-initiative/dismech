...
Boomer grounding analysis for [`kb/disorders/Protein_S_Deficiency.yaml`](../../../../kb/disorders/Protein_S_Deficiency.yaml).

- **Entry term:** [`MONDO:0012868`](http://purl.obolibrary.org/obo/MONDO_0012868) thrombophilia due to protein S deficiency, autosomal dominant
- **Grounded subtypes:** 0
