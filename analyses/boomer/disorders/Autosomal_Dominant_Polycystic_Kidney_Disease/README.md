...
Boomer grounding analysis for [`kb/disorders/Autosomal_Dominant_Polycystic_Kidney_Disease.yaml`](../../../../kb/disorders/Autosomal_Dominant_Polycystic_Kidney_Disease.yaml).

- **Entry term:** [`MONDO:0004691`](http://purl.obolibrary.org/obo/MONDO_0004691) autosomal dominant polycystic kidney disease
- **Grounded subtypes:** 0
