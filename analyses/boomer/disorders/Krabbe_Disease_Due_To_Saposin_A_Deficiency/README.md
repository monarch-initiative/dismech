...
Boomer grounding analysis for [`kb/disorders/Krabbe_Disease_Due_To_Saposin_A_Deficiency.yaml`](../../../../kb/disorders/Krabbe_Disease_Due_To_Saposin_A_Deficiency.yaml).

- **Entry term:** [`MONDO:0012720`](http://purl.obolibrary.org/obo/MONDO_0012720) Krabbe disease due to saposin A deficiency
- **Grounded subtypes:** 0
