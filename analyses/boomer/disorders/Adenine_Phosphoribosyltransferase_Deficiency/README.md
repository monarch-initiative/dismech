...
Boomer grounding analysis for [`kb/disorders/Adenine_Phosphoribosyltransferase_Deficiency.yaml`](../../../../kb/disorders/Adenine_Phosphoribosyltransferase_Deficiency.yaml).

- **Entry term:** [`MONDO:0013869`](http://purl.obolibrary.org/obo/MONDO_0013869) adenine phosphoribosyltransferase deficiency
- **Grounded subtypes:** 0
