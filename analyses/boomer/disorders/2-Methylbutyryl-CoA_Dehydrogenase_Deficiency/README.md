...
Boomer grounding analysis for [`kb/disorders/2-Methylbutyryl-CoA_Dehydrogenase_Deficiency.yaml`](../../../../kb/disorders/2-Methylbutyryl-CoA_Dehydrogenase_Deficiency.yaml).

- **Entry term:** [`MONDO:0012392`](http://purl.obolibrary.org/obo/MONDO_0012392) 2-methylbutyryl-CoA dehydrogenase deficiency
- **Grounded subtypes:** 0
