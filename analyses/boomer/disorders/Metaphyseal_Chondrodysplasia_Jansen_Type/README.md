...
Boomer grounding analysis for [`kb/disorders/Metaphyseal_Chondrodysplasia_Jansen_Type.yaml`](../../../../kb/disorders/Metaphyseal_Chondrodysplasia_Jansen_Type.yaml).

- **Entry term:** [`MONDO:0007982`](http://purl.obolibrary.org/obo/MONDO_0007982) metaphyseal chondrodysplasia, Jansen type
- **Grounded subtypes:** 0
