...
Boomer grounding analysis for [`kb/disorders/Autosomal_Dominant_Osteopetrosis_Type_II.yaml`](../../../../kb/disorders/Autosomal_Dominant_Osteopetrosis_Type_II.yaml).

- **Entry term:** [`MONDO:0008156`](http://purl.obolibrary.org/obo/MONDO_0008156) autosomal dominant osteopetrosis 2
- **Grounded subtypes:** 0
