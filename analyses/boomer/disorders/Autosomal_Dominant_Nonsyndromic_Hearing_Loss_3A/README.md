...
Boomer grounding analysis for [`kb/disorders/Autosomal_Dominant_Nonsyndromic_Hearing_Loss_3A.yaml`](../../../../kb/disorders/Autosomal_Dominant_Nonsyndromic_Hearing_Loss_3A.yaml).

- **Entry term:** [`MONDO:0011103`](http://purl.obolibrary.org/obo/MONDO_0011103) autosomal dominant nonsyndromic hearing loss 3A
- **Grounded subtypes:** 0
