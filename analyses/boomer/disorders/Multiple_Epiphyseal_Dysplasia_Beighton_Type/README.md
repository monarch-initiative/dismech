...
Boomer grounding analysis for [`kb/disorders/Multiple_Epiphyseal_Dysplasia_Beighton_Type.yaml`](../../../../kb/disorders/Multiple_Epiphyseal_Dysplasia_Beighton_Type.yaml).

- **Entry term:** [`MONDO:0007562`](http://purl.obolibrary.org/obo/MONDO_0007562) multiple epiphyseal dysplasia, Beighton type
- **Grounded subtypes:** 0
