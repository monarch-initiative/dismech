...
Boomer grounding analysis for [`kb/disorders/G6PC3_Deficiency.yaml`](../../../../kb/disorders/G6PC3_Deficiency.yaml).

- **Entry term:** [`MONDO:0012930`](http://purl.obolibrary.org/obo/MONDO_0012930) autosomal recessive severe congenital neutropenia due to G6PC3 deficiency
- **Grounded subtypes:** 0
