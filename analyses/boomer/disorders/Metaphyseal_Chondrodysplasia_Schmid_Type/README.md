...
Boomer grounding analysis for [`kb/disorders/Metaphyseal_Chondrodysplasia_Schmid_Type.yaml`](../../../../kb/disorders/Metaphyseal_Chondrodysplasia_Schmid_Type.yaml).

- **Entry term:** [`MONDO:0007983`](http://purl.obolibrary.org/obo/MONDO_0007983) Schmid metaphyseal chondrodysplasia
- **Grounded subtypes:** 0
