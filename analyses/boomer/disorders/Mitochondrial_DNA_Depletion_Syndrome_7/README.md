...
Boomer grounding analysis for [`kb/disorders/Mitochondrial_DNA_Depletion_Syndrome_7.yaml`](../../../../kb/disorders/Mitochondrial_DNA_Depletion_Syndrome_7.yaml).

- **Entry term:** [`MONDO:0010060`](http://purl.obolibrary.org/obo/MONDO_0010060) mitochondrial DNA depletion syndrome 7 (hepatocerebral type)
- **Grounded subtypes:** 0
