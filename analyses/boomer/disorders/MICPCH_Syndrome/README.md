...
Boomer grounding analysis for [`kb/disorders/MICPCH_Syndrome.yaml`](../../../../kb/disorders/MICPCH_Syndrome.yaml).

- **Entry term:** [`MONDO:0010417`](http://purl.obolibrary.org/obo/MONDO_0010417) syndromic X-linked intellectual disability Najm type
- **Grounded subtypes:** 0
