...
Boomer grounding analysis for [`kb/disorders/Charcot-Marie-Tooth_Disease_Type_4B3.yaml`](../../../../kb/disorders/Charcot-Marie-Tooth_Disease_Type_4B3.yaml).

- **Entry term:** [`MONDO:0014117`](http://purl.obolibrary.org/obo/MONDO_0014117) Charcot-Marie-Tooth disease type 4B3
- **Grounded subtypes:** 0
