...
Boomer grounding analysis for [`kb/disorders/NAD_P_HX_Dehydratase_Deficiency.yaml`](../../../../kb/disorders/NAD_P_HX_Dehydratase_Deficiency.yaml).

- **Entry term:** [`MONDO:0034121`](http://purl.obolibrary.org/obo/MONDO_0034121) NAD(P)HX dehydratase deficiency
- **Grounded subtypes:** 0
