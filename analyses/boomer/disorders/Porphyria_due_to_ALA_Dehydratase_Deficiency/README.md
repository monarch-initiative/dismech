...
Boomer grounding analysis for [`kb/disorders/Porphyria_due_to_ALA_Dehydratase_Deficiency.yaml`](../../../../kb/disorders/Porphyria_due_to_ALA_Dehydratase_Deficiency.yaml).

- **Entry term:** [`MONDO:0013000`](http://purl.obolibrary.org/obo/MONDO_0013000) porphyria due to ALA dehydratase deficiency
- **Grounded subtypes:** 0
