...
Boomer grounding analysis for [`kb/disorders/Spondylometaphyseal_Dysplasia_Corner_Fracture_Type.yaml`](../../../../kb/disorders/Spondylometaphyseal_Dysplasia_Corner_Fracture_Type.yaml).

- **Entry term:** [`MONDO:0008479`](http://purl.obolibrary.org/obo/MONDO_0008479) spondylometaphyseal dysplasia, 'corner fracture' type
- **Grounded subtypes:** 0
