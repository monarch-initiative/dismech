...
Boomer grounding analysis for [`kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_2.yaml`](../../../../kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_2.yaml).

- **Entry term:** [`MONDO:0032606`](http://purl.obolibrary.org/obo/MONDO_0032606) mitochondrial complex I deficiency, nuclear type 2
- **Grounded subtypes:** 0
