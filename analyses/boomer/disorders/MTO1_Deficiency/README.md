...
Boomer grounding analysis for [`kb/disorders/MTO1_Deficiency.yaml`](../../../../kb/disorders/MTO1_Deficiency.yaml).

- **Entry term:** [`MONDO:0013865`](http://purl.obolibrary.org/obo/MONDO_0013865) mitochondrial hypertrophic cardiomyopathy with lactic acidosis due to MTO1 deficiency
- **Grounded subtypes:** 0
