...
Boomer grounding analysis for [`kb/disorders/Hereditary_Diffuse_Leukoencephalopathy_with_Spheroids.yaml`](../../../../kb/disorders/Hereditary_Diffuse_Leukoencephalopathy_with_Spheroids.yaml).

- **Entry term:** [`MONDO:0800027`](http://purl.obolibrary.org/obo/MONDO_0800027) leukoencephalopathy, diffuse hereditary, with spheroids 1
- **Grounded subtypes:** 0
