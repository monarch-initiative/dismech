...
Boomer grounding analysis for [`kb/disorders/TUBA8-related_Polymicrogyria_with_Optic_Nerve_Hypoplasia.yaml`](../../../../kb/disorders/TUBA8-related_Polymicrogyria_with_Optic_Nerve_Hypoplasia.yaml).

- **Entry term:** [`MONDO:0013172`](http://purl.obolibrary.org/obo/MONDO_0013172) polymicrogyria with optic nerve hypoplasia
- **Grounded subtypes:** 0
