...
Boomer grounding analysis for [`kb/disorders/SLC6A1-Related_Disorder.yaml`](../../../../kb/disorders/SLC6A1-Related_Disorder.yaml).

- **Entry term:** [`MONDO:0014633`](http://purl.obolibrary.org/obo/MONDO_0014633) epilepsy with myoclonic atonic seizures
- **Grounded subtypes:** 0
