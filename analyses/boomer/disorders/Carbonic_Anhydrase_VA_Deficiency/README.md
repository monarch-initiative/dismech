...
Boomer grounding analysis for [`kb/disorders/Carbonic_Anhydrase_VA_Deficiency.yaml`](../../../../kb/disorders/Carbonic_Anhydrase_VA_Deficiency.yaml).

- **Entry term:** [`MONDO:0014332`](http://purl.obolibrary.org/obo/MONDO_0014332) hyperammonemic encephalopathy due to carbonic anhydrase VA deficiency
- **Grounded subtypes:** 0
