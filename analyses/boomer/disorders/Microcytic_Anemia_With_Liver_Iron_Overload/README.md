...
Boomer grounding analysis for [`kb/disorders/Microcytic_Anemia_With_Liver_Iron_Overload.yaml`](../../../../kb/disorders/Microcytic_Anemia_With_Liver_Iron_Overload.yaml).

- **Entry term:** [`MONDO:0008787`](http://purl.obolibrary.org/obo/MONDO_0008787) microcytic anemia with liver iron overload
- **Grounded subtypes:** 0
