...
Boomer grounding analysis for [`kb/disorders/PHF21A_Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/PHF21A_Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0032883`](http://purl.obolibrary.org/obo/MONDO_0032883) intellectual developmental disorder with behavioral abnormalities and craniofacial dysmorphism with or without seizures
- **Grounded subtypes:** 0
