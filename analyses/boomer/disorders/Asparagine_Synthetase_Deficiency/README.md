...
Boomer grounding analysis for [`kb/disorders/Asparagine_Synthetase_Deficiency.yaml`](../../../../kb/disorders/Asparagine_Synthetase_Deficiency.yaml).

- **Entry term:** [`MONDO:0014258`](http://purl.obolibrary.org/obo/MONDO_0014258) congenital microcephaly - severe encephalopathy - progressive cerebral atrophy syndrome
- **Grounded subtypes:** 0
