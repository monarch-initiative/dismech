...
Boomer grounding analysis for [`kb/disorders/ADPRS-Related_Stress-Induced_Neurodegeneration.yaml`](../../../../kb/disorders/ADPRS-Related_Stress-Induced_Neurodegeneration.yaml).

- **Entry term:** [`MONDO:0100095`](http://purl.obolibrary.org/obo/MONDO_0100095) neurodegeneration, childhood-onset, stress-induced, with variable ataxia and seizures
- **Grounded subtypes:** 0
