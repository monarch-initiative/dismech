...
Boomer grounding analysis for [`kb/disorders/3-Hydroxy-3-Methylglutaric_Aciduria.yaml`](../../../../kb/disorders/3-Hydroxy-3-Methylglutaric_Aciduria.yaml).

- **Entry term:** [`MONDO:0009520`](http://purl.obolibrary.org/obo/MONDO_0009520) 3-hydroxy-3-methylglutaric aciduria
- **Grounded subtypes:** 0
