...
Boomer grounding analysis for [`kb/disorders/PDE6A-Related_Retinopathy.yaml`](../../../../kb/disorders/PDE6A-Related_Retinopathy.yaml).

- **Entry term:** [`MONDO:0700224`](http://purl.obolibrary.org/obo/MONDO_0700224) PDE6A-related retinopathy
- **Grounded subtypes:** 0
