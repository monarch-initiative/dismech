...
Boomer grounding analysis for [`kb/disorders/SNIP1-Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/SNIP1-Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0013787`](http://purl.obolibrary.org/obo/MONDO_0013787) psychomotor retardation, epilepsy, and craniofacial dysmorphism
- **Grounded subtypes:** 0
