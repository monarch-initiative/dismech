...
Boomer grounding analysis for [`kb/disorders/COX6B1-Related_COX_Deficiency.yaml`](../../../../kb/disorders/COX6B1-Related_COX_Deficiency.yaml).

- **Entry term:** [`MONDO:0033637`](http://purl.obolibrary.org/obo/MONDO_0033637) mitochondrial complex IV deficiency, nuclear type 7
- **Grounded subtypes:** 0
