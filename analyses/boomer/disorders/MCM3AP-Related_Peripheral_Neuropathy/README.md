...
Boomer grounding analysis for [`kb/disorders/MCM3AP-Related_Peripheral_Neuropathy.yaml`](../../../../kb/disorders/MCM3AP-Related_Peripheral_Neuropathy.yaml).

- **Entry term:** [`MONDO:0029131`](http://purl.obolibrary.org/obo/MONDO_0029131) peripheral neuropathy, autosomal recessive, with or without impaired intellectual development
- **Grounded subtypes:** 0
