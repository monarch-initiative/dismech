...
Boomer grounding analysis for [`kb/disorders/Peroxisome_Biogenesis_Disorder_4A_Zellweger.yaml`](../../../../kb/disorders/Peroxisome_Biogenesis_Disorder_4A_Zellweger.yaml).

- **Entry term:** [`MONDO:0013930`](http://purl.obolibrary.org/obo/MONDO_0013930) peroxisome biogenesis disorder 4A (Zellweger)
- **Grounded subtypes:** 0
