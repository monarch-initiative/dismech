...
Boomer grounding analysis for [`kb/disorders/Peroxisome_Biogenesis_Disorder_3A_Zellweger.yaml`](../../../../kb/disorders/Peroxisome_Biogenesis_Disorder_3A_Zellweger.yaml).

- **Entry term:** [`MONDO:0013927`](http://purl.obolibrary.org/obo/MONDO_0013927) peroxisome biogenesis disorder 3A (Zellweger)
- **Grounded subtypes:** 0
