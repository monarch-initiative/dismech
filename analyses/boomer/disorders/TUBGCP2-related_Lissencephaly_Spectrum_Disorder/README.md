...
Boomer grounding analysis for [`kb/disorders/TUBGCP2-related_Lissencephaly_Spectrum_Disorder.yaml`](../../../../kb/disorders/TUBGCP2-related_Lissencephaly_Spectrum_Disorder.yaml).

- **Entry term:** [`MONDO:0032893`](http://purl.obolibrary.org/obo/MONDO_0032893) pachygyria, microcephaly, developmental delay, and dysmorphic facies, with or without seizures
- **Grounded subtypes:** 0
