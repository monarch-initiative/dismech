...
Boomer grounding analysis for [`kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_6.yaml`](../../../../kb/disorders/Mitochondrial_Complex_I_Deficiency_Nuclear_Type_6.yaml).

- **Entry term:** [`MONDO:0032611`](http://purl.obolibrary.org/obo/MONDO_0032611) mitochondrial complex I deficiency, nuclear type 6
- **Grounded subtypes:** 0
