...
Boomer grounding analysis for [`kb/disorders/NELABA.yaml`](../../../../kb/disorders/NELABA.yaml).

- **Entry term:** [`MONDO:0060562`](http://purl.obolibrary.org/obo/MONDO_0060562) encephalopathy, neonatal severe, with lactic acidosis and brain abnormalities
- **Grounded subtypes:** 0
