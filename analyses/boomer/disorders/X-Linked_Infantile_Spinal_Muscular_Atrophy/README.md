...
Boomer grounding analysis for [`kb/disorders/X-Linked_Infantile_Spinal_Muscular_Atrophy.yaml`](../../../../kb/disorders/X-Linked_Infantile_Spinal_Muscular_Atrophy.yaml).

- **Entry term:** [`MONDO:0010532`](http://purl.obolibrary.org/obo/MONDO_0010532) infantile-onset X-linked spinal muscular atrophy
- **Grounded subtypes:** 0
