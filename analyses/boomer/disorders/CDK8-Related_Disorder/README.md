...
Boomer grounding analysis for [`kb/disorders/CDK8-Related_Disorder.yaml`](../../../../kb/disorders/CDK8-Related_Disorder.yaml).

- **Entry term:** [`MONDO:0032897`](http://purl.obolibrary.org/obo/MONDO_0032897) intellectual developmental disorder with hypotonia and behavioral abnormalities
- **Grounded subtypes:** 0
