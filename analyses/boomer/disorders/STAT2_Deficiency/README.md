...
Boomer grounding analysis for [`kb/disorders/STAT2_Deficiency.yaml`](../../../../kb/disorders/STAT2_Deficiency.yaml).

- **Entry term:** [`MONDO:0014715`](http://purl.obolibrary.org/obo/MONDO_0014715) primary immunodeficiency with post-measles-mumps-rubella vaccine viral infection
- **Grounded subtypes:** 0
