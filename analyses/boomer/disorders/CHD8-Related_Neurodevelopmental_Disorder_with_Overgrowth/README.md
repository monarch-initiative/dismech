...
Boomer grounding analysis for [`kb/disorders/CHD8-Related_Neurodevelopmental_Disorder_with_Overgrowth.yaml`](../../../../kb/disorders/CHD8-Related_Neurodevelopmental_Disorder_with_Overgrowth.yaml).

- **Entry term:** [`MONDO:0014017`](http://purl.obolibrary.org/obo/MONDO_0014017) intellectual developmental disorder with autism and macrocephaly
- **Grounded subtypes:** 0
