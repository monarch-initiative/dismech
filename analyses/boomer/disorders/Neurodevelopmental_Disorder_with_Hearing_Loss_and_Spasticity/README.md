...
Boomer grounding analysis for [`kb/disorders/Neurodevelopmental_Disorder_with_Hearing_Loss_and_Spasticity.yaml`](../../../../kb/disorders/Neurodevelopmental_Disorder_with_Hearing_Loss_and_Spasticity.yaml).

- **Entry term:** [`MONDO:0859206`](http://purl.obolibrary.org/obo/MONDO_0859206) neurodevelopmental disorder with hearing loss and spasticity
- **Grounded subtypes:** 0
