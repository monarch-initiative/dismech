...
Boomer grounding analysis for [`kb/disorders/X-linked_Dystonia-Parkinsonism.yaml`](../../../../kb/disorders/X-linked_Dystonia-Parkinsonism.yaml).

- **Entry term:** [`MONDO:0010747`](http://purl.obolibrary.org/obo/MONDO_0010747) X-linked dystonia-parkinsonism
- **Grounded subtypes:** 0
