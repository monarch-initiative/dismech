...
Boomer grounding analysis for [`kb/disorders/Charcot-Marie-Tooth_Disease_Axonal_Type_2P.yaml`](../../../../kb/disorders/Charcot-Marie-Tooth_Disease_Axonal_Type_2P.yaml).

- **Entry term:** [`MONDO:0013753`](http://purl.obolibrary.org/obo/MONDO_0013753) Charcot-Marie-Tooth disease axonal type 2P
- **Grounded subtypes:** 0
