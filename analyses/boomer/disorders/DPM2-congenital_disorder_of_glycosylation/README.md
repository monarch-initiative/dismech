...
Boomer grounding analysis for [`kb/disorders/DPM2-congenital_disorder_of_glycosylation.yaml`](../../../../kb/disorders/DPM2-congenital_disorder_of_glycosylation.yaml).

- **Entry term:** [`MONDO:0014023`](http://purl.obolibrary.org/obo/MONDO_0014023) congenital muscular dystrophy with intellectual disability and severe epilepsy
- **Grounded subtypes:** 0
