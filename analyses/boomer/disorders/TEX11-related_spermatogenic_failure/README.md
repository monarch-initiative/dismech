...
Boomer grounding analysis for [`kb/disorders/TEX11-related_spermatogenic_failure.yaml`](../../../../kb/disorders/TEX11-related_spermatogenic_failure.yaml).

- **Entry term:** [`MONDO:0010647`](http://purl.obolibrary.org/obo/MONDO_0010647) spermatogenic failure, X-linked, 2
- **Grounded subtypes:** 0
