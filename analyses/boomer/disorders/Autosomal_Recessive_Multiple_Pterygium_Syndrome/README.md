...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Multiple_Pterygium_Syndrome.yaml`](../../../../kb/disorders/Autosomal_Recessive_Multiple_Pterygium_Syndrome.yaml).

- **Entry term:** [`MONDO:0009926`](http://purl.obolibrary.org/obo/MONDO_0009926) autosomal recessive multiple pterygium syndrome
- **Grounded subtypes:** 0
