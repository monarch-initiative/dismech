...
Boomer grounding analysis for [`kb/disorders/X-linked_Retinoschisis.yaml`](../../../../kb/disorders/X-linked_Retinoschisis.yaml).

- **Entry term:** [`MONDO:0010725`](http://purl.obolibrary.org/obo/MONDO_0010725) X-linked retinoschisis
- **Grounded subtypes:** 0
