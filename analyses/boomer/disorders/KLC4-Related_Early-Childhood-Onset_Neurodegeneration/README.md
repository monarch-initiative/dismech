...
Boomer grounding analysis for [`kb/disorders/KLC4-Related_Early-Childhood-Onset_Neurodegeneration.yaml`](../../../../kb/disorders/KLC4-Related_Early-Childhood-Onset_Neurodegeneration.yaml).

- **Entry term:** [`MONDO:0700288`](http://purl.obolibrary.org/obo/MONDO_0700288) early-childhood-onset neurodegeneration with retinitis pigmentosa, sensorineural hearing loss, and demyelinating peripheral neuropathy
- **Grounded subtypes:** 0
