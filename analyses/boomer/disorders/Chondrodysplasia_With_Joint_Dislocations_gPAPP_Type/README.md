...
Boomer grounding analysis for [`kb/disorders/Chondrodysplasia_With_Joint_Dislocations_gPAPP_Type.yaml`](../../../../kb/disorders/Chondrodysplasia_With_Joint_Dislocations_gPAPP_Type.yaml).

- **Entry term:** [`MONDO:0013561`](http://purl.obolibrary.org/obo/MONDO_0013561) chondrodysplasia with joint dislocations, gPAPP type
- **Grounded subtypes:** 0
