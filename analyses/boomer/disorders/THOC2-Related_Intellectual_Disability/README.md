...
Boomer grounding analysis for [`kb/disorders/THOC2-Related_Intellectual_Disability.yaml`](../../../../kb/disorders/THOC2-Related_Intellectual_Disability.yaml).

- **Entry term:** [`MONDO:0010496`](http://purl.obolibrary.org/obo/MONDO_0010496) X-linked intellectual disability-short stature-overweight syndrome
- **Grounded subtypes:** 0
