...
Boomer grounding analysis for [`kb/disorders/Mitochondrial_Complex_V_ATP_Synthase_Deficiency_Nuclear_Type_3.yaml`](../../../../kb/disorders/Mitochondrial_Complex_V_ATP_Synthase_Deficiency_Nuclear_Type_3.yaml).

- **Entry term:** [`MONDO:0013547`](http://purl.obolibrary.org/obo/MONDO_0013547) mitochondrial complex V (ATP synthase) deficiency, nuclear type 3
- **Grounded subtypes:** 0
