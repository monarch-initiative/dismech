...
Boomer grounding analysis for [`kb/disorders/SARS1-Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/SARS1-Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0060577`](http://purl.obolibrary.org/obo/MONDO_0060577) neurodevelopmental disorder with microcephaly, ataxia, and seizures
- **Grounded subtypes:** 0
