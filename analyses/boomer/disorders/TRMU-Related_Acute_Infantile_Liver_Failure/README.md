...
Boomer grounding analysis for [`kb/disorders/TRMU-Related_Acute_Infantile_Liver_Failure.yaml`](../../../../kb/disorders/TRMU-Related_Acute_Infantile_Liver_Failure.yaml).

- **Entry term:** [`MONDO:0013111`](http://purl.obolibrary.org/obo/MONDO_0013111) acute infantile liver failure due to synthesis defect of mtDNA-encoded proteins
- **Grounded subtypes:** 0
