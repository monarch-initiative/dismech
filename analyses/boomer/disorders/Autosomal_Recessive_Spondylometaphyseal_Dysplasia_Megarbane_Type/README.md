...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Spondylometaphyseal_Dysplasia_Megarbane_Type.yaml`](../../../../kb/disorders/Autosomal_Recessive_Spondylometaphyseal_Dysplasia_Megarbane_Type.yaml).

- **Entry term:** [`MONDO:0013223`](http://purl.obolibrary.org/obo/MONDO_0013223) autosomal recessive spondylometaphyseal dysplasia, Megarbane type
- **Grounded subtypes:** 0
