...
Boomer grounding analysis for [`kb/disorders/Peroxisome_Biogenesis_Disorder_2B.yaml`](../../../../kb/disorders/Peroxisome_Biogenesis_Disorder_2B.yaml).

- **Entry term:** [`MONDO:0008736`](http://purl.obolibrary.org/obo/MONDO_0008736) peroxisome biogenesis disorder 2B
- **Grounded subtypes:** 0
