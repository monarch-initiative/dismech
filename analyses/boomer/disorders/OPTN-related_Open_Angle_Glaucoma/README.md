...
Boomer grounding analysis for [`kb/disorders/OPTN-related_Open_Angle_Glaucoma.yaml`](../../../../kb/disorders/OPTN-related_Open_Angle_Glaucoma.yaml).

- **Entry term:** [`MONDO:0100553`](http://purl.obolibrary.org/obo/MONDO_0100553) OPTN-related open angle glaucoma
- **Grounded subtypes:** 0
