...
Boomer grounding analysis for [`kb/disorders/DTYMK-Related_Neurodegeneration.yaml`](../../../../kb/disorders/DTYMK-Related_Neurodegeneration.yaml).

- **Entry term:** [`MONDO:0859241`](http://purl.obolibrary.org/obo/MONDO_0859241) neurodegeneration, childhood-onset, with progressive microcephaly
- **Grounded subtypes:** 0
