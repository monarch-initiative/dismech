...
Boomer grounding analysis for [`kb/disorders/COX6A2-Related_COX_Deficiency.yaml`](../../../../kb/disorders/COX6A2-Related_COX_Deficiency.yaml).

- **Entry term:** [`MONDO:0033653`](http://purl.obolibrary.org/obo/MONDO_0033653) mitochondrial complex IV deficiency, nuclear type 18
- **Grounded subtypes:** 0
