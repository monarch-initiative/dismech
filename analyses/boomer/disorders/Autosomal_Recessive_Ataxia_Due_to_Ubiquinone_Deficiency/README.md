...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Ataxia_Due_to_Ubiquinone_Deficiency.yaml`](../../../../kb/disorders/Autosomal_Recessive_Ataxia_Due_to_Ubiquinone_Deficiency.yaml).

- **Entry term:** [`MONDO:0012784`](http://purl.obolibrary.org/obo/MONDO_0012784) autosomal recessive ataxia due to ubiquinone deficiency
- **Grounded subtypes:** 0
