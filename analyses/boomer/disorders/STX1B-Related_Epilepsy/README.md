...
Boomer grounding analysis for [`kb/disorders/STX1B-Related_Epilepsy.yaml`](../../../../kb/disorders/STX1B-Related_Epilepsy.yaml).

- **Entry term:** [`MONDO:0014517`](http://purl.obolibrary.org/obo/MONDO_0014517) generalized epilepsy with febrile seizures plus, type 9
- **Grounded subtypes:** 0
