...
Boomer grounding analysis for [`kb/disorders/RUNX1_Familial_Platelet_Disorder.yaml`](../../../../kb/disorders/RUNX1_Familial_Platelet_Disorder.yaml).

- **Entry term:** [`MONDO:0100083`](http://purl.obolibrary.org/obo/MONDO_0100083) hereditary thrombocytopenia and hematological cancer predisposition syndrome associated with RUNX1
- **Grounded subtypes:** 0
