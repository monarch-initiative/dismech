...
Boomer grounding analysis for [`kb/disorders/Duane_Retraction_Syndrome_3_With_Or_Without_Deafness.yaml`](../../../../kb/disorders/Duane_Retraction_Syndrome_3_With_Or_Without_Deafness.yaml).

- **Entry term:** [`MONDO:0014880`](http://purl.obolibrary.org/obo/MONDO_0014880) Duane retraction syndrome 3 with or without deafness
- **Grounded subtypes:** 0
