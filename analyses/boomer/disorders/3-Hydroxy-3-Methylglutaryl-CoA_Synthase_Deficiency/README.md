...
Boomer grounding analysis for [`kb/disorders/3-Hydroxy-3-Methylglutaryl-CoA_Synthase_Deficiency.yaml`](../../../../kb/disorders/3-Hydroxy-3-Methylglutaryl-CoA_Synthase_Deficiency.yaml).

- **Entry term:** [`MONDO:0011614`](http://purl.obolibrary.org/obo/MONDO_0011614) 3-hydroxy-3-methylglutaryl-CoA synthase deficiency
- **Grounded subtypes:** 0
