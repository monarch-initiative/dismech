# MSTO1-Related Mitochondrial Myopathy

Boomer grounding analysis for [`kb/disorders/MSTO1-Related_Mitochondrial_Myopathy.yaml`](../../../../kb/disorders/MSTO1-Related_Mitochondrial_Myopathy.yaml).

- **Entry term:** [`MONDO:0044714`](http://purl.obolibrary.org/obo/MONDO_0044714) mitochondrial myopathy-cerebellar ataxia-pigmentary retinopathy syndrome
- **Grounded subtypes:** 0
