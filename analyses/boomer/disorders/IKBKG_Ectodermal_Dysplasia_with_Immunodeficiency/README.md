...
Boomer grounding analysis for [`kb/disorders/IKBKG_Ectodermal_Dysplasia_with_Immunodeficiency.yaml`](../../../../kb/disorders/IKBKG_Ectodermal_Dysplasia_with_Immunodeficiency.yaml).

- **Entry term:** [`MONDO:0100162`](http://purl.obolibrary.org/obo/MONDO_0100162) IKBKG-related immunodeficiency with or without ectodermal dysplasia
- **Grounded subtypes:** 0
