...
Boomer grounding analysis for [`kb/disorders/MEPAN_Syndrome.yaml`](../../../../kb/disorders/MEPAN_Syndrome.yaml).

- **Entry term:** [`MONDO:0015003`](http://purl.obolibrary.org/obo/MONDO_0015003) dystonia, childhood-onset, with optic atrophy and basal ganglia abnormalities
- **Grounded subtypes:** 0
