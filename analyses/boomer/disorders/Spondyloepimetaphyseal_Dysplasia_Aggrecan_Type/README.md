...
Boomer grounding analysis for [`kb/disorders/Spondyloepimetaphyseal_Dysplasia_Aggrecan_Type.yaml`](../../../../kb/disorders/Spondyloepimetaphyseal_Dysplasia_Aggrecan_Type.yaml).

- **Entry term:** [`MONDO:0013014`](http://purl.obolibrary.org/obo/MONDO_0013014) spondyloepimetaphyseal dysplasia, aggrecan type
- **Grounded subtypes:** 0
