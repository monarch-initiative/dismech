...
Boomer grounding analysis for [`kb/disorders/KDM1A-Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/KDM1A-Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0014751`](http://purl.obolibrary.org/obo/MONDO_0014751) palatal anomalies-widely spaced teeth-facial dysmorphism-developmental delay syndrome
- **Grounded subtypes:** 0
