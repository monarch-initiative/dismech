...
Boomer grounding analysis for [`kb/disorders/Bainbridge-Ropers_Syndrome.yaml`](../../../../kb/disorders/Bainbridge-Ropers_Syndrome.yaml).

- **Entry term:** [`MONDO:0014205`](http://purl.obolibrary.org/obo/MONDO_0014205) severe feeding difficulties-failure to thrive-microcephaly due to ASXL3 deficiency syndrome
- **Grounded subtypes:** 0
