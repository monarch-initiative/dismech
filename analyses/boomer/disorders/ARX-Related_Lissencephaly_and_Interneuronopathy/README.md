...
Boomer grounding analysis for [`kb/disorders/ARX-Related_Lissencephaly_and_Interneuronopathy.yaml`](../../../../kb/disorders/ARX-Related_Lissencephaly_and_Interneuronopathy.yaml).

- **Entry term:** [`MONDO:0010268`](http://purl.obolibrary.org/obo/MONDO_0010268) X-linked lissencephaly with abnormal genitalia
- **Grounded subtypes:** 0
