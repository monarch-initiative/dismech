...
Boomer grounding analysis for [`kb/disorders/X-Linked_Hypophosphatemia.yaml`](../../../../kb/disorders/X-Linked_Hypophosphatemia.yaml).

- **Entry term:** [`MONDO:0010619`](http://purl.obolibrary.org/obo/MONDO_0010619) X-linked dominant hypophosphatemic rickets
- **Grounded subtypes:** 0
