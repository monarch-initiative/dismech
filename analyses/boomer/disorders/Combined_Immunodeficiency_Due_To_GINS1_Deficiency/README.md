...
Boomer grounding analysis for [`kb/disorders/Combined_Immunodeficiency_Due_To_GINS1_Deficiency.yaml`](../../../../kb/disorders/Combined_Immunodeficiency_Due_To_GINS1_Deficiency.yaml).

- **Entry term:** [`MONDO:0044725`](http://purl.obolibrary.org/obo/MONDO_0044725) combined immunodeficiency due to GINS1 deficiency
- **Grounded subtypes:** 0
