...
Boomer grounding analysis for [`kb/disorders/Generalized_Resistance_to_Thyroid_Hormone.yaml`](../../../../kb/disorders/Generalized_Resistance_to_Thyroid_Hormone.yaml).

- **Entry term:** [`MONDO:0009043`](http://purl.obolibrary.org/obo/MONDO_0009043) generalized resistance to thyroid hormone
- **Grounded subtypes:** 0
