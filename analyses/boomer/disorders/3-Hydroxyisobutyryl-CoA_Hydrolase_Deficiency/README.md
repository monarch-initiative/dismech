...
Boomer grounding analysis for [`kb/disorders/3-Hydroxyisobutyryl-CoA_Hydrolase_Deficiency.yaml`](../../../../kb/disorders/3-Hydroxyisobutyryl-CoA_Hydrolase_Deficiency.yaml).

- **Entry term:** [`MONDO:0009603`](http://purl.obolibrary.org/obo/MONDO_0009603) 3-hydroxyisobutyryl-CoA hydrolase deficiency
- **Grounded subtypes:** 0
