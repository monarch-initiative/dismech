...
Boomer grounding analysis for [`kb/disorders/CAPRIN1_Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/CAPRIN1_Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0968945`](http://purl.obolibrary.org/obo/MONDO_0968945) neurodevelopmental disorder with language impairment, autism, and attention deficit-hyperactivity disorder
- **Grounded subtypes:** 0
