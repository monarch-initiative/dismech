...
Boomer grounding analysis for [`kb/disorders/Spondylometaphyseal_Dysplasia_Kozlowski_Type.yaml`](../../../../kb/disorders/Spondylometaphyseal_Dysplasia_Kozlowski_Type.yaml).

- **Entry term:** [`MONDO:0008477`](http://purl.obolibrary.org/obo/MONDO_0008477) spondylometaphyseal dysplasia, Kozlowski type
- **Grounded subtypes:** 0
