# THUMPD1-Related Neurodevelopmental Disorder with Speech Delay and Variable Ocular Anomalies

Boomer grounding analysis for [`kb/disorders/THUMPD1-Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/THUMPD1-Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0859272`](http://purl.obolibrary.org/obo/MONDO_0859272) neurodevelopmental disorder with speech delay and variable ocular anomalies
- **Grounded subtypes:** 0
