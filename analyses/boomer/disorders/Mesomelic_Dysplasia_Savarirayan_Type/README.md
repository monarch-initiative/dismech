...
Boomer grounding analysis for [`kb/disorders/Mesomelic_Dysplasia_Savarirayan_Type.yaml`](../../../../kb/disorders/Mesomelic_Dysplasia_Savarirayan_Type.yaml).

- **Entry term:** [`MONDO:0011530`](http://purl.obolibrary.org/obo/MONDO_0011530) mesomelic dysplasia, Savarirayan type
- **Grounded subtypes:** 0
