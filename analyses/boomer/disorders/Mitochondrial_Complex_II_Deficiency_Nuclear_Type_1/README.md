...
Boomer grounding analysis for [`kb/disorders/Mitochondrial_Complex_II_Deficiency_Nuclear_Type_1.yaml`](../../../../kb/disorders/Mitochondrial_Complex_II_Deficiency_Nuclear_Type_1.yaml).

- **Entry term:** [`MONDO:0100294`](http://purl.obolibrary.org/obo/MONDO_0100294) mitochondrial complex II deficiency, nuclear type 1
- **Grounded subtypes:** 0
