...
Boomer grounding analysis for [`kb/disorders/CHST3-Related_Skeletal_Dysplasia.yaml`](../../../../kb/disorders/CHST3-Related_Skeletal_Dysplasia.yaml).

- **Entry term:** [`MONDO:0007738`](http://purl.obolibrary.org/obo/MONDO_0007738) spondyloepiphyseal dysplasia with congenital joint dislocations
- **Grounded subtypes:** 0
