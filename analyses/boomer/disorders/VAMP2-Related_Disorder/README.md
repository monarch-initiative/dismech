...
Boomer grounding analysis for [`kb/disorders/VAMP2-Related_Disorder.yaml`](../../../../kb/disorders/VAMP2-Related_Disorder.yaml).

- **Entry term:** [`MONDO:0032900`](http://purl.obolibrary.org/obo/MONDO_0032900) neurodevelopmental disorder with hypotonia and autistic features with or without hyperkinetic movements
- **Grounded subtypes:** 0
