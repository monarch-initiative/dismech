...
Boomer grounding analysis for [`kb/disorders/Neuronal_Intranuclear_Inclusion_Disease.yaml`](../../../../kb/disorders/Neuronal_Intranuclear_Inclusion_Disease.yaml).

- **Entry term:** [`MONDO:0011327`](http://purl.obolibrary.org/obo/MONDO_0011327) neuronal intranuclear inclusion disease
- **Grounded subtypes:** 0
