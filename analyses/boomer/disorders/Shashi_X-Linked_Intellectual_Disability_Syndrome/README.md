...
Boomer grounding analysis for [`kb/disorders/Shashi_X-Linked_Intellectual_Disability_Syndrome.yaml`](../../../../kb/disorders/Shashi_X-Linked_Intellectual_Disability_Syndrome.yaml).

- **Entry term:** [`MONDO:0010277`](http://purl.obolibrary.org/obo/MONDO_0010277) syndromic X-linked intellectual disability Shashi type
- **Grounded subtypes:** 0
