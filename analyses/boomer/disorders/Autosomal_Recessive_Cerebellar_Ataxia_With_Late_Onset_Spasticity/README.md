...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Cerebellar_Ataxia_With_Late_Onset_Spasticity.yaml`](../../../../kb/disorders/Autosomal_Recessive_Cerebellar_Ataxia_With_Late_Onset_Spasticity.yaml).

- **Entry term:** [`MONDO:0018129`](http://purl.obolibrary.org/obo/MONDO_0018129) autosomal recessive cerebellar ataxia with late-onset spasticity
- **Grounded subtypes:** 0
