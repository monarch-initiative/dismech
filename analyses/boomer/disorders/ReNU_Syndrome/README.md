...
Boomer grounding analysis for [`kb/disorders/ReNU_Syndrome.yaml`](../../../../kb/disorders/ReNU_Syndrome.yaml).

- **Entry term:** [`MONDO:0971172`](http://purl.obolibrary.org/obo/MONDO_0971172) neurodevelopmental disorder with hypotonia, brain anomalies, distinctive facies, and absent language
- **Grounded subtypes:** 0
