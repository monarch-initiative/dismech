...
Boomer grounding analysis for [`kb/disorders/Distal_Hereditary_Motor_Neuronopathy_Type_5B.yaml`](../../../../kb/disorders/Distal_Hereditary_Motor_Neuronopathy_Type_5B.yaml).

- **Entry term:** [`MONDO:0013884`](http://purl.obolibrary.org/obo/MONDO_0013884) neuronopathy, distal hereditary motor, type 5B
- **Grounded subtypes:** 0
