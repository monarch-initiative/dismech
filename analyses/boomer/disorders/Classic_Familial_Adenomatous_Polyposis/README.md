...
Boomer grounding analysis for [`kb/disorders/Classic_Familial_Adenomatous_Polyposis.yaml`](../../../../kb/disorders/Classic_Familial_Adenomatous_Polyposis.yaml).

- **Entry term:** [`MONDO:0021055`](http://purl.obolibrary.org/obo/MONDO_0021055) classic familial adenomatous polyposis
- **Grounded subtypes:** 0
