...
Boomer grounding analysis for [`kb/disorders/SETD1A-Related_Early-Onset_Epilepsy.yaml`](../../../../kb/disorders/SETD1A-Related_Early-Onset_Epilepsy.yaml).

- **Entry term:** [`MONDO:0030005`](http://purl.obolibrary.org/obo/MONDO_0030005) epilepsy, early-onset, with or without developmental delay
- **Grounded subtypes:** 0
