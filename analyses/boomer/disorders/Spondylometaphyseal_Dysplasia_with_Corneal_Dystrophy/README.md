...
Boomer grounding analysis for [`kb/disorders/Spondylometaphyseal_Dysplasia_with_Corneal_Dystrophy.yaml`](../../../../kb/disorders/Spondylometaphyseal_Dysplasia_with_Corneal_Dystrophy.yaml).

- **Entry term:** [`MONDO:0030074`](http://purl.obolibrary.org/obo/MONDO_0030074) spondylometaphyseal dysplasia with corneal dystrophy
- **Grounded subtypes:** 0
