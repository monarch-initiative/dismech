...
Boomer grounding analysis for [`kb/disorders/Polycystic_Kidney_Disease_3.yaml`](../../../../kb/disorders/Polycystic_Kidney_Disease_3.yaml).

- **Entry term:** [`MONDO:0010916`](http://purl.obolibrary.org/obo/MONDO_0010916) polycystic kidney disease 3 with or without polycystic liver disease
- **Grounded subtypes:** 0
