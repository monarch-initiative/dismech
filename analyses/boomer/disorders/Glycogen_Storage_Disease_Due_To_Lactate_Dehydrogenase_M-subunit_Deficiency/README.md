...
Boomer grounding analysis for [`kb/disorders/Glycogen_Storage_Disease_Due_To_Lactate_Dehydrogenase_M-subunit_Deficiency.yaml`](../../../../kb/disorders/Glycogen_Storage_Disease_Due_To_Lactate_Dehydrogenase_M-subunit_Deficiency.yaml).

- **Entry term:** [`MONDO:0013047`](http://purl.obolibrary.org/obo/MONDO_0013047) glycogen storage disease due to lactate dehydrogenase M-subunit deficiency
- **Grounded subtypes:** 0
