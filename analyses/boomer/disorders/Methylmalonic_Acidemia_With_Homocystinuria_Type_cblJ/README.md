...
Boomer grounding analysis for [`kb/disorders/Methylmalonic_Acidemia_With_Homocystinuria_Type_cblJ.yaml`](../../../../kb/disorders/Methylmalonic_Acidemia_With_Homocystinuria_Type_cblJ.yaml).

- **Entry term:** [`MONDO:0013925`](http://purl.obolibrary.org/obo/MONDO_0013925) methylmalonic acidemia with homocystinuria, type cblJ
- **Grounded subtypes:** 0
