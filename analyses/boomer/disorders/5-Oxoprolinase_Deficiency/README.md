...
Boomer grounding analysis for [`kb/disorders/5-Oxoprolinase_Deficiency.yaml`](../../../../kb/disorders/5-Oxoprolinase_Deficiency.yaml).

- **Entry term:** [`MONDO:0009825`](http://purl.obolibrary.org/obo/MONDO_0009825) 5-oxoprolinase deficiency
- **Grounded subtypes:** 0
