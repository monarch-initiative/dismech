...
Boomer grounding analysis for [`kb/disorders/Mosaic_Variegated_Aneuploidy_Syndrome.yaml`](../../../../kb/disorders/Mosaic_Variegated_Aneuploidy_Syndrome.yaml).

- **Entry term:** [`MONDO:0000141`](http://purl.obolibrary.org/obo/MONDO_0000141) mosaic variegated aneuploidy syndrome
- **Grounded subtypes:** 0
