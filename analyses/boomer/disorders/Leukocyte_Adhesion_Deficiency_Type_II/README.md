...
Boomer grounding analysis for [`kb/disorders/Leukocyte_Adhesion_Deficiency_Type_II.yaml`](../../../../kb/disorders/Leukocyte_Adhesion_Deficiency_Type_II.yaml).

- **Entry term:** [`MONDO:0009953`](http://purl.obolibrary.org/obo/MONDO_0009953) leukocyte adhesion deficiency type II
- **Grounded subtypes:** 0
