...
Boomer grounding analysis for [`kb/disorders/VCP-associated_Multisystem_Proteinopathy.yaml`](../../../../kb/disorders/VCP-associated_Multisystem_Proteinopathy.yaml).

- **Entry term:** [`MONDO:0008178`](http://purl.obolibrary.org/obo/MONDO_0008178) inclusion body myopathy with Paget disease of bone and frontotemporal dementia type 1
- **Grounded subtypes:** 0
