...
Boomer grounding analysis for [`kb/disorders/3-Methylglutaconic_Aciduria_Type_I.yaml`](../../../../kb/disorders/3-Methylglutaconic_Aciduria_Type_I.yaml).

- **Entry term:** [`MONDO:0009610`](http://purl.obolibrary.org/obo/MONDO_0009610) 3-methylglutaconic aciduria type 1
- **Grounded subtypes:** 0
