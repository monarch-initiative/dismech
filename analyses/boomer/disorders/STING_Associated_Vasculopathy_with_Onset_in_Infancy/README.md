...
Boomer grounding analysis for [`kb/disorders/STING_Associated_Vasculopathy_with_Onset_in_Infancy.yaml`](../../../../kb/disorders/STING_Associated_Vasculopathy_with_Onset_in_Infancy.yaml).

- **Entry term:** [`MONDO:0014405`](http://purl.obolibrary.org/obo/MONDO_0014405) STING-associated vasculopathy with onset in infancy
- **Grounded subtypes:** 0
