...
Boomer grounding analysis for [`kb/disorders/Hereditary_Intrinsic_Factor_Deficiency.yaml`](../../../../kb/disorders/Hereditary_Intrinsic_Factor_Deficiency.yaml).

- **Entry term:** [`MONDO:0009852`](http://purl.obolibrary.org/obo/MONDO_0009852) hereditary intrinsic factor deficiency
- **Grounded subtypes:** 0
