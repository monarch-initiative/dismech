...
Boomer grounding analysis for [`kb/disorders/Microphthalmia_with_Coloboma.yaml`](../../../../kb/disorders/Microphthalmia_with_Coloboma.yaml).

- **Entry term:** [`MONDO:0000170`](http://purl.obolibrary.org/obo/MONDO_0000170) microphthalmia, isolated, with coloboma
- **Grounded subtypes:** 0
