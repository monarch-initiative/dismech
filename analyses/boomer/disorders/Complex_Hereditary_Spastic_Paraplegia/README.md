...
Boomer grounding analysis for [`kb/disorders/Complex_Hereditary_Spastic_Paraplegia.yaml`](../../../../kb/disorders/Complex_Hereditary_Spastic_Paraplegia.yaml).

- **Entry term:** [`MONDO:0015150`](http://purl.obolibrary.org/obo/MONDO_0015150) complex hereditary spastic paraplegia
- **Grounded subtypes:** 0
