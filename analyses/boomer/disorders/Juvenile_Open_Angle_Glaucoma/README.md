...
Boomer grounding analysis for [`kb/disorders/Juvenile_Open_Angle_Glaucoma.yaml`](../../../../kb/disorders/Juvenile_Open_Angle_Glaucoma.yaml).

- **Entry term:** [`MONDO:0020367`](http://purl.obolibrary.org/obo/MONDO_0020367) juvenile open angle glaucoma
- **Grounded subtypes:** 0
