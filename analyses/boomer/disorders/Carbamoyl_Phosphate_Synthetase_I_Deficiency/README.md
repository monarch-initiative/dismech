...
Boomer grounding analysis for [`kb/disorders/Carbamoyl_Phosphate_Synthetase_I_Deficiency.yaml`](../../../../kb/disorders/Carbamoyl_Phosphate_Synthetase_I_Deficiency.yaml).

- **Entry term:** [`MONDO:0009376`](http://purl.obolibrary.org/obo/MONDO_0009376) carbamoyl phosphate synthetase I deficiency disease
- **Grounded subtypes:** 0
