...
Boomer grounding analysis for [`kb/disorders/Combined_Oxidative_Phosphorylation_Defect_Type_26.yaml`](../../../../kb/disorders/Combined_Oxidative_Phosphorylation_Defect_Type_26.yaml).

- **Entry term:** [`MONDO:0014684`](http://purl.obolibrary.org/obo/MONDO_0014684) combined oxidative phosphorylation defect type 26
- **Grounded subtypes:** 0
