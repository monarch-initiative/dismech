...
Boomer grounding analysis for [`kb/disorders/TFRC-Related_Combined_Immunodeficiency.yaml`](../../../../kb/disorders/TFRC-Related_Combined_Immunodeficiency.yaml).

- **Entry term:** [`MONDO:0014760`](http://purl.obolibrary.org/obo/MONDO_0014760) TFRC-related combined immunodeficiency
- **Grounded subtypes:** 0
