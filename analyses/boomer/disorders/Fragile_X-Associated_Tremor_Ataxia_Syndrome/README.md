...
Boomer grounding analysis for [`kb/disorders/Fragile_X-Associated_Tremor_Ataxia_Syndrome.yaml`](../../../../kb/disorders/Fragile_X-Associated_Tremor_Ataxia_Syndrome.yaml).

- **Entry term:** [`MONDO:0010382`](http://purl.obolibrary.org/obo/MONDO_0010382) fragile X-associated tremor/ataxia syndrome
- **Grounded subtypes:** 0
