...
Boomer grounding analysis for [`kb/disorders/PUS7-Related_Neurodevelopmental_Disorder.yaml`](../../../../kb/disorders/PUS7-Related_Neurodevelopmental_Disorder.yaml).

- **Entry term:** [`MONDO:0032687`](http://purl.obolibrary.org/obo/MONDO_0032687) intellectual developmental disorder with abnormal behavior, microcephaly, and short stature
- **Grounded subtypes:** 0
