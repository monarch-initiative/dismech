...
Boomer grounding analysis for [`kb/disorders/SYN1-Related_Disorder.yaml`](../../../../kb/disorders/SYN1-Related_Disorder.yaml).

- **Entry term:** [`MONDO:0010339`](http://purl.obolibrary.org/obo/MONDO_0010339) epilepsy, X-linked 1, with variable learning disabilities and behavior disorders
- **Grounded subtypes:** 0
