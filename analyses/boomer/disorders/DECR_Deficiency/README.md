...
Boomer grounding analysis for [`kb/disorders/DECR_Deficiency.yaml`](../../../../kb/disorders/DECR_Deficiency.yaml).

- **Entry term:** [`MONDO:0014464`](http://purl.obolibrary.org/obo/MONDO_0014464) progressive encephalopathy with leukodystrophy due to DECR deficiency
- **Grounded subtypes:** 0
