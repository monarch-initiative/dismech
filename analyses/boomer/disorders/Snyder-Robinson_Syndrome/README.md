...
Boomer grounding analysis for [`kb/disorders/Snyder-Robinson_Syndrome.yaml`](../../../../kb/disorders/Snyder-Robinson_Syndrome.yaml).

- **Entry term:** [`MONDO:0010664`](http://purl.obolibrary.org/obo/MONDO_0010664) syndromic X-linked intellectual disability Snyder type
- **Grounded subtypes:** 0
