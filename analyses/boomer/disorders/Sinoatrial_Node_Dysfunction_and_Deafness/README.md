...
Boomer grounding analysis for [`kb/disorders/Sinoatrial_Node_Dysfunction_and_Deafness.yaml`](../../../../kb/disorders/Sinoatrial_Node_Dysfunction_and_Deafness.yaml).

- **Entry term:** [`MONDO:0013960`](http://purl.obolibrary.org/obo/MONDO_0013960) sinoatrial node dysfunction and deafness
- **Grounded subtypes:** 0
