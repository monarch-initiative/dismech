# SCUBE3-Related Short Stature Syndrome

Boomer grounding analysis for [`kb/disorders/SCUBE3-Related_Short_Stature_Syndrome.yaml`](../../../../kb/disorders/SCUBE3-Related_Short_Stature_Syndrome.yaml).

- **Entry term:** [`MONDO:0030953`](http://purl.obolibrary.org/obo/MONDO_0030953) short stature, facial dysmorphism, and skeletal anomalies with or without cardiac anomalies 2
- **Grounded subtypes:** 0
