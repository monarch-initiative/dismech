...
Boomer grounding analysis for [`kb/disorders/LRBA_Deficiency.yaml`](../../../../kb/disorders/LRBA_Deficiency.yaml).

- **Entry term:** [`MONDO:0013863`](http://purl.obolibrary.org/obo/MONDO_0013863) combined immunodeficiency due to LRBA deficiency
- **Grounded subtypes:** 0
