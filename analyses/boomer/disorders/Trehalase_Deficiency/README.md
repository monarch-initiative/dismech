...
Boomer grounding analysis for [`kb/disorders/Trehalase_Deficiency.yaml`](../../../../kb/disorders/Trehalase_Deficiency.yaml).

- **Entry term:** [`MONDO:0012803`](http://purl.obolibrary.org/obo/MONDO_0012803) diarrhea-vomiting due to trehalase deficiency
- **Grounded subtypes:** 0
