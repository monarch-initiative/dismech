...
Boomer grounding analysis for [`kb/disorders/CADASIL_Type_1.yaml`](../../../../kb/disorders/CADASIL_Type_1.yaml).

- **Entry term:** [`MONDO:0000914`](http://purl.obolibrary.org/obo/MONDO_0000914) cerebral arteriopathy, autosomal dominant, with subcortical infarcts and leukoencephalopathy, type 1
- **Grounded subtypes:** 0
