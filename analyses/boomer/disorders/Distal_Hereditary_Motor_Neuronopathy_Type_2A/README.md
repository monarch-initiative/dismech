...
Boomer grounding analysis for [`kb/disorders/Distal_Hereditary_Motor_Neuronopathy_Type_2A.yaml`](../../../../kb/disorders/Distal_Hereditary_Motor_Neuronopathy_Type_2A.yaml).

- **Entry term:** [`MONDO:0008025`](http://purl.obolibrary.org/obo/MONDO_0008025) neuronopathy, distal hereditary motor, type 2A
- **Grounded subtypes:** 0
