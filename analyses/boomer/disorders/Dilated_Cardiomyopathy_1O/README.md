...
Boomer grounding analysis for [`kb/disorders/Dilated_Cardiomyopathy_1O.yaml`](../../../../kb/disorders/Dilated_Cardiomyopathy_1O.yaml).

- **Entry term:** [`MONDO:0012062`](http://purl.obolibrary.org/obo/MONDO_0012062) dilated cardiomyopathy 1O
- **Grounded subtypes:** 0
