...
Boomer grounding analysis for [`kb/disorders/Infantile-Onset_Pompe_Disease.yaml`](../../../../kb/disorders/Infantile-Onset_Pompe_Disease.yaml).

- **Entry term:** [`MONDO:0017694`](http://purl.obolibrary.org/obo/MONDO_0017694) glycogen storage disease due to acid maltase deficiency, infantile onset
- **Grounded subtypes:** 0
