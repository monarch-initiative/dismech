...
Boomer grounding analysis for [`kb/disorders/Proteasome_Associated_Autoinflammatory_Syndrome.yaml`](../../../../kb/disorders/Proteasome_Associated_Autoinflammatory_Syndrome.yaml).

- **Entry term:** [`MONDO:0009726`](http://purl.obolibrary.org/obo/MONDO_0009726) proteosome-associated autoinflammatory syndrome
- **Grounded subtypes:** 0
