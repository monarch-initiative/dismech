...
Boomer grounding analysis for [`kb/disorders/X-linked_Agammaglobulinemia.yaml`](../../../../kb/disorders/X-linked_Agammaglobulinemia.yaml).

- **Entry term:** [`MONDO:0010421`](http://purl.obolibrary.org/obo/MONDO_0010421) Bruton-type agammaglobulinemia
- **Grounded subtypes:** 0
