...
Boomer grounding analysis for [`kb/disorders/Posterior_Polymorphous_Corneal_Dystrophy.yaml`](../../../../kb/disorders/Posterior_Polymorphous_Corneal_Dystrophy.yaml).

- **Entry term:** [`MONDO:0020364`](http://purl.obolibrary.org/obo/MONDO_0020364) posterior polymorphous corneal dystrophy
- **Grounded subtypes:** 0
