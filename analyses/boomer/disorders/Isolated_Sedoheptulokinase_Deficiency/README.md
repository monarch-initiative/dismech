...
Boomer grounding analysis for [`kb/disorders/Isolated_Sedoheptulokinase_Deficiency.yaml`](../../../../kb/disorders/Isolated_Sedoheptulokinase_Deficiency.yaml).

- **Entry term:** [`MONDO:0014969`](http://purl.obolibrary.org/obo/MONDO_0014969) isolated sedoheptulokinase deficiency
- **Grounded subtypes:** 0
