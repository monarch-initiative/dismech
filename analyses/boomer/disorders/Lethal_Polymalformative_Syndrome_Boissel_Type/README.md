...
Boomer grounding analysis for [`kb/disorders/Lethal_Polymalformative_Syndrome_Boissel_Type.yaml`](../../../../kb/disorders/Lethal_Polymalformative_Syndrome_Boissel_Type.yaml).

- **Entry term:** [`MONDO:0013050`](http://purl.obolibrary.org/obo/MONDO_0013050) lethal polymalformative syndrome, Boissel type
- **Grounded subtypes:** 0
