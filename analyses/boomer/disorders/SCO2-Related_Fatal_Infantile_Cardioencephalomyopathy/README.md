...
Boomer grounding analysis for [`kb/disorders/SCO2-Related_Fatal_Infantile_Cardioencephalomyopathy.yaml`](../../../../kb/disorders/SCO2-Related_Fatal_Infantile_Cardioencephalomyopathy.yaml).

- **Entry term:** [`MONDO:0011451`](http://purl.obolibrary.org/obo/MONDO_0011451) cardioencephalomyopathy, fatal infantile, due to cytochrome c oxidase deficiency 1
- **Grounded subtypes:** 0
