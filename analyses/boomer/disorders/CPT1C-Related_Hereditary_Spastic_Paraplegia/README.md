...
Boomer grounding analysis for [`kb/disorders/CPT1C-Related_Hereditary_Spastic_Paraplegia.yaml`](../../../../kb/disorders/CPT1C-Related_Hereditary_Spastic_Paraplegia.yaml).

- **Entry term:** [`MONDO:0014568`](http://purl.obolibrary.org/obo/MONDO_0014568) hereditary spastic paraplegia 73
- **Grounded subtypes:** 0
