...
Boomer grounding analysis for [`kb/disorders/Autosomal_Dominant_Nonsyndromic_Hearing_Loss_2B.yaml`](../../../../kb/disorders/Autosomal_Dominant_Nonsyndromic_Hearing_Loss_2B.yaml).

- **Entry term:** [`MONDO:0012976`](http://purl.obolibrary.org/obo/MONDO_0012976) autosomal dominant nonsyndromic hearing loss 2B
- **Grounded subtypes:** 0
