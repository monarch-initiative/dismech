...
Boomer grounding analysis for [`kb/disorders/Combined_Oxidative_Phosphorylation_Defect_Type_13.yaml`](../../../../kb/disorders/Combined_Oxidative_Phosphorylation_Defect_Type_13.yaml).

- **Entry term:** [`MONDO:0013977`](http://purl.obolibrary.org/obo/MONDO_0013977) combined oxidative phosphorylation defect type 13
- **Grounded subtypes:** 0
