...
Boomer grounding analysis for [`kb/disorders/Dilated_Cardiomyopathy_1X.yaml`](../../../../kb/disorders/Dilated_Cardiomyopathy_1X.yaml).

- **Entry term:** [`MONDO:0012704`](http://purl.obolibrary.org/obo/MONDO_0012704) dilated cardiomyopathy 1X
- **Grounded subtypes:** 0
