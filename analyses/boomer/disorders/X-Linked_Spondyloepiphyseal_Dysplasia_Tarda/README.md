...
Boomer grounding analysis for [`kb/disorders/X-Linked_Spondyloepiphyseal_Dysplasia_Tarda.yaml`](../../../../kb/disorders/X-Linked_Spondyloepiphyseal_Dysplasia_Tarda.yaml).

- **Entry term:** [`MONDO:0010737`](http://purl.obolibrary.org/obo/MONDO_0010737) spondyloepiphyseal dysplasia tarda, X-linked
- **Grounded subtypes:** 0
