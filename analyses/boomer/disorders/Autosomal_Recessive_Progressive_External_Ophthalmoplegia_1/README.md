...
Boomer grounding analysis for [`kb/disorders/Autosomal_Recessive_Progressive_External_Ophthalmoplegia_1.yaml`](../../../../kb/disorders/Autosomal_Recessive_Progressive_External_Ophthalmoplegia_1.yaml).

- **Entry term:** [`MONDO:0009783`](http://purl.obolibrary.org/obo/MONDO_0009783) progressive external ophthalmoplegia with mitochondrial DNA deletions, autosomal recessive 1
- **Grounded subtypes:** 0
