...
Boomer grounding analysis for [`kb/disorders/TUBA1A-related_Tubulinopathy.yaml`](../../../../kb/disorders/TUBA1A-related_Tubulinopathy.yaml).

- **Entry term:** [`MONDO:0012703`](http://purl.obolibrary.org/obo/MONDO_0012703) lissencephaly due to TUBA1A mutation
- **Grounded subtypes:** 0
