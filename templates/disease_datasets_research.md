...
pathophysiology of **{disease_name}**. The output will be reconciled against a
...
1. Datasets generated **from patients with {disease_name}** (primary tissue,
...
3. Large **reference / consortium resources** that contain a usable
   {disease_name} stratum (GTEx, TCGA, ENCODE, UK Biobank, GWAS Catalog,
...
- **Mechanistic relevance:** <2-3 sentences: which specific pathophysiological
  step of {disease_name} this dataset speaks to, and what was found. Tie it to
...
- Which aspects of {disease_name} pathophysiology **are** well covered by public
