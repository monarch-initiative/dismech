...
MAXO_MAPPINGS = [
    ...
    (r'bronchodilat', {'id': 'MAXO:0000312', 'label': 'respiratory tract agent therapy'}),
    (r'inhaled\s*corticosteroid', {'id': 'MAXO:0000312', 'label': 'respiratory tract agent therapy'}),
    (r'corticosteroid', {'id': 'MAXO:0000058', 'label': 'pharmacotherapy'}),
    (r'steroid', {'id': 'MAXO:0000058', 'label': 'pharmacotherapy'}),
    (r'immuno.?suppres', {'id': 'MAXO:0000058', 'label': 'pharmacotherapy'}),
    ...
    (r'antihypertensive', {'id': 'MAXO:0000181', 'label': 'cardiovascular agent therapy'}),
    ...
    (r'airway\s*clearance', {'id': 'MAXO:0000312', 'label': 'respiratory tract agent therapy'}),
    ...
    (r'fluid\s*(resuscitation|replacement|therap)', {'id': 'MAXO:0000458', 'label': 'hydrotherapy'}),

    # More hormone therapies
    (r'testosterone\s*replacement', {'id': 'MAXO:0000283', 'label': 'hormone modifying therapy'}),
    (r'estrogen\s*replacement', {'id': 'MAXO:0000283', 'label': 'hormone modifying therapy'}),
    (r'glucocorticoid\s*replacement', {'id': 'MAXO:0000283', 'label': 'hormone modifying therapy'}),
    (r'mineralocorticoid\s*replacement', {'id': 'MAXO:0000283', 'label': 'hormone modifying therapy'}),
    (r'androgen', {'id': 'MAXO:0000283', 'label': 'hormone modifying therapy'}),
    (r'replacement\s*therap', {'id': 'MAXO:0000283', 'label': 'hormone modifying therapy'}),

    # More respiratory
    (r'beta.?agonist', {'id': 'MAXO:0000312', 'label': 'respiratory tract agent therapy'}),
    (r'leukotriene', {'id': 'MAXO:0000312', 'label': 'respiratory tract agent therapy'}),
    (r'anti.?ig.?e', {'id': 'MAXO:0000312', 'label': 'respiratory tract agent therapy'}),
    ...
    (r'calcium\s*channel\s*block', {'id': 'MAXO:0000434', 'label': 'calcium channel blocking agent therapy'}),
    ...
    (r'nerve\s*stimulat', {'id': 'MAXO:0000004', 'label': 'surgical procedure'}),
    ...
    (r'salt\s*supplement', {'id': 'MAXO:0000106', 'label': 'nutritional supplementation'}),
    ...
    # GI management
    (r'gastrointestinal\s*management', {'id': 'MAXO:0000267', 'label': 'gastrointestinal agent therapy'}),

    # More drugs
    (r'glucocorticoid', {'id': 'MAXO:0000058', 'label': 'pharmacotherapy'}),
    (r'mineralocorticoid\s*receptor', {'id': 'MAXO:0000058', 'label': 'pharmacotherapy'}),
    (r'receptor\s*antagonist', {'id': 'MAXO:0000161', 'label': 'receptor antagonist therapy'}),
]
...
def process_file(filepath: Path, dry_run: bool = False) -> dict:
    ...
    stats = {'file': filepath.name, 'treatments': len(data['treatments']), 'added': 0, 'skipped': 0}
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Add MAXO terms to disorder treatments')
    parser.add_argument('--dry-run', '-n', action='store_true', help='Do not write files')
