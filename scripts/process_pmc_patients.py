...
def create_case_yaml(entry: dict, mondo_term: dict, output_dir: Path) -> bool:
    ...
    with open(output_path, 'w') as f:
        yaml.dump(case, f, default_flow_style=False, allow_unicode=True, sort_keys=False, width=100)
