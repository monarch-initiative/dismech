...
- `ciliopathy_dysfunction` — Conserved ciliopathy pattern: basal body / transition zone / IFT defect → impaired cilium-dependent signaling (Hedgehog and non-canonical Wnt/PCP) → retinal, renal, skeletal, CNS, and metabolic pleiotropy, with a parallel motile-cilia arm (impaired ciliary beating → mucociliary clearance defect and laterality defects) for primary ciliary dyskinesia. Spans Bardet-Biedl, Joubert, nephronophthisis, Jeune, Alstrom, Meckel, orofaciodigital, short-rib polydactyly, and primary ciliary dyskinesia. Key conformance targets: `ciliopathy_dysfunction#Impaired Hedgehog Signal Transduction`, `ciliopathy_dysfunction#Basal Body and Transition Zone Dysfunction`
