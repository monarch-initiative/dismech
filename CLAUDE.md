...
- `ocular_morphogenesis_failure` — Conserved anophthalmia–microphthalmia–coloboma developmental pattern: sign-agnostic eye-field/optic-vesicle patterning perturbation → optic-stalk/optic-cup proximodistal boundary shift (the resolved Hedgehog arm) → disrupted optic-cup and globe morphogenesis → later optic-fissure closure failure → A/M/C spectrum, with early globe failure directly supplying anophthalmia/microphthalmia and fissure non-closure supplying coloboma. Conforming nodes substitute retinoid, WNT/FZD5, Hedgehog, transcription-factor, or enhancer lesions; the surface-ectoderm/lens-placode FOXE3 arm is explicitly out of scope. Terminal outcomes are HP-bound (HP:0000528/HP:0000568/HP:0000589) and close-mapped to MONDO:0016764 pending endpoint issue #3974. Key conformance target: `ocular_morphogenesis_failure#Disrupted Optic Cup and Globe Morphogenesis`
